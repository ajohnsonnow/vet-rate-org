 ...
 748 conditions
   ...
   Validated: 38 CFR Part 4 (eCFR Jan 2026)
 ...
 173 components
   Source: Component count from src/components/

 167,298 lines of code
   Source: Dynamic calculation from codebase
...
Files updated:
 ...
 src/utils/componentStats.js  
 src/utils/changelogGenerator.js
 src/contexts/LanguageContext.jsx (2 locations)
...
and documented nexus theories (38 CFR  3.310). We only include
