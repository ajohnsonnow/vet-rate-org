...
> **PII constraint:** All real veteran data stayed at `E:\Johnson_C-FIle` and was never committed. The redacted synthetic fixture (`tests/fixtures/redacted-packet.json`) uses `JOHN Q. VETERAN / 000-00-0000 / C-000-0000` with Johnson's condition+rating set.
...
## 3. Johnson 80% ground-truth result

**Both calculators independently produce 80% for Johnson's 9-condition set.**
...
Ground-truth test: `src/__tests__/utils/johnsonGroundTruth.test.js` (15 tests, all passing).
...
*Report generated 2026-06-08. PII-free — no SSN, VA file number, DOB, or name from real C-file appears in this document.*
