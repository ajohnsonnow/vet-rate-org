...
> **PII constraint:** All real veteran data stayed at `E:\Williams_C-FIle` and was never committed. The redacted synthetic fixture (`tests/fixtures/redacted-packet.json`) uses `JOHN Q. VETERAN / 000-00-0000 / C-000-0000` with Johnson's condition+rating set.
