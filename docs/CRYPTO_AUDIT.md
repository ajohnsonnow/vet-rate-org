...
|---|---|---|---|
| [src/utils/cloudEncryption.js](../src/utils/cloudEncryption.js) | Passphrase backups | PBKDF2-SHA256 → AES-256-GCM | **Hardened S8** — 100k → 600k iterations, versioned envelope `VR_ENC_V2` |
