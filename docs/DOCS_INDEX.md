...
> *Tutorials* (learning by doing), *How-to* (achieving a specific
> goal), *Reference* (looking up facts), *Explanation* (understanding
...
| [STATE_BENEFIT_HUNTER_UPDATE_SUMMARY.md](./STATE_BENEFIT_HUNTER_UPDATE_SUMMARY.md) | Latest state-benefit changes |
...
| [IMPLEMENTATION_SUMMARY.md](./IMPLEMENTATION_SUMMARY.md) | Cross-feature implementation snapshot |
