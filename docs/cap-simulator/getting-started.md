...
Click **"📋 C&P Simulator"** in the navigation header.

### From the Feature Card

On the main page, click **"🎯 Launch C&P Simulator"** in the amber/yellow feature card.
...
Shows your position in the simulation:
...
- Take the simulation multiple times
