...
<p>Learn the basics of the C&P Exam Simulator and how to begin.</p>
<a href="getting-started/" class="doc-button">Learn More →</a>
</div>

<div class="feature-card">
<h3>📋 Condition Selection</h3>
<p>Choose a condition to practice from your packet or the full database.</p>
<a href="condition-selection/" class="doc-button">Learn More →</a>
</div>

<div class="feature-card">
<h3>🎯 Taking the Simulation</h3>
<p>Walk through the simulation process and understand each question type.</p>
<a href="taking-simulation/" class="doc-button">Learn More →</a>
</div>

<div class="feature-card">
<h3>📊 Understanding Results</h3>
<p>Interpret your estimated rating and gap analysis.</p>
<a href="results/" class="doc-button">Learn More →</a>
</div>

<div class="feature-card">
<h3>📚 Flashcard Mode</h3>
<p>Learn medical terminology with interactive flashcards.</p>
