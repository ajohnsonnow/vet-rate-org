...
The **PTSD Stressor Statement** is a required form for PTSD claims that:

- Describes the traumatic event(s) you experienced
- Provides details the VA needs to verify the event
- Explains how the event affected you
- Connects the trauma to your current PTSD symptoms
...
## Form 21-0781: General PTSD

### When to Use

Use this form for stressors including:

- Combat or hostile military activity
- Fear of hostile military or terrorist activity
- Accidents or natural disasters
- Witnessing death or injury
- Training incidents
- Other traumatic events (not personal assault)
...
- Physical assault
- Personal assault
- Harassment that resulted in trauma

### Special Considerations

The VA recognizes that:

- Assault often goes unreported
- Records may not exist
- Alternative evidence is acceptable
...
<div class="step">
<strong>Download</strong> and review
</div>
</div>
...
Help the VA verify your stressor:

- Unit designation (full name)
- Dates assigned
- Duty position/MOS
- Commander's name (if known)
- Other witnesses (if known)

#### Symptoms and Treatment

Connect the event to current PTSD:
...
If you experienced multiple traumatic events:

- You can include multiple stressors on one form
...
### For MST (Alternative Evidence)

- Behavioral health records
- Performance evaluations showing change
- Requests for transfer
- Statements to chaplains, counselors
