...
When you first visit Vet-Rate.org, you'll be greeted with a welcome screen that introduces the platform and its core values.
...
The welcome screen includes a personal message from the creator explaining why the platform was built — to help veterans navigate the VA disability system without feeling like another deployment.
...
Once you acknowledge the welcome screen:

1. **The screen won't appear again** — Your acknowledgment is saved locally
2. **You'll go directly to the main interface** — Future visits skip the welcome
3. **You can always access help** — Through the About Us and footer links

!!! tip "Clearing Your Browser Data"
    If you clear your browser's local storage or use a different browser/device, the welcome screen will appear again. This is normal behavior.
