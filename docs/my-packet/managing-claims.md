...
<div class="step">
<strong>Search</strong> for a condition
</div>
<div class="step">
<strong>Find</strong> the condition in results
</div>
<div class="step">
Click <strong>"Save to Packet"</strong>
</div>
<div class="step">
Condition appears in <strong>My Packet</strong>
</div>
</div>
...
<div class="step-container">
<div class="step">
Open the <strong>details panel</strong> for a condition
</div>
<div class="step">
Click <strong>"Save to Packet"</strong> in the action buttons
</div>
<div class="step">
Confirm the condition is <strong>added</strong>
</div>
</div>
...
<div class="step-container">
<div class="step">
Review <strong>secondary condition suggestions</strong>
</div>
<div class="step">
Click <strong>"Save to Packet"</strong> on promising conditions
</div>
<div class="step">
Or use <strong>bulk selection</strong> to add multiple
</div>
</div>
...
## Condition Card Information

Each saved condition displays as a card with:
...
- Condition started in service
- Caused by event in service
...
- Caused by service-connected condition
- Aggravated by service-connected condition
- Related to medication for service-connected condition
...
<div class="step">
Status updates <strong>immediately</strong>
</div>
</div>
