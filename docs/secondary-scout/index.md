...
A **secondary condition** is a disability that was caused or aggravated by a service-connected condition you already have.

### Example

If you have **service-connected PTSD** and later develop:

- **Sleep Apnea** (from poor sleep patterns and weight gain)
- **Hypertension** (from chronic stress)
- **Depression** (worsened by PTSD symptoms)

These may qualify as **secondary** to your PTSD.
...
<h3>🚀 Launching Secondary Scout</h3>
<p>Learn how to enter your conditions and start discovering secondary connections.</p>
<a href="launching/" class="doc-button">Learn More →</a>
</div>

<div class="feature-card">
<h3>📊 Understanding Results</h3>
<p>Interpret the suggestions, mechanisms, and probability ratings.</p>
<a href="results/" class="doc-button">Learn More →</a>
</div>

<div class="feature-card">
<h3>📁 Adding to My Packet</h3>
<p>Save promising secondary conditions to your claims packet for tracking.</p>
<a href="add-to-packet/" class="doc-button">Learn More →</a>
</div>
