"""
Alabama State Benefits Scraper
"""
...
class AlabamaScraper(SimpleStateScraper):
    """Scraper for Alabama veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Alabama",
            state_code="AL",
            base_url="https://dvs.al.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Alabama veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Alabama Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.al.gov"
                )
            ],
            source_url="https://dvs.al.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Alabama Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.al.gov"
                )
            ],
            source_url="https://dmv.al.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Alabama public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Alabama institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Alabama Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.al.gov"
                )
            ],
            source_url="https://education.al.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Alabama.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Alabama Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.al.gov"
                )
            ],
            source_url="https://wildlife.al.gov/veterans",
            last_verified="2026-01-24"
        ))
