"""
Arkansas State Benefits Scraper
"""
...
class ArkansasScraper(SimpleStateScraper):
    """Scraper for Arkansas veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Arkansas",
            state_code="AR",
            base_url="https://dvs.ar.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Arkansas veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Arkansas Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ar.gov"
                )
            ],
            source_url="https://dvs.ar.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Arkansas Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ar.gov"
                )
            ],
            source_url="https://dmv.ar.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Arkansas.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Arkansas Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.ar.gov"
                )
            ],
            source_url="https://wildlife.ar.gov/veterans",
            last_verified="2026-01-24"
        ))
