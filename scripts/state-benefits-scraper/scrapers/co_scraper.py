"""
Colorado State Benefits Scraper
"""
...
class ColoradoScraper(SimpleStateScraper):
    """Scraper for Colorado veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Colorado",
            state_code="CO",
            base_url="https://dvs.co.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Colorado veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Colorado Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.co.gov"
                )
            ],
            source_url="https://dvs.co.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Colorado Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.co.gov"
                )
            ],
            source_url="https://dmv.co.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Colorado public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Colorado institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Colorado Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.co.gov"
                )
            ],
            source_url="https://education.co.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Colorado.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Colorado Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.co.gov"
                )
            ],
            source_url="https://wildlife.co.gov/veterans",
            last_verified="2026-01-24"
        ))
