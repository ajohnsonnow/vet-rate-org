"""
Connecticut State Benefits Scraper
"""
...
class ConnecticutScraper(SimpleStateScraper):
    """Scraper for Connecticut veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Connecticut",
            state_code="CT",
            base_url="https://dvs.ct.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Connecticut veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Connecticut Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ct.gov"
                )
            ],
            source_url="https://dvs.ct.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Connecticut Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ct.gov"
                )
            ],
            source_url="https://dmv.ct.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Connecticut public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Connecticut institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Connecticut Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.ct.gov"
                )
            ],
            source_url="https://education.ct.gov/veterans",
            last_verified="2026-01-24"
        ))
