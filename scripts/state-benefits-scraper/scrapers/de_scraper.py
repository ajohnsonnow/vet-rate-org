"""
Delaware State Benefits Scraper
"""
...
class DelawareScraper(SimpleStateScraper):
    """Scraper for Delaware veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Delaware",
            state_code="DE",
            base_url="https://dvs.de.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Delaware veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Delaware Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.de.gov"
                )
            ],
            source_url="https://dvs.de.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Delaware Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.de.gov"
                )
            ],
            source_url="https://dmv.de.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Delaware public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Delaware institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Delaware Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.de.gov"
                )
            ],
            source_url="https://education.de.gov/veterans",
            last_verified="2026-01-24"
        ))
