...
class HawaiiScraper(SimpleStateScraper):
    """Scraper for Hawaii veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Hawaii",
            state_code="HI",
            base_url="https://dvs.hi.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Hawaii veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Hawaii Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.hi.gov"
                )
            ],
            source_url="https://dvs.hi.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Hawaii Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.hi.gov"
                )
            ],
            source_url="https://dmv.hi.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Hawaii public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Hawaii institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Hawaii Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.hi.gov"
                )
            ],
            source_url="https://education.hi.gov/veterans",
            last_verified="2026-01-24"
        ))
