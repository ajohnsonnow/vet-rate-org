...
class IowaScraper(SimpleStateScraper):
    """Scraper for Iowa veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Iowa",
            state_code="IA",
            base_url="https://dvs.ia.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Iowa veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Iowa Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ia.gov"
                )
            ],
            source_url="https://dvs.ia.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Iowa Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ia.gov"
                )
            ],
            source_url="https://dmv.ia.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Iowa public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Iowa institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Iowa Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.ia.gov"
                )
            ],
            source_url="https://education.ia.gov/veterans",
            last_verified="2026-01-24"
        ))
