...
class IdahoScraper(SimpleStateScraper):
    """Scraper for Idaho veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Idaho",
            state_code="ID",
            base_url="https://dvs.id.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Idaho veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Idaho Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.id.gov"
                )
            ],
            source_url="https://dvs.id.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Idaho Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.id.gov"
                )
            ],
            source_url="https://dmv.id.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Idaho.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Idaho Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.id.gov"
                )
            ],
            source_url="https://wildlife.id.gov/veterans",
            last_verified="2026-01-24"
        ))
