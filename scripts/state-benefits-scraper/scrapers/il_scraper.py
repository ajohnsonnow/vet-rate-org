"""
Illinois State Benefits Scraper
"""
...
class IllinoisScraper(SimpleStateScraper):
    """Scraper for Illinois veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Illinois",
            state_code="IL",
            base_url="https://dvs.il.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Illinois veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Illinois Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.il.gov"
                )
            ],
            source_url="https://dvs.il.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Illinois Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.il.gov"
                )
            ],
            source_url="https://dmv.il.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Illinois public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Illinois institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Illinois Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.il.gov"
                )
            ],
            source_url="https://education.il.gov/veterans",
            last_verified="2026-01-24"
        ))
