...
class KansasScraper(SimpleStateScraper):
    """Scraper for Kansas veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Kansas",
            state_code="KS",
            base_url="https://dvs.ks.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Kansas veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Kansas Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ks.gov"
                )
            ],
            source_url="https://dvs.ks.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Kansas Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ks.gov"
                )
            ],
            source_url="https://dmv.ks.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Kansas public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Kansas institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Kansas Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.ks.gov"
                )
            ],
            source_url="https://education.ks.gov/veterans",
            last_verified="2026-01-24"
        ))
