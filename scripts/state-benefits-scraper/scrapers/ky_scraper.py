"""
Kentucky State Benefits Scraper
"""
...
class KentuckyScraper(SimpleStateScraper):
    """Scraper for Kentucky veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Kentucky",
            state_code="KY",
            base_url="https://dvs.ky.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Kentucky veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Kentucky Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ky.gov"
                )
            ],
            source_url="https://dvs.ky.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Kentucky Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ky.gov"
                )
            ],
            source_url="https://dmv.ky.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Kentucky public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Kentucky institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Kentucky Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.ky.gov"
                )
            ],
            source_url="https://education.ky.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Kentucky.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Kentucky Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.ky.gov"
                )
            ],
            source_url="https://wildlife.ky.gov/veterans",
            last_verified="2026-01-24"
        ))
