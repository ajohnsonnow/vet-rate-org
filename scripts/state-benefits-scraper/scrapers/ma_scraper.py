"""
Massachusetts State Benefits Scraper
"""
...
class MassachusettsScraper(SimpleStateScraper):
    """Scraper for Massachusetts veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Massachusetts",
            state_code="MA",
            base_url="https://dvs.ma.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Massachusetts veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Massachusetts Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ma.gov"
                )
            ],
            source_url="https://dvs.ma.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Massachusetts Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ma.gov"
                )
            ],
            source_url="https://dmv.ma.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Massachusetts public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Massachusetts institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Massachusetts Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.ma.gov"
                )
            ],
            source_url="https://education.ma.gov/veterans",
            last_verified="2026-01-24"
        ))
