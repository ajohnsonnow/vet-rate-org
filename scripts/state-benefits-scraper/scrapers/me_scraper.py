...
class MaineScraper(SimpleStateScraper):
    """Scraper for Maine veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Maine",
            state_code="ME",
            base_url="https://dvs.me.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Maine veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Maine Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.me.gov"
                )
            ],
            source_url="https://dvs.me.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Maine Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.me.gov"
                )
            ],
            source_url="https://dmv.me.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Maine.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Maine Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.me.gov"
                )
            ],
            source_url="https://wildlife.me.gov/veterans",
            last_verified="2026-01-24"
        ))
