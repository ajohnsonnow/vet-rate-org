"""
Michigan State Benefits Scraper
"""
...
class MichiganScraper(SimpleStateScraper):
    """Scraper for Michigan veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Michigan",
            state_code="MI",
            base_url="https://dvs.mi.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Michigan veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Michigan Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.mi.gov"
                )
            ],
            source_url="https://dvs.mi.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Michigan Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.mi.gov"
                )
            ],
            source_url="https://dmv.mi.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Michigan public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Michigan institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Michigan Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.mi.gov"
                )
            ],
            source_url="https://education.mi.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Michigan.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Michigan Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.mi.gov"
                )
            ],
            source_url="https://wildlife.mi.gov/veterans",
            last_verified="2026-01-24"
        ))
