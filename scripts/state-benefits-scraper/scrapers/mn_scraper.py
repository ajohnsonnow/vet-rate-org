"""
Minnesota State Benefits Scraper
"""
...
class MinnesotaScraper(SimpleStateScraper):
    """Scraper for Minnesota veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Minnesota",
            state_code="MN",
            base_url="https://dvs.mn.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Minnesota veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Minnesota Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.mn.gov"
                )
            ],
            source_url="https://dvs.mn.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Minnesota Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.mn.gov"
                )
            ],
            source_url="https://dmv.mn.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Minnesota public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Minnesota institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Minnesota Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.mn.gov"
                )
            ],
            source_url="https://education.mn.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Minnesota.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Minnesota Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.mn.gov"
                )
            ],
            source_url="https://wildlife.mn.gov/veterans",
            last_verified="2026-01-24"
        ))
