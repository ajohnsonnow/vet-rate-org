"""
Missouri State Benefits Scraper
"""
...
class MissouriScraper(SimpleStateScraper):
    """Scraper for Missouri veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Missouri",
            state_code="MO",
            base_url="https://dvs.mo.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Missouri veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Missouri Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.mo.gov"
                )
            ],
            source_url="https://dvs.mo.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Missouri Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.mo.gov"
                )
            ],
            source_url="https://dmv.mo.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Missouri public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Missouri institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Missouri Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.mo.gov"
                )
            ],
            source_url="https://education.mo.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Missouri.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Missouri Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.mo.gov"
                )
            ],
            source_url="https://wildlife.mo.gov/veterans",
            last_verified="2026-01-24"
        ))
