"""
Mississippi State Benefits Scraper
"""
...
class MississippiScraper(SimpleStateScraper):
    """Scraper for Mississippi veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Mississippi",
            state_code="MS",
            base_url="https://dvs.ms.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Mississippi veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Mississippi Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ms.gov"
                )
            ],
            source_url="https://dvs.ms.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Mississippi Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ms.gov"
                )
            ],
            source_url="https://dmv.ms.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Mississippi.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Mississippi Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.ms.gov"
                )
            ],
            source_url="https://wildlife.ms.gov/veterans",
            last_verified="2026-01-24"
        ))
