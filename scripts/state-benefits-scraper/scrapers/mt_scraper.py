"""
Montana State Benefits Scraper
"""
...
class MontanaScraper(SimpleStateScraper):
    """Scraper for Montana veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Montana",
            state_code="MT",
            base_url="https://dvs.mt.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Montana veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Montana Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.mt.gov"
                )
            ],
            source_url="https://dvs.mt.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Montana Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.mt.gov"
                )
            ],
            source_url="https://dmv.mt.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Montana.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Montana Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.mt.gov"
                )
            ],
            source_url="https://wildlife.mt.gov/veterans",
            last_verified="2026-01-24"
        ))
