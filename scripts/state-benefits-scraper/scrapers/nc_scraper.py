"""
North Carolina State Benefits Scraper
"""
...
class NorthCarolinaScraper(SimpleStateScraper):
    """Scraper for North Carolina veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="North Carolina",
            state_code="NC",
            base_url="https://dvs.nc.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all North Carolina veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="North Carolina Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.nc.gov"
                )
            ],
            source_url="https://dvs.nc.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="North Carolina Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.nc.gov"
                )
            ],
            source_url="https://dmv.nc.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at North Carolina public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your North Carolina institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="North Carolina Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.nc.gov"
                )
            ],
            source_url="https://education.nc.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in North Carolina.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="North Carolina Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.nc.gov"
                )
            ],
            source_url="https://wildlife.nc.gov/veterans",
            last_verified="2026-01-24"
        ))
