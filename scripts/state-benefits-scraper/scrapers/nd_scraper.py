"""
North Dakota State Benefits Scraper
"""
...
class NorthDakotaScraper(SimpleStateScraper):
    """Scraper for North Dakota veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="North Dakota",
            state_code="ND",
            base_url="https://dvs.nd.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all North Dakota veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="North Dakota Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.nd.gov"
                )
            ],
            source_url="https://dvs.nd.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="North Dakota Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.nd.gov"
                )
            ],
            source_url="https://dmv.nd.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in North Dakota.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="North Dakota Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.nd.gov"
                )
            ],
            source_url="https://wildlife.nd.gov/veterans",
            last_verified="2026-01-24"
        ))
