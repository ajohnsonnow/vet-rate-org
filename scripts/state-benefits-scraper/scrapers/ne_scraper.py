"""
Nebraska State Benefits Scraper
"""
...
class NebraskaScraper(SimpleStateScraper):
    """Scraper for Nebraska veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Nebraska",
            state_code="NE",
            base_url="https://dvs.ne.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Nebraska veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Nebraska Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ne.gov"
                )
            ],
            source_url="https://dvs.ne.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Nebraska Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ne.gov"
                )
            ],
            source_url="https://dmv.ne.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Nebraska public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Nebraska institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Nebraska Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.ne.gov"
                )
            ],
            source_url="https://education.ne.gov/veterans",
            last_verified="2026-01-24"
        ))
