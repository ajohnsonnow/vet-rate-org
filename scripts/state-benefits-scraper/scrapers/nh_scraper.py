"""
New Hampshire State Benefits Scraper
"""
...
class NewHampshireScraper(SimpleStateScraper):
    """Scraper for New Hampshire veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="New Hampshire",
            state_code="NH",
            base_url="https://dvs.nh.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all New Hampshire veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="New Hampshire Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.nh.gov"
                )
            ],
            source_url="https://dvs.nh.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="New Hampshire Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.nh.gov"
                )
            ],
            source_url="https://dmv.nh.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in New Hampshire.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="New Hampshire Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.nh.gov"
                )
            ],
            source_url="https://wildlife.nh.gov/veterans",
            last_verified="2026-01-24"
        ))
