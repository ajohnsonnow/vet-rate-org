"""
New Jersey State Benefits Scraper
"""
...
class NewJerseyScraper(SimpleStateScraper):
    """Scraper for New Jersey veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="New Jersey",
            state_code="NJ",
            base_url="https://dvs.nj.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all New Jersey veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="New Jersey Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.nj.gov"
                )
            ],
            source_url="https://dvs.nj.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="New Jersey Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.nj.gov"
                )
            ],
            source_url="https://dmv.nj.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at New Jersey public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your New Jersey institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="New Jersey Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.nj.gov"
                )
            ],
            source_url="https://education.nj.gov/veterans",
            last_verified="2026-01-24"
        ))
