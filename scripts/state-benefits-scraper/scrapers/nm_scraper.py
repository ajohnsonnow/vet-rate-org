"""
New Mexico State Benefits Scraper
"""
...
class NewMexicoScraper(SimpleStateScraper):
    """Scraper for New Mexico veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="New Mexico",
            state_code="NM",
            base_url="https://dvs.nm.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all New Mexico veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="New Mexico Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.nm.gov"
                )
            ],
            source_url="https://dvs.nm.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="New Mexico Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.nm.gov"
                )
            ],
            source_url="https://dmv.nm.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at New Mexico public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your New Mexico institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="New Mexico Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.nm.gov"
                )
            ],
            source_url="https://education.nm.gov/veterans",
            last_verified="2026-01-24"
        ))
