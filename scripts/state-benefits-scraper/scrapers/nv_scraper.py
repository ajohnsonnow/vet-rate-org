...
class NevadaScraper(SimpleStateScraper):
    """Scraper for Nevada veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Nevada",
            state_code="NV",
            base_url="https://dvs.nv.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Nevada veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Nevada Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.nv.gov"
                )
            ],
            source_url="https://dvs.nv.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Nevada Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.nv.gov"
                )
            ],
            source_url="https://dmv.nv.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Nevada public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Nevada institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Nevada Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.nv.gov"
                )
            ],
            source_url="https://education.nv.gov/veterans",
            last_verified="2026-01-24"
        ))
