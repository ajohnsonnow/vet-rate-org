"""
New York State Benefits Scraper
"""
...
class NewYorkScraper(SimpleStateScraper):
    """Scraper for New York veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="New York",
            state_code="NY",
            base_url="https://dvs.ny.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all New York veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="New York Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ny.gov"
                )
            ],
            source_url="https://dvs.ny.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="New York Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ny.gov"
                )
            ],
            source_url="https://dmv.ny.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at New York public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your New York institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="New York Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.ny.gov"
                )
            ],
            source_url="https://education.ny.gov/veterans",
            last_verified="2026-01-24"
        ))
