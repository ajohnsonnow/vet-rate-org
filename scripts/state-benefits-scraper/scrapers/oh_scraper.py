...
class OhioScraper(SimpleStateScraper):
    """Scraper for Ohio veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Ohio",
            state_code="OH",
            base_url="https://dvs.oh.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Ohio veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Ohio Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.oh.gov"
                )
            ],
            source_url="https://dvs.oh.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Ohio Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.oh.gov"
                )
            ],
            source_url="https://dmv.oh.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Ohio public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Ohio institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Ohio Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.oh.gov"
                )
            ],
            source_url="https://education.oh.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Ohio.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Ohio Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.oh.gov"
                )
            ],
            source_url="https://wildlife.oh.gov/veterans",
            last_verified="2026-01-24"
        ))
