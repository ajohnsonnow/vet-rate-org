"""
Oklahoma State Benefits Scraper
"""
...
class OklahomaScraper(SimpleStateScraper):
    """Scraper for Oklahoma veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Oklahoma",
            state_code="OK",
            base_url="https://dvs.ok.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Oklahoma veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Oklahoma Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ok.gov"
                )
            ],
            source_url="https://dvs.ok.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Oklahoma Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ok.gov"
                )
            ],
            source_url="https://dmv.ok.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Oklahoma public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Oklahoma institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Oklahoma Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.ok.gov"
                )
            ],
            source_url="https://education.ok.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Oklahoma.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Oklahoma Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.ok.gov"
                )
            ],
            source_url="https://wildlife.ok.gov/veterans",
            last_verified="2026-01-24"
        ))
