...
class OregonScraper(SimpleStateScraper):
    """Scraper for Oregon veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Oregon",
            state_code="OR",
            base_url="https://dvs.or.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Oregon veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Oregon Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.or.gov"
                )
            ],
            source_url="https://dvs.or.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Oregon Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.or.gov"
                )
            ],
            source_url="https://dmv.or.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Oregon public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Oregon institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Oregon Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.or.gov"
                )
            ],
            source_url="https://education.or.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Oregon.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Oregon Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.or.gov"
                )
            ],
            source_url="https://wildlife.or.gov/veterans",
            last_verified="2026-01-24"
        ))
