"""
Pennsylvania State Benefits Scraper
"""
...
class PennsylvaniaScraper(SimpleStateScraper):
    """Scraper for Pennsylvania veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Pennsylvania",
            state_code="PA",
            base_url="https://dvs.pa.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Pennsylvania veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Pennsylvania Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.pa.gov"
                )
            ],
            source_url="https://dvs.pa.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Pennsylvania Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.pa.gov"
                )
            ],
            source_url="https://dmv.pa.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Pennsylvania.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Pennsylvania Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.pa.gov"
                )
            ],
            source_url="https://wildlife.pa.gov/veterans",
            last_verified="2026-01-24"
        ))
