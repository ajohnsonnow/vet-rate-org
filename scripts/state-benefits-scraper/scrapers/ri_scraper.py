"""
Rhode Island State Benefits Scraper
"""
...
class RhodeIslandScraper(SimpleStateScraper):
    """Scraper for Rhode Island veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Rhode Island",
            state_code="RI",
            base_url="https://dvs.ri.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Rhode Island veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Rhode Island Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ri.gov"
                )
            ],
            source_url="https://dvs.ri.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Rhode Island Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ri.gov"
                )
            ],
            source_url="https://dmv.ri.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Rhode Island public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Rhode Island institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Rhode Island Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.ri.gov"
                )
            ],
            source_url="https://education.ri.gov/veterans",
            last_verified="2026-01-24"
        ))
