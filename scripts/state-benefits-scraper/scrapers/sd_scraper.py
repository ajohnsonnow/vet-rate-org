"""
South Dakota State Benefits Scraper
"""
...
class SouthDakotaScraper(SimpleStateScraper):
    """Scraper for South Dakota veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="South Dakota",
            state_code="SD",
            base_url="https://dvs.sd.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all South Dakota veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="South Dakota Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.sd.gov"
                )
            ],
            source_url="https://dvs.sd.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="South Dakota Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.sd.gov"
                )
            ],
            source_url="https://dmv.sd.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in South Dakota.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="South Dakota Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.sd.gov"
                )
            ],
            source_url="https://wildlife.sd.gov/veterans",
            last_verified="2026-01-24"
        ))
