"""
Tennessee State Benefits Scraper
"""
...
class TennesseeScraper(SimpleStateScraper):
    """Scraper for Tennessee veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Tennessee",
            state_code="TN",
            base_url="https://dvs.tn.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Tennessee veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Tennessee Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.tn.gov"
                )
            ],
            source_url="https://dvs.tn.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Tennessee Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.tn.gov"
                )
            ],
            source_url="https://dmv.tn.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Tennessee.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Tennessee Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.tn.gov"
                )
            ],
            source_url="https://wildlife.tn.gov/veterans",
            last_verified="2026-01-24"
        ))
