...
class UtahScraper(SimpleStateScraper):
    """Scraper for Utah veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Utah",
            state_code="UT",
            base_url="https://dvs.ut.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Utah veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Utah Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.ut.gov"
                )
            ],
            source_url="https://dvs.ut.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Utah Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.ut.gov"
                )
            ],
            source_url="https://dmv.ut.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Utah public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Utah institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Utah Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.ut.gov"
                )
            ],
            source_url="https://education.ut.gov/veterans",
            last_verified="2026-01-24"
        ))
