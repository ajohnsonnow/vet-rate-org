"""
Virginia State Benefits Scraper
"""
...
class VirginiaScraper(SimpleStateScraper):
    """Scraper for Virginia veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Virginia",
            state_code="VA",
            base_url="https://dvs.va.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Virginia veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Virginia Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.va.gov"
                )
            ],
            source_url="https://dvs.va.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Virginia Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.va.gov"
                )
            ],
            source_url="https://dmv.va.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Virginia public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Virginia institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Virginia Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.va.gov"
                )
            ],
            source_url="https://education.va.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Virginia.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Virginia Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.va.gov"
                )
            ],
            source_url="https://wildlife.va.gov/veterans",
            last_verified="2026-01-24"
        ))
