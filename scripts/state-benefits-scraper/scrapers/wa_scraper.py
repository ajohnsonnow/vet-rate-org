"""
Washington State Benefits Scraper
"""
...
class WashingtonScraper(SimpleStateScraper):
    """Scraper for Washington veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Washington",
            state_code="WA",
            base_url="https://dvs.wa.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Washington veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Washington Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.wa.gov"
                )
            ],
            source_url="https://dvs.wa.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Washington Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.wa.gov"
                )
            ],
            source_url="https://dmv.wa.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Washington public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Washington institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Washington Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.wa.gov"
                )
            ],
            source_url="https://education.wa.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Washington.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Washington Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.wa.gov"
                )
            ],
            source_url="https://wildlife.wa.gov/veterans",
            last_verified="2026-01-24"
        ))
