"""
Wisconsin State Benefits Scraper
"""
...
class WisconsinScraper(SimpleStateScraper):
    """Scraper for Wisconsin veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="Wisconsin",
            state_code="WI",
            base_url="https://dvs.wi.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all Wisconsin veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Wisconsin Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.wi.gov"
                )
            ],
            source_url="https://dvs.wi.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="Wisconsin Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.wi.gov"
                )
            ],
            source_url="https://dmv.wi.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at Wisconsin public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your Wisconsin institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="Wisconsin Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.wi.gov"
                )
            ],
            source_url="https://education.wi.gov/veterans",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Recreation",
            description="Disabled veterans receive discounted or free hunting and fishing licenses in Wisconsin.",
            ...
            legal_citations=[
                LegalCitation(
                    statute="Wisconsin Wildlife Code",
                    description="License discounts for disabled veterans",
                    url="https://wildlife.wi.gov"
                )
            ],
            source_url="https://wildlife.wi.gov/veterans",
            last_verified="2026-01-24"
        ))
