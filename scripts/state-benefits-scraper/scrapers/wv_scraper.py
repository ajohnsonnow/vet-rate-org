"""
West Virginia State Benefits Scraper
"""
...
class WestVirginiaScraper(SimpleStateScraper):
    """Scraper for West Virginia veteran benefits"""
    
    def __init__(self):
        super().__init__(
            state_name="West Virginia",
            state_code="WV",
            base_url="https://dvs.wv.gov"
        )
    
    def scrape_benefits(self) -> list[Benefit]:
        """Scrape all West Virginia veteran benefits"""
        benefits = []
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="West Virginia Property Tax Code",
                    description="Property tax exemption for 100% disabled veterans",
                    url="https://dvs.wv.gov"
                )
            ],
            source_url="https://dvs.wv.gov/benefits/property-tax",
        ...
        benefits.append(Benefit(
            ...
            legal_citations=[
                LegalCitation(
                    statute="West Virginia Vehicle Code",
                    description="Disabled veteran license plates",
                    url="https://dmv.wv.gov"
                )
            ],
            source_url="https://dmv.wv.gov/dv-plates",
            last_verified="2026-01-24"
        ))
        ...
        benefits.append(Benefit(
            ...
            category="Education",
            description="Veterans using GI Bill benefits qualify for in-state tuition at West Virginia public colleges and universities.",
            ...
            how_to_apply="Contact the veterans services office at your West Virginia institution. Submit DD-214 and proof of GI Bill eligibility.",
            legal_citations=[
                LegalCitation(
                    statute="West Virginia Education Code",
                    description="In-state tuition for veterans",
                    url="https://education.wv.gov"
                )
            ],
            source_url="https://education.wv.gov/veterans",
            last_verified="2026-01-24"
        ))
