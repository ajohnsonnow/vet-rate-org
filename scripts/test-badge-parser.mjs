...
console.log(
  "║       BADGE PARSER TEST - Williams DD214 Badge Detection         ║",
);
console.log(
  "╚══════════════════════════════════════════════════════════════════╝\n",
);
...
console.log(
  "│ TEST 1: Williams TF Phoenix III (Afghanistan Combat Deployment)  │",
);
console.log(
  "└──────────────────────────────────────────────────────────────────┘",
);
...
console.log(
  "│ TEST 2: Williams TF Phoenix V (Second Afghanistan Deployment)    │",
);
console.log(
  "└──────────────────────────────────────────────────────────────────┘",
);
...
const tests = [
  ...
  { name: "Comprehensive Badge Detection", passed: missingBadges.length === 0 },
  {
    ...
    passed: tf3Results.combatIndicators.length > 0,
  },
];
