...
function parseCommit(message) {
  ...
  const conventionalPattern = /^(feat|fix|docs|style|refactor|perf|test|build|ci|chore|hotfix|HOTFIX)(?:\(([^)]+)\))?:\s*(.+)$/i;
...
function generateMarkdownChangelog(version, date, commits) {
  ...
  // Order sections
  const sectionOrder = ['Added', 'Changed', 'Fixed', 'Documentation', 'Security', 'Deprecated', 'Removed'];
