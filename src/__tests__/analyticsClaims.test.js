 ...
 * claims that carry legal and human stakes. This guards the two named surfaces.
 */
const read = (p) => readFileSync(join(process.cwd(), p), "utf8");

const SURFACES = ["README.md", "public/faq.html"];
const FALSE_CLAIMS = [/no analytics/i, /zero data collection/i];
