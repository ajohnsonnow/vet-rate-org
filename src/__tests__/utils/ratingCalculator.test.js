...
import { calculateCombinedRating, calculateMonthlyCompensation, checkBilateralFactor, calculateExactCombinedRating } from '../../utils/ratingCalculator';
...
describe('calculateCombinedRating', () => {
  ...
  it('order does not matter', () => {
    expect(calculateCombinedRating([40, 60])).toBe(calculateCombinedRating([60, 40]));
    expect(calculateCombinedRating([20, 40, 60])).toBe(calculateCombinedRating([60, 40, 20]));
  });
