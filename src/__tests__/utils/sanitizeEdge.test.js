...
describe("sanitizeUrl - edge cases", () => {
  it("handles URLs with query params", () => {
    expect(sanitizeUrl("https://va.gov/search?q=ptsd")).toBe(
      "https://va.gov/search?q=ptsd",
    );
  });

  it("handles URLs with fragments", () => {
    expect(sanitizeUrl("https://va.gov/page#section")).toBe(
      "https://va.gov/page#section",
    );
  });
