  ...
  return (
    <div className="relative inline-block">
      ...
      <button
        ...
        `}
        title={isListening ? 'Stop Dictation (Click to Stop)' : 'Start Dictation (Click to Speak)'}
        aria-label={isListening ? 'Stop dictation' : 'Start dictation'}
      >
        {isListening ? (
          // Recording icon
          <svg className={`${iconSizeClasses[size]} mx-auto`} fill="currentColor" viewBox="0 0 20 20">
      ...
      {error && (
        <div className="absolute bottom-full mb-2 left-1/2 transform -translate-x-1/2 
          ...
          <div className="absolute top-full left-1/2 transform -translate-x-1/2 
                        border-4 border-transparent border-t-red-500"></div>
        </div>
      )}
