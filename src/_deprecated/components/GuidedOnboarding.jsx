...
const CLAIM_STAGES = [
  ...
  },
  {
    ...
    description:
      "I have conditions identified and need to gather supporting evidence",
    tools: [
      "cfile-analyzer",
      "blue-button",
      "nexus-builder",
...
const BODY_SYSTEMS = [
  {
    ...
    desc: "Back, joints, spine, orthopedic",
  },
  {
    id: "mental-health",
    icon: "🧠",
    name: "Mental Health",
    desc: "PTSD, anxiety, depression, TBI",
  },
  {
    id: "respiratory",
    icon: "🫁",
    name: "Respiratory",
    desc: "Lungs, asthma, sleep apnea",
  },
  {
    id: "cardiovascular",
    icon: "❤️",
    name: "Cardiovascular",
    desc: "Heart, hypertension, circulation",
  },
  {
    id: "neurological",
    icon: "⚡",
    name: "Neurological",
    desc: "Nerve damage, migraines, seizures",
  },
  {
    id: "digestive",
    icon: "🔥",
    name: "Digestive",
    desc: "GERD, IBS, liver conditions",
  },
  {
    id: "skin",
    icon: "🩹",
    name: "Skin",
    desc: "Scars, eczema, burn injuries",
  },
  {
    id: "hearing-vision",
    icon: "👁️",
    name: "Hearing & Vision",
    desc: "Tinnitus, hearing loss, vision",
  },
  {
    id: "toxic-exposure",
    icon: "☢️",
    name: "Toxic Exposure",
    desc: "Burn pits, Agent Orange, radiation",
    highlight: true,
  },
];
...
const AI_OPTIONS = [
  {
    ...
    description:
      "100% offline, maximum privacy. AI runs entirely on your device.",
    badge: "Recommended",
    privacy: "Maximum",
  },
  {
  ...
  },
  {
    ...
    title: "Manual Mode",
    description:
      "Use all tools without AI assistance. Full functionality, your expertise.",
    badge: null,
    privacy: "No AI",
  },
];
...
export default function GuidedOnboarding({ onComplete, onSkip }) {
  ...
  return (
    <div className={containerClasses}>
      {/* Header */}
      <header
        className={`px-4 py-6 ${isDark || isTbiComfort ? "bg-gray-800/50" : "bg-white/80"} backdrop-blur-sm border-b ${isDark || isTbiComfort ? "border-gray-700" : "border-slate-200"}`}
      >
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <div>
            <h1
              className={`text-2xl font-black ${isDark || isTbiComfort ? "text-white" : "text-slate-900"}`}
            >
              🎖️ Mission Planning
            </h1>
            <p
          ...
          <div className="flex items-center gap-2">
            {[1, 2, 3].map((s) => (
              <div key={s} className="flex-1 flex items-center gap-2">
                ...
                {s < 3 && (
                  <div
                    className={`flex-1 h-1 rounded-full ${s < step ? "bg-green-600" : `${isDark || isTbiComfort ? "bg-gray-700" : "bg-slate-200"}`}`}
                  />
                )}
              </div>
            ))}
            ...
            <span
              className={
                step >= 1
                  ...
                  : `${isDark || isTbiComfort ? "text-gray-500" : "text-slate-400"}`
              }
            >
              Claim Stage
            </span>
          ...
          {step === 1 && (
            <div className="space-y-4">
              <div className="text-center mb-8">
                <h2
                  className={`text-2xl font-bold ${isDark || isTbiComfort ? "text-white" : "text-slate-900"}`}
                >
                  Where are you in your claims journey?
                </h2>
                <p
                  className={`mt-2 ${isDark || isTbiComfort ? "text-gray-400" : "text-slate-600"}`}
                >
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        <h3
                          className={`text-lg font-bold ${isDark || isTbiComfort ? "text-white" : "text-slate-900"}`}
                        >
                          {stage.title}
                        </h3>
                        <p
            ...
            <div className="space-y-4">
              <div className="text-center mb-8">
                ...
                <p
                  className={`mt-2 ${isDark || isTbiComfort ? "text-gray-400" : "text-slate-600"}`}
                >
                  Select all that apply (optional) • This pre-loads relevant
                  diagnostic codes
                </p>
              </div>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                {BODY_SYSTEMS.map((system) => (
                  ...
                  >
                    ...
                    <h3
                      className={`text-sm font-bold ${isDark || isTbiComfort ? "text-white" : "text-slate-900"}`}
                    >
                      {system.name}
                    </h3>
                    <p
                      className={`text-xs mt-1 ${isDark || isTbiComfort ? "text-gray-500" : "text-slate-500"}`}
                    >
                      {system.desc}
                    </p>
                    {selections.bodySystems.includes(system.id) && (
                      <span className="absolute top-2 left-2 text-blue-500 text-lg">
                        ✓
                      </span>
                    )}
                  </button>
            ...
            <div className="space-y-4">
              <div className="text-center mb-8">
                ...
                <p
                  className={`mt-2 ${isDark || isTbiComfort ? "text-gray-400" : "text-slate-600"}`}
                >
                  All modes provide full tool access • AI enhances analysis
                  capabilities
                </p>
              </div>
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p
                          className={`text-xs mt-1 font-medium ${isDark || isTbiComfort ? "text-gray-500" : "text-slate-500"}`}
                        >
      ...
      {/* Footer */}
      <footer
        className={`px-4 py-4 ${isDark || isTbiComfort ? "bg-gray-800/50" : "bg-white/80"} backdrop-blur-sm border-t ${isDark || isTbiComfort ? "border-gray-700" : "border-slate-200"}`}
      >
        <div className="max-w-3xl mx-auto flex items-center justify-between">
          <button
            onClick={handleBack}
...
export function useOnboardingStatus() {
  ...
  useEffect(() => {
    const completed =
      localStorage.getItem("vetrate-onboarding-complete") === "true";
