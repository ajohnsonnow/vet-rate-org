...
const MISSION_STAGES = [
  {
    ...
    icon: "🔭",
    description:
      "Find conditions you may be entitled to claim based on your service, exposures, and symptoms.",
    color: "service-blue",
    tools: [
      {
        id: "smart-search",
        name: "Smart Search",
        desc: "Search conditions & diagnostic codes",
        icon: "🔍",
      },
      {
        id: "pact-navigator",
        name: "PACT Act Navigator",
        desc: "Presumptive conditions from toxic exposure",
        icon: "⚠️",
      },
      {
        id: "mos-hazard",
        name: "MOS Hazard Matcher",
        desc: "Match your MOS to related conditions",
        icon: "🎖️",
      },
      {
        id: "web-conditions",
        name: "Web of Conditions",
        desc: "Visual map of condition relationships",
        icon: "🕸️",
      },
      {
        id: "secondary-scout",
        name: "Secondary Scout",
        desc: "Find secondary conditions",
        icon: "🔗",
      },
    ],
  },
  {
    ...
    icon: "📂",
    description:
      "Analyze your records and build strong nexus links between service and conditions.",
    color: "violet",
    tools: [
      {
        id: "cfile-analyzer",
        name: "C-File AI Analyzer",
        desc: "Extract evidence from your claims file",
        icon: "📋",
        local: true,
      },
      {
        ...
        desc: "Analyze VA health records",
        icon: "💙",
        local: true,
      },
      {
        id: "dd214-analyzer",
        name: "DD214 Analyzer",
        desc: "Parse your service record",
        icon: "📜",
        local: true,
      },
      {
        id: "nexus-builder",
        name: "Nexus Builder",
        desc: "Build medical nexus statements",
        icon: "🔗",
      },
      {
        id: "witness-bench",
        name: "Witness Bench",
        desc: "Draft buddy statements",
        icon: "✍️",
      },
      {
        id: "symptom-logger",
  ...
  },
  {
    ...
    icon: "🛡️",
    description:
      "Simulate C&P exams, identify weaknesses, and prepare counter-arguments.",
    color: "rose",
    tools: [
      {
        id: "cap-simulator",
        name: "C&P Exam Simulator",
        desc: "Practice exam scenarios",
        icon: "🎯",
      },
      {
        id: "nexus-analyzer",
        name: "Nexus Quality Analyzer",
        desc: "Score nexus letter strength (BVA data)",
        icon: "📊",
        badge: "NEW",
      },
      {
        ...
        desc: "Pre-submission gap finder",
        icon: "🔍",
        badge: "NEW",
      },
      {
        ...
        desc: "Choose the right appeal path",
        icon: "🛤️",
        badge: "NEW",
      },
      {
        id: "red-team",
        name: "The War Game",
        desc: "VA rater perspective stress test",
        icon: "♟️",
      },
      {
        id: "consistency-engine",
        name: "Consistency Engine",
        desc: "Check statement consistency",
        icon: "⚖️",
      },
      {
        id: "evidence-gaps",
        name: "Evidence Gap Finder",
        desc: "Identify missing evidence",
        icon: "🔎",
      },
      {
        id: "denial-decoder",
        name: "Denial Decoder",
        desc: "Decode VA decision letters",
        icon: "📖",
      },
    ],
  },
  {
    ...
    icon: "🧮",
    description:
      "Calculate your combined rating and understand your monthly compensation.",
    color: "amber",
    tools: [
      {
        id: "tactical-calc",
        name: "Tactical Calculator",
        desc: "Calculate combined rating",
        icon: "🧮",
      },
      {
        id: "million-dollar",
        name: "Million Dollar Dashboard",
        desc: "Lifetime benefits visualization",
        icon: "💰",
      },
      {
        id: "whatif-sandbox",
        name: "What-If Sandbox",
        desc: "Simulate different scenarios",
        icon: "🎲",
      },
      {
        id: "retro-hunter",
        name: "Retro Pay Hunter",
        desc: "Calculate back pay",
        icon: "💵",
      },
      {
        id: "tdiu-builder",
        name: "TDIU Builder",
        desc: "Individual Unemployability claims",
        icon: "📊",
      },
    ],
  },
  {
    ...
    icon: "🤝",
    description:
      "Find VSOs, state benefits, and community support for your journey.",
    color: "sky",
    tools: [
      {
        id: "vso-finder",
        name: "VSO Finder",
        desc: "Find local service officers",
        icon: "👥",
      },
      {
        id: "state-benefits",
        name: "State Benefits",
        desc: "State-specific veteran benefits",
        icon: "🏛️",
      },
      {
        id: "forms-helper",
        name: "Forms Helper",
        desc: "Complete VA forms correctly",
        icon: "📝",
      },
      {
        id: "va-resources",
        name: "VA Resources",
        desc: "Official VA links & tools",
        icon: "🔗",
      },
      {
        id: "backup-manager",
        name: "The Bunker",
        desc: "Backup & sync your data",
        icon: "💾",
      },
    ],
  },
    ...
    >
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          <h4
            className={`font-bold text-base sm:text-lg ${isDark || isTbiComfort ? "text-white" : "text-slate-900"} group-hover:text-blue-600 dark:group-hover:text-blue-400 truncate`}
          >
            {tool.name}
          </h4>
          <p
            className={`text-sm ${isDark || isTbiComfort ? "text-gray-400" : "text-slate-600"} line-clamp-2`}
          >
            {tool.desc}
          </p>
        </div>
      ...
      <div
        className={`mt-3 text-xs font-bold uppercase tracking-wider ${isDark || isTbiComfort ? "text-blue-400" : "text-blue-600"} opacity-0 group-hover:opacity-100 transition-opacity`}
      >
        Launch Tool →
      </div>
    </button>
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 text-left">
        <p
          className={`text-[10px] font-black uppercase tracking-widest ${isActive ? "text-blue-600 dark:text-blue-400" : "text-gray-500"}`}
        >
          Phase {index + 1}
        </p>
        <h3
          className={`font-bold text-sm sm:text-base ${isDark || isTbiComfort ? "text-white" : "text-slate-900"} truncate`}
        >
          {stage.title}
        </h3>
        <p
          className={`text-xs ${isDark || isTbiComfort ? "text-gray-400" : "text-slate-500"} hidden sm:block`}
        >
          {stage.subtitle}
        </p>
      </div>

      <span className="text-xl hidden sm:block" aria-hidden="true">
        {stage.icon}
      </span>
    </button>
  );
...
export default function MissionRoadmap({
  ...
  return (
    <div
      className={`fixed inset-0 z-50 overflow-y-auto ${isDark || isTbiComfort ? "bg-gray-900" : "bg-slate-50"}`}
    >
      {/* Header */}
      <header
        className={`sticky top-0 z-10 ${isDark || isTbiComfort ? "bg-gray-900/95" : "bg-white/95"} backdrop-blur-sm border-b ${isDark || isTbiComfort ? "border-gray-700" : "border-slate-200"} px-4 py-4`}
      >
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div>
            <h1
              className={`text-2xl sm:text-3xl font-black ${isDark || isTbiComfort ? "text-white" : "text-slate-900"} tracking-tight`}
            >
              🗺️ Mission Roadmap
            </h1>
            <p
              className={`text-sm ${isDark || isTbiComfort ? "text-gray-400" : "text-slate-600"}`}
            >
      ...
      <main className="max-w-7xl mx-auto px-4 py-6 sm:py-8">
        ...
        <section
          className={`rounded-3xl ${isDark || isTbiComfort ? "bg-gray-800/50" : "bg-white"} p-6 sm:p-8 border-2 ${isDark || isTbiComfort ? "border-gray-700" : "border-slate-100"} shadow-xl`}
        >
          {/* Stage Header */}
          <div className="mb-8">
            <div className="flex items-center gap-4 mb-4">
              ...
              <div>
                <h2
                  className={`text-2xl sm:text-3xl font-black ${isDark || isTbiComfort ? "text-white" : "text-slate-900"}`}
                >
                  {activeStage.title}
                </h2>
                <p
                  className={`text-lg ${isDark || isTbiComfort ? "text-gray-400" : "text-slate-600"}`}
                >
            ...
            <p
              className={`text-base ${isDark || isTbiComfort ? "text-gray-300" : "text-slate-700"} max-w-3xl`}
            >
        ...
        <footer
          className={`mt-8 p-4 ${isDark || isTbiComfort ? "bg-gray-800/30" : "bg-slate-50"} border ${isDark || isTbiComfort ? "border-gray-700" : "border-slate-200"} rounded-xl`}
        >
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <span
                className={`text-sm font-medium ${isDark || isTbiComfort ? "text-gray-300" : "text-slate-700"}`}
              >
                Security Status:{" "}
