...
const PacketCommander = ({ onClose }) => {
  ...
  const handleAddDocument = () => {
    const newDoc = {
      ...
      pages: 1,
      startPage:
        documents.length > 0 ? documents[documents.length - 1].endPage + 1 : 1,
      endPage:
        documents.length > 0 ? documents[documents.length - 1].endPage + 1 : 1,
      description: "",
    };
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      downloadCoverSheet(
        pdfBytes,
        `Claim_Cover_Sheet_${new Date().toISOString().split("T")[0]}`,
      );
    } catch (error) {
      ...
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">
                  Generate Claim Cover Sheet / Table of Contents
                </p>
              </div>
            </div>
            <button
        ...
        <div className="p-6 space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-blue-700 dark:text-blue-300">
                  VA raters review hundreds of claims. A professional Table of
                  Contents helps them quickly navigate your evidence, increasing
                  the chance of a favorable decision.{" "}
                  <strong>
                    An organized rater approves. A confused rater denies.
                  </strong>
                </p>
              </div>
            </div>
          ...
          <div>
            ...
            >
              <option value="Initial Disability Claim">
              ...
              <option value="Secondary Service Connection">
          ...
          <div>
            <div className="flex items-center justify-between mb-3">
              <label className="block text-sm font-semibold text-gray-700 dark:text-gray-300">
                Documents in Your Packet ({documents.length}{" "}
            ...
            {documents.length === 0 ? (
              <div className="text-center py-12 bg-gray-50 dark:bg-gray-800 rounded-lg border-2 border-dashed border-gray-300 dark:border-gray-600">
                ...
                <p className="text-sm text-gray-400 dark:text-gray-500">
                  Click "Add Document" to start building your packet
                </p>
              </div>
            ) : (
