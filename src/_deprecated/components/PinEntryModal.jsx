        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 rounded">
              <div className="flex">
                ...
                <div className="ml-3 text-sm text-blue-700 dark:text-blue-300">
                  Your data will be encrypted with military-grade AES-256
                  encryption.
                  <strong className="block mt-1">
                    Choose a PIN you'll remember - it cannot be recovered if
                    lost.
                  </strong>
                </div>
              </div>
          ...
          <div className="pt-2 border-t border-gray-200 dark:border-gray-700">
            <div className="flex items-start gap-2 text-xs text-gray-500 dark:text-gray-400">
              ...
              <p>
                Your PIN never leaves your device. All encryption happens in
                your browser using Web Crypto API.
              </p>
            </div>
          </div>
        </form>
