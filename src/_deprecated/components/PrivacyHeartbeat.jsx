  ...
  if (compact) {
    return (
      <div className="flex items-center gap-2">
        ...
        <span
          className={`text-xs font-bold ${statusColor === "green" ? "text-green-600 dark:text-green-400" : statusColor === "yellow" ? "text-yellow-600 dark:text-yellow-400" : "text-blue-600 dark:text-blue-400"}`}
        >
    ...
    >
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          {isProcessing && (
            <p
              className={`text-xs ${isDark || isTbiComfort ? "text-gray-500" : "text-slate-500"} mt-1`}
            >
...
export function PrivacyNotice({ compact = false }) {
  ...
  if (compact) {
    return (
      <p
        className={`text-xs ${isDark || isTbiComfort ? "text-gray-500" : "text-slate-500"} flex items-center gap-1`}
      >
  ...
  return (
    ...
    >
      ...
      <div>
        <p
          className={`text-sm font-semibold ${isDark || isTbiComfort ? "text-green-400" : "text-green-800"}`}
        >
          Privacy Verified
        </p>
        <p
          className={`text-xs ${isDark || isTbiComfort ? "text-green-300/70" : "text-green-700"}`}
        >
          This file is processed entirely in your browser's RAM. No data is
          uploaded, stored, or transmitted. Analysis is wiped when you close the
          tab.
        </p>
      </div>
    </div>
