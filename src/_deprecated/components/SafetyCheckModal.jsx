...
const SafetyCheckModal = ({
  ...
  const content = {
    en: {
      ...
      description:
        "We're about to discuss your service and medical history. To keep your story private and your mind at ease, please confirm:",
      checkpoints: [
    ...
    es: {
      ...
      description:
        "Vamos a discutir tu historial de servicio y médico. Para mantener tu historia privada y tu mente tranquila, por favor confirma:",
      checkpoints: [
    ...
    tl: {
      ...
      description:
        "Pag-uusapan natin ang iyong kasaysayan ng serbisyo at medikal. Para mapanatiling pribado ang iyong kwento, pakikumpirma:",
      checkpoints: [
    ...
    vi: {
      ...
      description:
        "Chúng ta sẽ thảo luận về lịch sử phục vụ và y tế của bạn. Để giữ câu chuyện của bạn riêng tư, vui lòng xác nhận:",
      checkpoints: [
    ...
    ko: {
      title: "🔐 주변 환경을 확인하세요",
      description:
        "귀하의 복무 및 의료 기록에 대해 이야기하겠습니다. 귀하의 이야기를 비공개로 유지하려면 다음을 확인해 주세요:",
      checkpoints: [
  ...
  return (
    <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-50 p-4">
      <div
        className={`max-w-md bg-slate-900 border-2 border-yellow-500/50 rounded-xl p-6 shadow-2xl ${className}`}
      >
        <h2 className="text-xl font-bold text-white mb-4">{c.title}</h2>

        <p className="text-slate-300 mb-6 leading-relaxed">{c.description}</p>
