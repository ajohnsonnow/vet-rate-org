...
const SecurityManager = ({ children }) => {
  ...
  const disableVault = () => {
    if (
      confirm(
        "⚠️ Warning: This will disable encryption and clear all encrypted data. Are you sure?",
      )
    ) {
      // Clear vault data
            ...
            <div className="p-6 space-y-4">
              <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-500 p-4 rounded">
                ...
                <p className="text-sm text-blue-800 dark:text-blue-200">
                  Right now, your data is stored in plain text. If you're using
                  a shared or public computer, anyone with access to your
                  browser could read your trauma history, medical conditions,
              ...
              <div className="space-y-2">
                ...
                <ul className="text-sm text-gray-700 dark:text-gray-300 space-y-1 ml-4">
                  <li>
                    • <strong>Military-grade AES-256 encryption</strong> for all
                    your data
                  </li>
                  <li>
                    • <strong>PIN protection</strong> - only you can access your
                    information
                  </li>
                  <li>
                    • <strong>Auto-lock after 15 minutes</strong> of inactivity
                  </li>
                  <li>
                    • <strong>Zero server uploads</strong> - everything stays on
                    your device
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 p-4 rounded">
                <p className="text-sm text-yellow-800 dark:text-yellow-200">
                  <strong>⚠️ Important:</strong> Choose a PIN you'll remember.
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-8 max-w-md mx-4">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Please wait while we secure your information. This will only
                take a moment.
              </p>
            </div>
          </div>
