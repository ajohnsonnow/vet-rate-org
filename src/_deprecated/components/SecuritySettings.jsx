...
const SecuritySettings = ({ isOpen, onClose, securityContext }) => {
  const { t } = useLanguage();
            ...
            <div className="flex items-center gap-3 text-white">
              ...
              <div>
                ...
                <p className="text-blue-100 text-sm">
                  Protect your sensitive veteran data
                </p>
              </div>
            </div>
            <button
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  Military-grade AES-256 encryption protects all your data with
                  a personal PIN
                </p>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  Auto-lock screen after 15 minutes of inactivity (2-minute
                  warning)
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-500 mt-2 italic">
                  💡 Protects your data if you walk away from a public/shared
                  computer
                </p>
              </div>
              <div className="ml-4">
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-500 mt-2 italic">
                  💡 Share screenshots with VSOs or buddies without exposing
                  sensitive data
                </p>
              </div>
              <div className="ml-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded text-xs">
                  <p className="text-blue-800 dark:text-blue-300">
                    <strong>Accessibility Feature:</strong> Built for veterans
                    with hand tremors, nerve damage, or mobility issues. Click
                    and speak - your words appear automatically.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div className="flex items-start">
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                  Content Security Policy blocks XSS attacks and malicious
                  scripts
                </p>
                <p className="text-xs text-gray-500 dark:text-gray-500 mt-2 italic">
                ...
                <div className="mt-3 p-3 bg-gray-50 dark:bg-gray-900/50 rounded text-xs">
                  <p className="text-gray-700 dark:text-gray-300">
                    <strong>Protection Level:</strong> Blocks 99% of cross-site
                    scripting (XSS) attacks, prompt injection, and unauthorized
                    API calls. Only trusted sources can execute code.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-500 mt-2 italic">
                  💡 Boss coming? Hit the panic button to hide the app instantly
                  (shows fake Google homepage)
                </p>
                <div className="mt-3 p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded text-xs">
                  <p className="text-yellow-800 dark:text-yellow-300">
                    <strong>Privacy Feature:</strong> Replaces your screen with
                    a harmless cover page. Press the same key combo again to
                    restore the app.
                  </p>
                </div>
              </div>
