...
export const COMPONENT_STATS = {
  "tactical-calculator": {
    ...
    lines: 8500,
    description:
      "Combined rating calculator with bilateral factors, dependents, and 2026 pay rates",
  },
  "secondary-scout": {
    ...
    lines: 6200,
    description:
      "Discovery engine for 65+ medically-recognized secondary conditions",
  },
  "cap-simulator": {
    ...
    lines: 7800,
    description:
      "DBQ-aligned practice questions with AI percentage predictions",
  },
  "cfile-analyzer": {
  ...
  "forms-helper": {
    ...
    lines: 6800,
    description:
      "Guided assistance for 16+ VA forms including buddy statements",
  },
  "my-packet": {
    name: "My Packet",
    hours: 290,
  ...
  "decision-decoder": {
    ...
    lines: 4900,
    description:
      "AI analysis of VA decision letters to find appeal opportunities",
  },
  "blue-button-xray": {
  ...
  "million-dollar-dashboard": {
    ...
    lines: 4500,
    description:
      "Lifetime benefit value calculator with retirement projections",
  },
  "pact-act-navigator": {
