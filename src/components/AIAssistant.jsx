      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700">
        <div className="flex gap-2">
          <textarea
            ...
            placeholder={isHelperMode ? "Ask me anything about VA claims..." : "Ask me anything..."}
            className="flex-1 px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 resize-none"
            rows={2}
            disabled={isLoading}
          />
          <button
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
          Press Enter to send • {isHelperMode && '💝 Helper Mode Active'}
        </p>
      </div>
    </div>
  );
