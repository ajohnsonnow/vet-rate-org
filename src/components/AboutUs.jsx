...
function getTypeLabel(type, isNew) {
  if (isNew) return "🆕 NEW";
  const labels = {
    feature: "Feature",
    fix: "Bug Fix",
...
function ChangelogPanel({ version, changelog }) {
  return (
...
const VersionDropUp = () => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && <ChangelogPanel version={version} changelog={changelog} />}
    </div>
  );
};
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-700">
      ...
      <details className="text-xs">
        ...
        <div className="mt-2 bg-gray-50 dark:bg-gray-900/50 rounded p-3 space-y-1 text-gray-600 dark:text-gray-400">
          <p>
            <strong>CPU:</strong> AMD Ryzen 9 7950X3D 4.2 GHz 16-Core
          </p>
          <p>
          ...
          <p>
            ...
            (top slot); Asus ProArt OC RTX 4070 Ti SUPER 16 GB (middle slot)
          </p>
          <p>
          ...
          <p className="pt-1 border-t border-gray-200 dark:border-gray-700 mt-1">
            <strong>eGPU:</strong> Asus Dual GeForce RTX 5060 Ti OC 16GB in
...
function CoreComponentsBlock() {
  return (
    <div className="border-b border-gray-200 dark:border-gray-700 pb-2">
      ...
      <p>
        <strong>React Components:</strong> {FORMATTED_STATS.components}
      </p>
      <p>
        <strong>Utility Modules:</strong> {FORMATTED_STATS.utilities}
      </p>
      <p>
  ...
  return (
    <div className="border-b border-gray-200 dark:border-gray-700 pb-2">
      ...
      <p>
        ...
        {PROJECT_STATS.disabilitiesValidated} rated conditions
      </p>
      <p>
      ...
      <p>
        <strong>PACT Act Data:</strong> Toxic exposure coverage
      </p>
      <p>
        <strong>DBQ Logic Map:</strong> C&P exam question bank
      </p>
    </div>
  );
}
...
function LocalAIArsenalBlock() {
  return (
    <div className="border-t border-gray-200 dark:border-gray-700 pt-2">
      ...
      <p>
        <strong>Local Models:</strong> {PROJECT_STATS.localAIModels} Warrant
        Council agents
      </p>
      <p>
    ...
    <div className="border-t border-gray-200 dark:border-gray-700 pt-2 mt-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-2 text-xs">
        ...
        <div className="bg-purple-50 dark:bg-purple-900/30 rounded p-2">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Crafts compelling personal statements and nexus letters
          </p>
        </div>
        <div className="bg-green-50 dark:bg-green-900/30 rounded p-2">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Calculates VA disability ratings with bilateral factor precision
          </p>
        </div>
      </div>
...
function DevelopmentTimeEstimate() {
  return (
    <>
      <p className="font-semibold text-gray-700 dark:text-gray-300 mb-1">
        ⏱️ Development Time
      ...
      <p className="text-xs mt-1 italic">
        ...
        field manual
        <br />• {PROJECT_STATS.breakdown.research} hrs research (38 CFR
        regulations)
        <br />• {PROJECT_STATS.breakdown.deployment} hrs deployment &
        optimization
      </p>
...
function ActualTimeInvested() {
  return (
    <>
      <hr className="my-2 border-gray-300 dark:border-gray-600" />
      <p>
        <strong>Actual Time Invested:</strong> {FORMATTED_STATS.actualTime}
      </p>
      <p className="text-xs mt-1 italic">
        • First commit: {PROJECT_STATS.git.firstCommitDate} at{" "}
        {PROJECT_STATS.git.firstCommitTime}
        <br />• Latest commit: {PROJECT_STATS.git.latestCommitDate} at{" "}
...
function ComponentBreakdownListPart1() {
  return (
    <>
      <p>
        • <strong>C-File AI Analyzer:</strong> 680 hrs / 9,200 lines
      </p>
      <p>
        • <strong>C&P Exam Simulator:</strong> 520 hrs / 7,800 lines
      </p>
      <p>
        • <strong>Tactical Calculator:</strong> 450 hrs / 8,500 lines
      </p>
      <p>
        • <strong>Forms Helper:</strong> 410 hrs / 6,800 lines
      </p>
      <p>
        • <strong>Blue Button X-Ray:</strong> 380 hrs / 5,100 lines
      </p>
      <p>
        • <strong>Secondary Scout:</strong> 380 hrs / 6,200 lines
      </p>
      <p>
        • <strong>Decision Decoder:</strong> 350 hrs / 4,900 lines
      </p>
      <p>
        • <strong>Smart Search:</strong> 340 hrs / 5,200 lines
      </p>
      <p>
        • <strong>Nexus Builder:</strong> 320 hrs / 5,400 lines
      </p>
      <p>
        • <strong>Million Dollar Dashboard:</strong> 310 hrs / 4,500 lines
      </p>
      <p>
        • <strong>My Packet:</strong> 290 hrs / 4,200 lines
      </p>
      <p>
        • <strong>Web of Conditions:</strong> 290 hrs / 4,100 lines
      </p>
      <p>
        • <strong>Red Team Simulator:</strong> 280 hrs / 3,800 lines
      </p>
      <p>
        • <strong>State Benefit Hunter:</strong> 270 hrs / 3,900 lines
      </p>
    </>
  );
}

function ComponentBreakdownListPart2() {
  return (
    <>
      <p>
        • <strong>PACT Act Navigator:</strong> 260 hrs / 3,700 lines
      </p>
      <p>
        • <strong>Witness Bench:</strong> 240 hrs / 3,600 lines
      </p>
      <p>
        • <strong>MOS Hazard Matcher:</strong> 230 hrs / 3,300 lines
      </p>
      <p>
        • <strong>TDIU Builder:</strong> 220 hrs / 3,100 lines
      </p>
      <p>
        • <strong>Pathfinder:</strong> 210 hrs / 3,200 lines
      </p>
      <p>
        • <strong>Risk Assessment:</strong> 190 hrs / 2,800 lines
      </p>
      <p>
        • <strong>Symptom Logger:</strong> 180 hrs / 2,400 lines
      </p>
      <p>
        • <strong>FOIA Generator:</strong> 170 hrs / 2,500 lines
      </p>
      <p>
        • <strong>Shark Radar:</strong> 160 hrs / 2,200 lines
      </p>
      <p>
        • <strong>VA Resources Hub:</strong> 150 hrs / 2,100 lines
      </p>
      <p>
        • <strong>VSO Finder:</strong> 140 hrs / 1,900 lines
      </p>
      <p>
        • <strong>Accessibility Features:</strong> 120 hrs / 1,600 lines
      </p>
      <p>
        • <strong>Field Manual:</strong> 100 hrs / 1,800 lines
      </p>
    </>
  );
}

function ComponentBreakdownDetails() {
  return (
...
function AboutUsFooter({ onClose, onZonk }) {
  const { t } = useLanguage();
  return (
  ...
  return (
    ...
    >
      <div className={`${modalClasses.content} max-w-4xl my-8`}>
        ...
        <AboutUsFooter onClose={onClose} onZonk={handleZonk} />
      </div>

      {/* Zonk Message Overlay */}
      {showZonkMessage && <ZonkMessageOverlay />}
    </div>
  );
};
