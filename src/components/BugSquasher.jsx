              ...
              <div className="space-y-6">
                <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg p-4">
                  <p className="text-sm text-blue-800 dark:text-blue-200">
                    <strong>💡 Tip:</strong> The more details you provide, the
                    faster I can squash this bug! Technical details will be
                    automatically captured to help diagnose the issue.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    Enter the diagnostic code you were viewing when the bug
                    occurred
                  </p>
                </div>
                ...
                <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 rounded-lg p-4 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 italic">
                      We respect your privacy. Leave blank to stay anonymous.
                      Only fill this in if you'd like me to email you when the
                      bug is squashed.
                    </p>
                  </div>
                </div>
                ...
                {submitted ? (
                  <div className="bg-green-50 dark:bg-green-900/30 border-2 border-green-300 dark:border-green-600 rounded-lg p-6 text-center">
                    ...
                    <p className="text-green-700 dark:text-green-100 mb-4">
                      ...
                      <strong>saved to My Tickets</strong> and the report is
                    ...
                    <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm font-medium text-green-800 dark:text-green-200">
                          Bug report generated! Review it below and click
                          "Submit Report" to send it directly.
                        </span>
                      </div>
                    </div>
