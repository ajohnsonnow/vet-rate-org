...
import { X, ClipboardList, BookOpen, AlertCircle, ChevronRight, ChevronLeft, ChevronDown, HelpCircle, Search } from 'lucide-react';
          ...
          <div className="p-8 space-y-6 overflow-y-auto flex-1">
            ...
            <div className="flex gap-4 justify-center pt-4">
              <button
                ...
                className="px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition shadow-md flex items-center gap-2"
              >
              ...
              <button
                ...
                className="px-8 py-3 bg-purple-600 text-white font-semibold rounded-lg hover:bg-purple-700 transition shadow-md flex items-center gap-2"
              >
