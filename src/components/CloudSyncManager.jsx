            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300 text-sm">
                <li className="flex items-start gap-2">
                  ...
                  <span>
                    Backups are encrypted and saved to <strong>YOUR</strong>{" "}
                    Google Drive
                  </span>
                </li>
                <li className="flex items-start gap-2">
        ...
        {!isInitialized && (
          <div className="bg-red-500/10 border border-red-400/30 rounded-lg p-6 mb-6">
            ...
            <p className="text-gray-400 text-xs mt-3">
              If this persists, try refreshing the page or check browser console
              for errors.
            </p>
          </div>
        )}
        ...
        {isSignedIn && (
          <div className="space-y-6">
            ...
            >
              ...
              <span>
                {isLoading ? "Creating Backup..." : "Create New Backup Now"}
              </span>
            </ToolCardButton>
