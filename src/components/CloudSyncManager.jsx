              ...
              <div>
                ...
                <ul className="space-y-2 text-gray-300 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-green-400">✓</span>
                    <span>
                      We never see your data-it goes directly from your browser
                      to your cloud
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
          ...
          {!isInitialized && (
            <div className="bg-red-500/10 border border-red-400/30 rounded-lg p-6 mb-6">
              ...
              <p className="text-gray-400 text-xs mt-3">
                If this persists, try refreshing the page or check browser
                console for errors.
              </p>
            </div>
          )}
          ...
          {isInitialized && !isSignedIn && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-300 mb-6">
                Sign in with Google to start backing up your claim data
                securely.
              </p>
              <button
