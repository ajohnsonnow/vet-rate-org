    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-90 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="bg-red-600 text-white p-6 rounded-t-lg">
          ...
          <p className="text-center text-red-100 mt-2">24/7 confidential support for Veterans in crisis</p>
        </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6">
              Connect with caring, qualified responders who understand veteran experiences.
            </p>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-4 space-y-2">
            <h4 className="font-semibold text-gray-900 dark:text-white">More Resources:</h4>
            <ul className="text-sm text-gray-600 dark:text-gray-300 space-y-1">
              <li>• <strong>Deaf/Hard of Hearing:</strong> TTY 1-800-799-4889</li>
              <li>• <strong>International:</strong> Call +1-800-273-8255</li>
              <li>• <strong>Website:</strong> VeteransCrisisLine.net</li>
            </ul>
          </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
            <p className="text-sm text-blue-900 dark:text-blue-100">
              <strong>You are not alone.</strong> The Veterans Crisis Line is staffed by caring professionals who understand what you're going through. All calls are confidential - crisis or not.
            </p>
          </div>
