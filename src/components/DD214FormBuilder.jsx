...
const DD214_FIELDS = {
  ...
  service: {
    ...
    fields: [
      ...
      },
      {
        ...
        block: "11",
        placeholder: "Infantry, Corpsman, etc.",
      },
      {
        id: "serviceNumber",
  ...
  dates: {
    ...
    fields: [
      ...
      {
        id: "totalActiveDutyDays",
        label: "Total Active Service",
        block: "12d",
        type: "number",
        placeholder: "Days",
      },
    ...
    fields: [
      {
        ...
        type: "textarea",
        placeholder:
          "List all awards, medals, and decorations (one per line or comma-separated)",
        rows: 6,
      },
    ],
  },
    ...
    fields: [
      {
        ...
        type: "textarea",
        placeholder:
          "Additional service details, awards continuation, special qualifications, etc.",
        rows: 4,
      },
    ],
  },
