            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 dark:text-amber-300 mt-1">
                  VA decisions are written in complex legal language. Paste the
                  key paragraphs below and we'll translate what they're{" "}
            ...
            <div className="mb-6">
              <SmartAILoadButton
                ...
                onLoadComplete={(model) =>
                  console.log(
                    "Smart AI loaded for Decision Decoder:",
                    model?.name,
                  )
                }
              />
...
Example: "The evidence does not establish a nexus between your current lumbar spine condition and your service-connected right knee disability. While the medical evidence shows a current diagnosis of lumbar degenerative disc disease, there is no competent medical evidence linking this condition to your service or to your service-connected disabilities."`}
              ...
              {inputMethod === "file" && (
                <div>
                          ...
                          <div className="p-3 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 rounded-lg">
                            <div className="flex items-center gap-2 text-green-700 dark:text-green-300">
                              ...
                              <span className="text-sm font-medium">
                                ...
                                characters from{" "}
                                {
                                  uploadedFiles.filter((f) => f.extractedText)
                                    .length
                                }{" "}
                                file(s)
                              </span>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-3 text-center">
                    🔒 All files processed locally in your browser - nothing is
                    sent to any server.
                  </p>
                </div>
              )}
              ...
              {/* Privacy Note */}
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-3 text-center">
                🔒 Your decision letter is processed securely and never stored
                on our servers.
              </p>
            </div>
            ...
            <div>
              ...
              {results && (
                <div className="space-y-4">
                  ...
                  {results.favorable_findings &&
                    results.favorable_findings.length > 0 && (
                      <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-xl p-4 border border-emerald-200 dark:border-emerald-700">
                        <h4 className="font-semibold text-emerald-800 dark:text-emerald-200 flex items-center gap-2 mb-3">
                          <span>🏆</span> Favorable Findings (Already
                          Established)
                        </h4>
                        <p className="text-xs text-emerald-600 dark:text-emerald-400 mb-2 italic">
                          The VA has already accepted these facts - you do NOT
                          need to prove them again!
                        </p>
                  ...
                  <div className="max-w-sm">
                    ...
                    <div className="mt-4 space-y-2 text-xs text-gray-500 dark:text-gray-500">
                      <p className="flex items-center justify-center gap-2">
                        <span className="animate-pulse">📝</span> Identifying
                        decision type...
                      </p>
                      <p className="flex items-center justify-center gap-2">
                      ...
                      <p className="flex items-center justify-center gap-2">
                        <span className="animate-pulse">📋</span> Building your
                        action plan...
                      </p>
                    </div>
            ...
            {showPhaseExplainer && (
              <div className="mt-4">
                <p className="text-sm text-teal-700 dark:text-teal-300 mb-4">
                  Wondering what your claim status means? Click a phase to learn
                  what the VA is doing and what you should expect.
                </p>
                  ...
                  <div className="flex justify-between relative">
                    {getAllClaimPhases().map((phase, idx) => (
                      <button
                        ...
                        onClick={() =>
                          setSelectedPhase(
                            selectedPhase?.key === phase.key ? null : phase,
                          )
                        }
