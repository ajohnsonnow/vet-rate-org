...
const DEMO_VETERAN_DATA = {
  ...
  claims: [
    // Primary Condition 1: Tinnitus
    {
      ...
      notes:
        "Constant ringing in both ears since deployment. Exposed to IED blasts and weapon fire without adequate hearing protection during patrols.",
      targetRating: 10,
    ...
    // Primary Condition 2: Lumbar Strain
    {
      ...
      status: "Statement Generated",
      notes:
        "Lower back injury from carrying heavy combat loads (80+ lbs) during dismounted patrols. MRI shows L4-L5 disc bulge.",
      targetRating: 20,
    ...
    // Secondary Condition: Migraines (secondary to Tinnitus)
    {
      ...
      status: "Drafting",
      notes:
        "Chronic migraines began 6 months after tinnitus onset. Neurologist confirmed connection between constant tinnitus and migraine triggers.",
      targetRating: 30,
    ...
    // Secondary Condition: Radiculopathy (secondary to Lumbar Strain)
    {
      ...
      status: "Drafting",
      notes:
        "Left leg radiculopathy stemming from L4-L5 disc bulge. Numbness and shooting pain down left leg.",
      targetRating: 20,
      ratingSchedule: "38 CFR § 4.124a",
  ...
  timeline: [
    {
      ...
      description:
        "IED detonation 15m from position during patrol. Immediate tinnitus and temporary hearing loss.",
      location: "Diyala Province, Iraq",
      witnesses: ["SSG Michael Torres", "SPC David Kim"],
      evidence: [
        "Incident Report #2010-DIY-0892",
        "Medical Record Entry 01/16/2010",
      ],
    },
    {
      id: "evt_002",
      ...
      description:
        "Fell into irrigation ditch with full combat load. Acute lower back pain, evacuated to aid station.",
      location: "Logar Province, Afghanistan",
      witnesses: ["SFC James Wilson"],
      evidence: [
        "SF-600 Chronological Record",
        "Limited Duty Profile 08/23/2012",
      ],
    },
    {
      id: "evt_003",
      ...
      description:
        "Bilateral subjective tinnitus diagnosed. Audiologist confirmed service connection.",
  ...
  symptomLog: [
    {
      ...
      severity: 7,
      notes:
        "Ringing very loud today. Had trouble sleeping last night. Used white noise but still took 2 hours to fall asleep.",
    ...
    },
    {
      ...
      severity: 8,
      notes:
        "Major flare-up after helping neighbor move boxes. Had to use heating pad all evening. Took ibuprofen.",
    ...
    },
    {
      ...
      severity: 6,
      notes:
        "Moderate migraine started mid-morning. Tinnitus seems louder than usual. Took Excedrin, resting in dark room.",
...
export const loadDemoData = () => {
  try {
    ...
    const tinnitusClaim = savedClaims.find(
      (c) => c.conditionName === "Tinnitus",
    );
    const lumbarClaim = savedClaims.find(
      (c) => c.conditionName === "Lumbosacral Strain",
    );
          ...
          <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
            <div className="bg-gray-800 border border-yellow-500/50 rounded-lg max-w-md w-full p-6">
              ...
              <p className="text-gray-300 text-center mb-6">
                ...
                <strong className="text-red-400">overwrite</strong> your current
                saved claims and statements. This cannot be undone.
              </p>
        ...
        <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-4">
          <div className="bg-gray-800 border border-yellow-500/50 rounded-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-300 text-center mb-6">
              Loading example data will{" "}
              <strong className="text-red-400">overwrite</strong> your current
              saved claims and statements. This action cannot be undone.
            </p>
