...
const UploadStep = ({
  ...
  <div className="space-y-6">
    <UploadNotices t={t} aiStatus={aiStatus} error={error} />
...
const ProcessingStep = ({ t, progress }) => (
...
const ResultsSummary = ({ t, analysis }) => (
  <>
    {/* Main Analysis */}
    <div
    ...
    >
      ...
      <p className="text-base leading-relaxed">{analysis.whatWasMissing}</p>
    </div>
