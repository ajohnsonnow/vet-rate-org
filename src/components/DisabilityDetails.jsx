...
const VAResources = {
  ...
  essential: [
    ...
    {
      label: "Center for Women Veterans",
      url: "https://www.va.gov/womenvet/",
    },
  ],
};

const DisabilityDetailsTitleBar = ({ result, onClose }) => (
  <div className="flex justify-between items-start gap-4 mb-4">
    <div>
      ...
      <p className="text-blue-100 text-lg">
        Diagnostic Code:{" "}
        <span className="font-bold">{result.diagnosticCode}</span>
      </p>
    </div>
    <button
      onClick={onClose}
...
const DisabilityDetailsActions = ({
  result,
  searchTerm,
  isSaved,
  handleSaveToPacket,
  handleBuildStatement,
}) => (
...
const DisabilityDetailsHeader = ({
  ...
  <div className="bg-gradient-to-r from-va-blue to-green-900 text-white p-8">
    <DisabilityDetailsTitleBar result={result} onClose={onClose} />
    <DisabilityDetailsActions
      result={result}
      searchTerm={searchTerm}
      isSaved={isSaved}
      handleSaveToPacket={handleSaveToPacket}
      handleBuildStatement={handleBuildStatement}
    />
  </div>
);

const RatingScheduleSummary = ({ result }) => (
  <div className="mb-8 p-4 bg-green-50 dark:bg-green-900/30 rounded-lg border border-green-200 dark:border-green-700">
    <p className="text-gray-700 dark:text-gray-300">
      <span className="font-bold text-va-blue dark:text-blue-100">
        📊 Rating Schedule:
      </span>{" "}
...
const RatingCriteriaToggle = ({ expandedSection, setExpandedSection }) => (
  <button
    onClick={() =>
      setExpandedSection(
...
const RatingCriteriaBadges = ({ result }) => (
  <>
    {/* Type Badge */}
    ...
    <div className="mb-8">
      ...
      {expandedSection === "ratingCriteria" && (
        <div className="mt-4 border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden">
          <RatingCriteriaBadges result={result} />
          <RatingCriteriaTable result={result} />
          <RatingCriteriaNotes result={result} />
        </div>
      )}
    </div>
  );
    ...
    {expandedSection === "documentation" && (
      <div className="mt-4 p-4 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
        <p className="text-gray-700 dark:text-gray-300 mb-4">
          Please ensure your medical documentation includes the following
          information to support disability rating decisions:
        </p>
...
const RelatedSecondaryConditions = ({ result, onSecondaryConditionClick }) =>
...
const VeteranResourcesSection = () => (
  <div className="mb-8">
    ...
    <div className="mb-8 p-4 bg-red-50 dark:bg-red-900/30 border-l-4 border-red-500 rounded">
      <h4 className="font-bold text-red-800 dark:text-red-100 mb-3">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div>
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          A 4-digit number used by the VA to classify and rate specific
          disabilities
        </p>
      </div>
      <div>
...
const DisabilityDetailsContent = ({
  result,
  expandedSection,
  setExpandedSection,
  onSecondaryConditionClick,
  ...
  <div id="diagnostic-content" className="p-8">
    ...
    {/* Rating Schedule */}
    <RatingScheduleSummary result={result} />
    ...
    <RelatedSecondaryConditions
      result={result}
      onSecondaryConditionClick={onSecondaryConditionClick}
    />

    {/* Veteran Support & Resources */}
    <VeteranResourcesSection />
...
function DisabilityDetails({
  ...
  return (
    <div
      ...
      className="mt-12 bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700"
    >
      {/* Header */}
      <DisabilityDetailsHeader
        result={result}
        searchTerm={searchTerm}
        onClose={onClose}
        isSaved={isSaved}
