...
function DisclaimerSplash({ onAcknowledge }) {
  ...
  return (
    ...
    >
      <div
        className={`${modalClasses.content} max-w-2xl rounded-2xl max-h-[90vh]`}
      >
        {/* Header - Warm Welcome */}
              ...
              <div className="flex-1">
                ...
                <div className="space-y-2 text-sm text-amber-900 dark:text-amber-100">
                  ...
                  <p className="text-xs text-amber-800 dark:text-amber-300 mt-3">
                    🏗️ Every tool is marked BETA. Expect improvements, updates,
                    and occasional rough edges as I build this for us. Your
                    feedback helps make it better for everyone.
                  </p>
                  <p className="text-xs text-amber-700 dark:text-amber-400 mt-3 italic">
                    💻 Thanks to Uncle Norb for sending me a 286 desktop
                    computer when I was 12 years old.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4 mb-6">
            <p className="text-blue-800 dark:text-blue-200 text-sm leading-relaxed">
              <span className="font-semibold">
                {t("splash", "fromOneVeteran")}
              </span>{" "}
              {t("splash", "personalMessage")}{" "}
              {t("splash", "coveringEverything")} -{" "}
              <strong>
