...
// Generate the packet
async function generatePacket(ctx) {
  const {
    primaryCondition,
    secondaryCondition,
    apiKey,
...
// Download as TXT
function downloadPacketTxt(packetData, primaryCondition, secondaryCondition) {
...
const ConsentPrivacyToggle = ({ showPrivacy, setShowPrivacy }) => (
  <>
    <button
...
const ConsentActions = ({ onClose, handleConsent }) => (
...
const InputStep = ({
  ...
  <div className="space-y-6">
    {/* AI Setup Message */}
    {!isAnyAIAvailable() && <InputAINotice />}

    {/* Conditions */}
    <InputConditionFields
...
const LoadingStep = ({ primaryCondition, secondaryCondition }) => (
...
const ErrorStep = ({ error, onClose, setError, setStep }) => (
  <div className="space-y-6">
...
const ResultHeader = ({ packetData, handlePrint, handleDownloadTxt }) => (
...
const ResultConditionsSummary = ({ primaryCondition, secondaryCondition }) => (
...
const ResultMechanism = ({ packetData }) => (
...
const ResultPathwaysAndLiterature = ({ packetData }) => (
  <>
...
const ResultRiskFactors = ({ packetData }) =>
...
const ResultNotesAndDisclaimer = ({ packetData }) => (
  <>
    {/* Notes */}
...
const ResultActions = ({ onClose, setPacketData, setStep }) => (
...
const ResultStep = ({
  ...
  <div className="space-y-6 print:bg-white print:text-black">
    ...
    {/* Conditions Summary */}
    <ResultConditionsSummary
      primaryCondition={primaryCondition}
      secondaryCondition={secondaryCondition}
    />

    {/* Mechanism Summary */}
    <ResultMechanism packetData={packetData} />

    {/* Key Pathways / Literature Topics */}
    <ResultPathwaysAndLiterature packetData={packetData} />

    {/* Risk Factors */}
    <ResultRiskFactors packetData={packetData} />

    {/* Doctor's Template */}
    <ResultTemplateLetter
      packetData={packetData}
      primaryCondition={primaryCondition}
      secondaryCondition={secondaryCondition}
    />

    <ResultNotesAndDisclaimer packetData={packetData} />
