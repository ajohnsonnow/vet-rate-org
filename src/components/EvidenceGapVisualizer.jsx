...
const EvidenceGapVisualizer = ({
  ...
  const selectedConditionData = selectedCondition
    ? EVIDENCE_REQUIREMENTS[selectedCondition]
    : null;
  const availableRatings = selectedConditionData
    ? Object.keys(selectedConditionData.ratings)
        .map((r) => parseInt(r))
        .sort((a, b) => a - b)
    : [];
  ...
  const handleConditionChange = (conditionId) => {
    ...
    if (condition) {
      const ratings = Object.keys(condition.ratings)
        ...
        .sort((a, b) => b - a);
      const defaultRating =
        ratings.find((r) => r < 100 && r >= 30) || ratings[0];
          ...
          {analysis ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-500 max-w-md mx-auto">
                Choose a condition and target rating above to see exactly what
