        ...
        <div className="bg-gray-900 border border-blue-500/30 rounded-lg p-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-300 text-sm">
              Visualize your nexus. Spot evidence gaps that could sink your
              claim.
            </p>
          </div>
          ...
          <div className="mt-6 bg-green-900/20 border border-green-500/30 rounded p-4">
            ...
            <ul className="text-gray-300 text-sm space-y-1">
              ...
              <li>
                • The timeline will automatically detect gaps longer than 5
                years
              </li>
              <li>
                •{" "}
              ...
              <li>
                • Fill gaps with buddy statements, medical visits, or lay
                evidence
              </li>
            </ul>
          </div>
