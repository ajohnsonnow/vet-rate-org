...
const CURATED_UPDATES = [
  {
    ...
    summary:
      "The PACT Act continues to expand presumptive conditions for toxic exposure. Veterans exposed to burn pits, Agent Orange, and other toxic substances may now file for conditions previously denied.",
    affectedConditions: [
    ...
    action:
      "FILE NOW - If you have these conditions and were exposed, file immediately.",
  ...
  },
  {
    ...
    summary:
      "VA is reviewing mental health rating criteria, potentially updating how PTSD, anxiety, and depression are evaluated. Changes could affect rating percentages.",
    affectedConditions: ["PTSD", "Anxiety", "Depression", "Bipolar Disorder"],
    action:
      "MONITOR - Current claims not affected, but may want to file before changes.",
  ...
  },
  {
    ...
    status: "monitoring",
    summary:
      "VA continues to evaluate tinnitus rating criteria. The 10% rating has been discussed for potential changes. Veterans with tinnitus should ensure claims are on file.",
    affectedConditions: ["Tinnitus", "Hearing Loss"],
    action:
      "PROTECT YOUR RATING - If you have tinnitus, ensure your claim is filed.",
  ...
  },
  {
    ...
    status: "monitoring",
    summary:
      "Sleep Apnea ratings, particularly the 50% CPAP rating, remain under discussion. No formal proposal yet, but veterans should be aware.",
    affectedConditions: ["Sleep Apnea"],
    action:
      "FILE IF NEEDED - If you have Sleep Apnea and haven't filed, consider doing so.",
    link: "https://www.va.gov/",
    urgency: "medium",
  },
];
...
Be direct, practical, and emphasize urgency when appropriate. Veterans need to know if they should act NOW.`;
  ...
  const filteredUpdates = allUpdates.filter((update) => {
    ...
    if (
      activeFilter === "active" &&
      !["active", "final_rule"].includes(update.type)
    )
      return false;
    ...
    if (searchTerm) {
      const text =
        `${update.title} ${update.summary} ${(update.affectedConditions || []).join(" ")}`.toLowerCase();
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700 dark:text-amber-300 mt-1">
                    When the VA{" "}
                    <strong>proposes changes to rating criteria</strong> (like
