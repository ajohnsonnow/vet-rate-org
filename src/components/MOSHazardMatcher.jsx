    ...
    <div className="fixed inset-0 z-50 overflow-y-auto">
      <div className="min-h-screen">
        ...
        <div className="relative bg-gray-900 min-h-screen">
          {/* Header */}
          <div className="sticky top-0 z-10 bg-gradient-to-r from-slate-700 via-slate-600 to-slate-700 p-4 shadow-lg">
            <div className="max-w-4xl mx-auto flex items-center justify-between">
              <div className="flex items-center gap-3">
                <span className="text-3xl">🎖️</span>
                <div>
                  <h2 className="text-xl font-bold text-white">MOS Hazard Matcher</h2>
                  <p className="text-sm text-slate-300">Your Job → Your Injuries</p>
                </div>
              </div>
              <button
                onClick={onClose}
