          ...
          <div className="p-6 space-y-6 bg-gray-900 overflow-y-auto flex-1 rounded-b-lg">
                ...
                >
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      >
                        {state}:{" "}
                        {STATE_PROPERTY_TAX_EXEMPTIONS[state]?.exemption ||
                          "N/A"}
                      </p>
                    </div>
                  </div>
            ...
            <div className="bg-gray-800/30 rounded-xl p-4 text-center">
              <p className="text-xs text-gray-500">
                ...
                state laws, and other factors. COLA rates vary annually. Consult
                a financial advisor for personal planning. Property tax
                exemptions vary by state and locality.
              </p>
              <p className="text-xs text-gray-500 mt-2">
                <strong>Note:</strong> This calculator shows base VA
                compensation rates. Veterans receiving Special Monthly
                Compensation (SMC) at any level (SMC-K, SMC-L, SMC-S, etc.) will
                have higher lifetime values not reflected here.
              </p>
            </div>
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-emerald-300/70 text-sm">
                    Most vets never see these numbers. This calculator took
                    months to build - property tax data for all 50 states, COLA
