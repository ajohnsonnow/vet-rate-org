        ...
        <div className="px-8 py-8">
          ...
          <div className="mb-8">
            ...
            >
              ...
              <p className="text-va-gold font-bold">
                That ends here.
              </p>
            </div>
          </div>
            ...
            <div className="grid gap-4">
              <div className="flex items-start gap-4 bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm" style={{ fontFamily: 'Courier New, monospace' }}>
                    This tool is free. No hidden fees. No premium tiers. 
                    No "pay to unlock" features. Everything is available to everyone.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm" style={{ fontFamily: 'Courier New, monospace' }}>
                    ...
                    No analytics tracking your medical information. Your claim is YOUR business.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 bg-gray-800/50 border border-gray-700 rounded-lg p-4">
                ...
                <div>
                  ...
                  <p className="text-gray-300 text-sm" style={{ fontFamily: 'Courier New, monospace' }}>
                    All AI processing happens locally on your device. Your medical records, 
                    your statements, your service history-none of it ever touches our servers.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gray-800 border-l-4 border-va-gold rounded-r-lg p-6 mb-8">
            ...
            >
              ...
              companies. Some got denied for claims that should have been approved.
              <br /><br />
            ...
            <div className="flex items-center justify-between">
              <div>
                <p 
                  ...
                  style={{ fontFamily: 'Brush Script MT, cursive', fontSize: '1.75rem' }}
                >
                  Anthony Johnson
                </p>
                <p className="text-gray-400 text-sm mt-1" style={{ fontFamily: 'Courier New, monospace' }}>
