...
/**
 * Modal header: title bar with the Vet-Rate wordmark
 */
const MissionProtocolHeader = () => (
...
/**
 * Mission statement intro paragraphs
 */
...
/**
 * The three standing-order promise cards (cost, tracking, privacy)
 */
...
/**
 * Personal statement blockquote from the developer
 */
const MissionPersonalStatement = () => (
...
/**
 * Signature block: name, title, and "built by a veteran" badge
 */
const MissionSignatureBlock = () => (
...
/**
 * Closing "share this" support note
 */
const MissionSupportNote = () => (
  ...
  return (
    ...
    >
      ...
      <div className="py-2">
        ...
        {/* Personal Statement */}
        <MissionPersonalStatement />

        {/* Signature Block - Military Style */}
        <MissionSignatureBlock />
