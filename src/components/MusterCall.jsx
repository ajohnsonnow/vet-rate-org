              ...
              <div className="flex items-center">
                ...
                <div>
                  <span className="text-sm font-medium text-green-800 dark:text-green-200">
                    CW5 Auditor ready - Your claim accuracy Chief Warrant Officer is standing by
                  </span>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-xs text-yellow-700 dark:text-yellow-300 mt-1">
                  Large files (like 320MB+ C-files) and poor-quality scanned images may take several minutes to process. 
                  Please be patient while we extract and analyze your documents with maximum accuracy.
                </p>
              </div>
            </div>
          </div>
            ...
            <>
              ...
              >
                ...
                <div className="mt-4 flex flex-wrap justify-center gap-2">
                  <span className="px-2 py-1 bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 text-xs rounded-full">C-Files (320MB+)</span>
                  <span className="px-2 py-1 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-full">Decision Letters</span>
                  <span className="px-2 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 text-xs rounded-full">DD214s</span>
                  <span className="px-2 py-1 bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 text-xs rounded-full">Medical Records</span>
                </div>
                ...
                <div className="mt-5 pt-4 border-t border-gray-200 dark:border-gray-700">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 max-w-md mx-auto">
                    Your documents are <strong>never uploaded</strong> anywhere. All processing happens 
                    right here in your browser. Your records stay on YOUR device - we never see them.
                  </p>
                </div>
              </div>
