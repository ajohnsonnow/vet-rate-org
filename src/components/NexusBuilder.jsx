            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
              <div className="flex-1 min-w-0 pr-10 sm:pr-0">
                ...
                <p className="text-violet-100 text-sm sm:text-base">
                  ...
                  <strong className="block sm:inline truncate">
                    {condition}
                  </strong>
                  {isSecondary && (
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      updateAnswer("symptomOnsetDate", e.target.value)
                    }
                  />
                    ...
                    {[
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            updateAnswer("hasTreatment", e.target.value)
                          }
                    ...
                    {aggravationOptions.map((option) => (
                      ...
                      >
                        <input
                          ...
                          value={option.value}
                          checked={
                            answers.aggravationMechanism === option.value
                          }
                          onChange={(e) =>
                ...
                <div>
                  <div className="flex items-center justify-between mb-2">
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                      {t("nexusBuilder.explainInOwnWords", {
                        primary: primaryCondition,
                        condition,
                      })}
                    </label>
                    {isAIAvailable() && (
                      <button
                        type="button"
                        onClick={() =>
                          handleFieldHelp("aggravationExplanation")
                        }
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      onChange={(e) =>
                        updateAnswer("aggravationExplanation", e.target.value)
                      }
                      onKeyDown={(e) => {
                          ...
                          onTranscript={(text) =>
                            updateAnswer(
                              ...
                              answers.aggravationExplanation
                                ? `${answers.aggravationExplanation} ${text}`
                                : text,
                            )
                          }
                          size="sm"
                    ...
                    <div className="mt-3">
                      <StatementAnalyzer
                        ...
                        onApplySuggestion={(original, rewrite) => {
                          updateAnswer(
                            "aggravationExplanation",
                            answers.aggravationExplanation.replace(
                              original,
                              rewrite,
                            ),
                          );
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      onChange={(e) =>
                        updateAnswer("specificIncident", e.target.value)
                      }
                      onKeyDown={(e) => {
                        if (e.key === "Enter" && e.ctrlKey) {
                          e.preventDefault();
                    ...
                    <div className="mt-3">
                      <StatementAnalyzer
                        ...
                        onApplySuggestion={(original, rewrite) => {
                          updateAnswer(
                            "specificIncident",
                            answers.specificIncident.replace(original, rewrite),
                          );
                        }}
                      />
                    </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      onChange={(e) =>
                        updateAnswer("workImpact", e.target.value)
                      }
                    />
                    {isSpeechRecognitionSupported() && (
                      <div
                    ...
                    <div className="mt-3">
                      <StatementAnalyzer
                        ...
                        onApplySuggestion={(original, rewrite) => {
                          updateAnswer(
                            "workImpact",
                            answers.workImpact.replace(original, rewrite),
                          );
                        }}
                      />
                    </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      onChange={(e) =>
                        updateAnswer("socialImpact", e.target.value)
                      }
                    />
                    {isSpeechRecognitionSupported() && (
                      <div
                    ...
                    <div className="mt-3">
                      <StatementAnalyzer
                        ...
                        onApplySuggestion={(original, rewrite) => {
                          updateAnswer(
                            "socialImpact",
                            answers.socialImpact.replace(original, rewrite),
                          );
                        }}
                      />
                    </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <textarea
                      ...
                      onChange={(e) =>
                        updateAnswer("specificExamples", e.target.value)
                      }
                    />
                    {isSpeechRecognitionSupported() && (
                      <div
                    ...
                    <div className="mt-3">
                      <StatementAnalyzer
                        ...
                        onApplySuggestion={(original, rewrite) => {
                          updateAnswer(
                            "specificExamples",
                            answers.specificExamples.replace(original, rewrite),
                          );
                        }}
                      />
                    </div>
