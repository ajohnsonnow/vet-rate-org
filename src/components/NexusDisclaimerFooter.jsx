      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-orange-800 dark:text-orange-300">
            This document outlines medical logic based on your inputs. <strong>It is NOT a medical diagnosis.</strong> 
            It must be reviewed, modified as appropriate, and signed by a qualified medical professional 
            before it can be submitted to the VA.
          </p>
        </div>
      </div>
    </div>
