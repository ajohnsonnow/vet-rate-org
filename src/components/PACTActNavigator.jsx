/**
 * Vet-Rate.org - PACT Act Navigator
...
const PACT_ACT_DATA = {
  ...
  agentOrange: {
    ...
    icon: "🌿",
    description:
      "Veterans exposed to Agent Orange or other tactical herbicides during military service",
    locations: [
      {
        name: "Vietnam",
        dates: "1962-1975",
        description:
          "Republic of Vietnam, including waters offshore and airspace",
      },
      {
        name: "Korean DMZ",
        dates: "1968-1971",
        description: "Demilitarized Zone in Korea",
      },
      {
        name: "Thailand (U.S. Military Bases)",
        dates: "1962-1975",
        description:
          "Royal Thai Air Force Bases: U-Tapao, Korat, Nakhon Phanom, Udorn, Takhli, Don Muang",
      },
      {
        name: "Laos",
        dates: "1965-1975",
        description: "Secret War operations",
      },
      {
        name: "Cambodia",
        dates: "1969-1975",
        description: "Border operations and incursions",
      },
      {
        name: "Guam",
        dates: "1962-1975",
        description: "Andersen Air Force Base (storing/testing)",
      },
      {
        name: "American Samoa",
        dates: "1962-1975",
        description: "Testing and storage areas",
      },
      {
        name: "Johnston Atoll",
        dates: "1972-1977",
        description: "Herbicide destruction operations",
      },
    ],
    conditions: [
      ...
      { name: "Chronic B-cell Leukemias", presumptive: true },
      {
        name: "Chloracne",
        presumptive: true,
        notes: "Must manifest within 1 year of exposure",
      },
      ...
      { name: "Prostate Cancer", presumptive: true },
      {
        ...
        presumptive: true,
        notes: "Lung, bronchus, larynx, trachea",
      },
  ...
  gulfWar: {
    ...
    icon: "🏜️",
    description:
      "Veterans who served in Southwest Asia during the Gulf War era",
    locations: [
      {
        name: "Iraq",
        dates: "1990-present",
        description: "All areas including airspace",
      },
      {
        name: "Kuwait",
        dates: "1990-present",
        description: "Including airspace",
      },
      {
        name: "Saudi Arabia",
        dates: "1990-present",
      ...
      },
      {
        name: "Bahrain",
        dates: "1990-present",
        description: "Including waters and airspace",
      },
      {
        name: "Qatar",
        dates: "1990-present",
      ...
      },
      {
        name: "Persian Gulf",
        dates: "1990-present",
        description: "Waters of the Persian Gulf",
      },
      {
        name: "Gulf of Aden",
        dates: "1990-present",
        description: "Waters of the Gulf of Aden",
      },
      {
        name: "Gulf of Oman",
        dates: "1990-present",
        description: "Waters of the Gulf of Oman",
      },
      {
        name: "Red Sea",
        dates: "1990-present",
        description: "Waters of the Red Sea",
      },
      {
        name: "Arabian Sea",
        dates: "1990-present",
        description: "Waters of the Arabian Sea",
      },
    ],
    conditions: [
      ...
      { name: "Fibromyalgia", presumptive: true },
      {
        ...
        presumptive: true,
        notes: "IBS, functional dyspepsia, etc.",
      },
      {
        name: "Undiagnosed Illnesses",
        presumptive: true,
        notes: "Medically unexplained chronic multi-symptom illness",
      },
      {
        name: "Infectious Diseases",
        presumptive: true,
        notes:
          "Including brucellosis, malaria, leishmaniasis, tuberculosis, West Nile virus, and others acquired in Southwest Asia",
      },
    ],
  },
  ...
  burnPit: {
    ...
    icon: "🔥",
    description:
      "Veterans exposed to burn pits or other toxic exposures post-9/11",
    locations: [
      {
        name: "Afghanistan",
        dates: "2001-present",
      ...
      },
      {
        name: "Djibouti",
        dates: "2001-present",
        description: "Including Camp Lemonnier",
      },
      {
        name: "Uzbekistan",
        dates: "2001-2005",
        description: "Karshi-Khanabad (K2) Air Base",
      },
      {
        name: "Somalia",
        dates: "2001-present",
    ...
    conditions: [
      ...
      {
        name: "Asthma (diagnosed during or after service)",
        presumptive: true,
        pactAdded: true,
      },
      ...
      {
        name: "Gastrointestinal Cancer (of any type)",
        presumptive: true,
        pactAdded: true,
      },
      {
        name: "Reproductive Cancer (of any type)",
        presumptive: true,
        pactAdded: true,
      },
      { name: "Lymphoma (of any type)", presumptive: true, pactAdded: true },
      {
        name: "Lymphomatic Cancer (of any type)",
        presumptive: true,
        pactAdded: true,
      },
    ...
    locations: [
      {
        ...
        dates: "1945-1946",
        description: "Occupation of Japan after WWII",
      },
      {
        name: "Nevada Test Site",
        dates: "1945-1962",
        description: "Atmospheric nuclear testing",
      },
      {
        name: "Pacific Proving Grounds",
        dates: "1946-1958",
        description: "Marshall Islands testing",
      },
      {
        name: "Enewetak Atoll",
        dates: "1977-1980",
      ...
      {
        name: "Various Nuclear Facilities",
        dates: "1942-present",
        description:
          "Certain DOE facilities, longshore workers loading nuclear materials",
      },
    ],
    conditions: [
      {
        name: "All Cancers",
        presumptive: true,
        notes: "All forms of cancer for radiation-exposed veterans",
      },
  ...
  campLejeune: {
    ...
    icon: "💧",
    description:
      "Veterans and family members exposed to contaminated water at Camp Lejeune",
    locations: [
      {
        name: "Camp Lejeune, NC",
        dates: "1953-1987",
        description:
          "Must have resided or worked at Camp Lejeune for at least 30 cumulative days",
      },
      {
        name: "MCAS New River, NC",
        dates: "1953-1987",
        description: "Adjacent Marine Corps Air Station",
      },
    ],
    conditions: [
      { name: "Adult Leukemia", presumptive: true },
      {
        name: "Aplastic Anemia and Other Myelodysplastic Syndromes",
        presumptive: true,
      },
