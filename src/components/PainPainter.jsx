...
const DIAGNOSTIC_CODES = {
  head: [
    { code: '8100', name: 'Migraine Headaches', maxRating: 50, description: 'Characteristic prostrating attacks' },
    { code: '8045', name: 'TBI Residuals', maxRating: 100, description: 'Traumatic brain injury residuals' },
    { code: '6260', name: 'Tinnitus', maxRating: 10, description: 'Ringing in the ears' },
    { code: '9304', name: 'Dementia (TBI)', maxRating: 100, description: 'Dementia due to brain trauma' },
  ],
  neck: [
    { code: '5237', name: 'Cervical Strain', maxRating: 100, description: 'Neck strain/sprain' },
    { code: '5242', name: 'Cervical DDD', maxRating: 100, description: 'Degenerative disc disease' },
    { code: '8510', name: 'Cervical Radiculopathy', maxRating: 70, description: 'Nerve root compression' },
  ],
  shoulder_left: [
    { code: '5201', name: 'Shoulder Limitation of Motion (Minor)', maxRating: 30, description: 'Limited arm movement' },
    { code: '5200', name: 'Shoulder Ankylosis (Minor)', maxRating: 40, description: 'Frozen shoulder' },
    { code: '5203', name: 'Clavicle/Scapula Impairment (Minor)', maxRating: 20, description: 'Collarbone issues' },
  ],
  shoulder_right: [
    { code: '5201', name: 'Shoulder Limitation of Motion (Major)', maxRating: 40, description: 'Limited arm movement' },
    { code: '5200', name: 'Shoulder Ankylosis (Major)', maxRating: 50, description: 'Frozen shoulder' },
    { code: '5203', name: 'Clavicle/Scapula Impairment (Major)', maxRating: 20, description: 'Collarbone issues' },
  ],
  upper_back: [
    { code: '5237', name: 'Thoracic Strain', maxRating: 100, description: 'Upper back strain' },
    { code: '5242', name: 'Thoracic DDD', maxRating: 100, description: 'Degenerative disc disease' },
  ],
  lower_back: [
    { code: '5237', name: 'Lumbosacral Strain', maxRating: 100, description: 'Lower back strain' },
    { code: '5243', name: 'IVDS', maxRating: 60, description: 'Intervertebral disc syndrome' },
    { code: '8520', name: 'Sciatic Nerve', maxRating: 80, description: 'Sciatica/nerve damage' },
    { code: '5242', name: 'Lumbar DDD', maxRating: 100, description: 'Degenerative disc disease' },
  ],
  hip_left: [
    { code: '5252', name: 'Hip Limitation of Flexion', maxRating: 40, description: 'Limited hip bending' },
    { code: '5251', name: 'Hip Limitation of Extension', maxRating: 10, description: 'Limited hip extension' },
    { code: '5250', name: 'Hip Ankylosis', maxRating: 90, description: 'Fused hip joint' },
  ],
  hip_right: [
    { code: '5252', name: 'Hip Limitation of Flexion', maxRating: 40, description: 'Limited hip bending' },
    { code: '5251', name: 'Hip Limitation of Extension', maxRating: 10, description: 'Limited hip extension' },
  ...
  knee_left: [
    { code: '5260', name: 'Knee Limitation of Flexion', maxRating: 30, description: 'Limited knee bending' },
    { code: '5261', name: 'Knee Limitation of Extension', maxRating: 50, description: 'Limited knee straightening' },
    { code: '5257', name: 'Knee Instability', maxRating: 30, description: 'Lateral instability' },
    { code: '5258', name: 'Torn Meniscus', maxRating: 20, description: 'Cartilage damage with locking' },
  ],
  knee_right: [
    { code: '5260', name: 'Knee Limitation of Flexion', maxRating: 30, description: 'Limited knee bending' },
    { code: '5261', name: 'Knee Limitation of Extension', maxRating: 50, description: 'Limited knee straightening' },
  ...
  ankle_left: [
    { code: '5271', name: 'Ankle Limitation of Motion', maxRating: 20, description: 'Limited ankle movement' },
    { code: '5270', name: 'Ankle Ankylosis', maxRating: 40, description: 'Fused ankle' },
    { code: '5284', name: 'Foot Injuries', maxRating: 30, description: 'Other foot injuries' },
  ],
  ankle_right: [
    { code: '5271', name: 'Ankle Limitation of Motion', maxRating: 20, description: 'Limited ankle movement' },
    { code: '5270', name: 'Ankle Ankylosis', maxRating: 40, description: 'Fused ankle' },
  ...
  elbow_left: [
    { code: '5206', name: 'Elbow Flexion Limitation (Minor)', maxRating: 40, description: 'Limited elbow bending' },
    { code: '5207', name: 'Elbow Extension Limitation (Minor)', maxRating: 40, description: 'Limited elbow straightening' },
  ],
  elbow_right: [
    { code: '5206', name: 'Elbow Flexion Limitation (Major)', maxRating: 50, description: 'Limited elbow bending' },
    { code: '5207', name: 'Elbow Extension Limitation (Major)', maxRating: 50, description: 'Limited elbow straightening' },
  ],
  wrist_left: [
    { code: '5215', name: 'Wrist Limitation of Motion (Minor)', maxRating: 10, description: 'Limited wrist movement' },
    { code: '8515', name: 'Carpal Tunnel (Minor)', maxRating: 40, description: 'Median nerve compression' },
  ],
  wrist_right: [
    { code: '5215', name: 'Wrist Limitation of Motion (Major)', maxRating: 10, description: 'Limited wrist movement' },
    { code: '8515', name: 'Carpal Tunnel (Major)', maxRating: 50, description: 'Median nerve compression' },
  ],
  chest: [
    { code: '6604', name: 'COPD/Asthma', maxRating: 100, description: 'Chronic obstructive pulmonary disease' },
    { code: '7005', name: 'Heart Disease', maxRating: 100, description: 'Arteriosclerotic heart disease' },
    { code: '5297', name: 'Rib Removal', maxRating: 40, description: 'Removal of ribs' },
  ],
  abdomen: [
    { code: '7346', name: 'GERD/Hiatal Hernia', maxRating: 60, description: 'Acid reflux disease' },
    { code: '7319', name: 'IBS', maxRating: 30, description: 'Irritable bowel syndrome' },
    { code: '7301', name: 'Peritoneal Adhesions', maxRating: 50, description: 'Scar tissue in abdomen' },
  ],
};
...
const NEXUS_PATTERNS = [
  {
    ...
    description: 'Lower back conditions often cause radiating pain down the legs. This is commonly rated as sciatica (DC 8520) secondary to lumbar strain.',
    suggestedCodes: ['8520', '5237'],
  },
  {
    regions: ['neck', 'shoulder_left', 'shoulder_right', 'elbow_left', 'elbow_right', 'wrist_left', 'wrist_right'],
    name: 'Cervical Radiculopathy Pattern',
    description: 'Neck conditions can cause pain, numbness, and weakness radiating down the arms. Consider cervical radiculopathy (DC 8510).',
    suggestedCodes: ['8510', '5237'],
  },
  {
    regions: ['knee_left', 'knee_right', 'ankle_left', 'ankle_right', 'lower_back'],
    name: 'Gait Compensation Pattern',
    description: 'Pain in lower extremities often leads to abnormal gait, which can cause or aggravate back conditions. Consider secondary service connection.',
    suggestedCodes: ['5237', '5260', '5271'],
  },
  {
    regions: ['head', 'neck'],
    name: 'Post-Concussive Pattern',
    description: 'Headaches combined with neck pain often indicate TBI residuals or cervicogenic headaches. Consider both DC 8045 (TBI) and DC 8100 (Migraines).',
...
const PainPainter = ({ onClose, onExport, onReportBug }) => {
  ...
  const STANDARD_VIEWS = {
    front: { id: 'front', name: 'Front View', icon: '👤', shortcut: 'F', description: 'Anterior view showing front of body' },
    back: { id: 'back', name: 'Back View', icon: '🔙', shortcut: 'B', description: 'Posterior view showing back of body' },
    left: { id: 'left', name: 'Left Side', icon: '⬅️', shortcut: 'L', description: 'Left lateral view showing side profile' },
    right: { id: 'right', name: 'Right Side', icon: '➡️', shortcut: 'R', description: 'Right lateral view showing side profile' }
  };
  ...
  const [showPhantomLimbs, setShowPhantomLimbs] = useState({ leftArm: true, rightArm: true, leftLeg: true, rightLeg: true });
  ...
  // Body type presets
  const BODY_PRESETS = {
    masculine: { name: 'Masculine', shoulders: 1.15, hips: 0.9, torso: 1.05, arms: 1.05, legs: 1, head: 1, icon: '👨' },
    feminine: { name: 'Feminine', shoulders: 0.9, hips: 1.1, torso: 0.95, arms: 0.95, legs: 1, head: 0.95, icon: '👩' },
    average: { name: 'Average', shoulders: 1, hips: 1, torso: 1, arms: 1, legs: 1, head: 1, icon: '🧑' },
    'trans-ftm': { name: 'Trans (FtM)', shoulders: 1.05, hips: 1, torso: 1, arms: 1, legs: 1, head: 1, icon: '⚧️' },
    'trans-mtf': { name: 'Trans (MtF)', shoulders: 0.95, hips: 1.05, torso: 0.98, arms: 0.98, legs: 1, head: 0.97, icon: '⚧️' },
    nonbinary: { name: 'Non-Binary', shoulders: 1, hips: 1, torso: 1, arms: 1, legs: 1, head: 1, icon: '🏳️‍🌈' }
  };
  ...
  useEffect(() => {
    ...
    const detected = NEXUS_PATTERNS.filter(pattern => {
      const matchingRegions = pattern.regions.filter(r => paintedRegions.includes(r));
  ...
  // Get region style
  const getRegionStyle = useCallback((regionId) => {
  ...
  const renderBodySVG = () => {
        ...
        return {
          ...
          shoulder_left: showPhantomLimbs.leftArm ? 
            `M ${centerX - shoulderWidth},100 Q ${centerX - shoulderWidth - 20},100 ${centerX - shoulderWidth - 20},120 
             L ${centerX - shoulderWidth},130 L ${centerX - 30},110 Z` : null,
          ...
          elbow_left: showPhantomLimbs.leftArm ? 
            `M ${centerX - 80 * s.arms},150 Q ${centerX - 90 * s.arms},160 ${centerX - 80 * s.arms},180 
             L ${centerX - 65 * s.arms},175 L ${centerX - 65 * s.arms},155 Z` : null,
          ...
          wrist_left: showPhantomLimbs.leftArm ?
            `M ${centerX - 95 * s.arms},200 Q ${centerX - 105 * s.arms},210 ${centerX - 95 * s.arms},230 
             L ${centerX - 80 * s.arms},225 L ${centerX - 80 * s.arms},205 Z` : null,
          wrist_right: showPhantomLimbs.rightArm ?
            `M ${centerX + 95 * s.arms},200 Q ${centerX + 105 * s.arms},210 ${centerX + 95 * s.arms},230 
             L ${centerX + 80 * s.arms},225 L ${centerX + 80 * s.arms},205 Z` : null,
          hip_left: showPhantomLimbs.leftLeg ?
            `M ${centerX - 35 * s.hips},220 L ${centerX - 10},220 L ${centerX - 20 * s.legs},260 L ${centerX - 40 * s.hips},260 Z` : null,
          ...
          knee_left: showPhantomLimbs.leftLeg ?
            `M ${centerX - 40 * s.legs},300 Q ${centerX - 50 * s.legs},320 ${centerX - 40 * s.legs},340 
             L ${centerX - 20 * s.legs},340 L ${centerX - 20 * s.legs},300 Z` : null,
          ...
          ankle_left: showPhantomLimbs.leftLeg ?
            `M ${centerX - 40 * s.legs},380 Q ${centerX - 50 * s.legs},395 ${centerX - 40 * s.legs},410 
             L ${centerX - 20 * s.legs},410 L ${centerX - 20 * s.legs},380 Z` : null,
        ...
        return {
          ...
          wrist_right: showPhantomLimbs.rightArm ?
            `M ${centerX + 95 * s.arms},200 Q ${centerX + 105 * s.arms},210 ${centerX + 95 * s.arms},230 
             L ${centerX + 80 * s.arms},225 L ${centerX + 80 * s.arms},205 Z` : null,
          hip_left: showPhantomLimbs.leftLeg ?
            `M ${centerX - 30 * s.hips},220 L ${centerX - 10},220 L ${centerX - 20},260 L ${centerX - 35 * s.hips},260 Z` : null,
          hip_right: showPhantomLimbs.rightLeg ?
            `M ${centerX + 30 * s.hips},220 L ${centerX + 10},220 L ${centerX + 20},260 L ${centerX + 35 * s.hips},260 Z` : null,
          knee_left: showPhantomLimbs.leftLeg ?
            `M ${centerX - 40 * s.legs},300 Q ${centerX - 50 * s.legs},320 ${centerX - 40 * s.legs},340 
    ...
    return (
      ...
      >
        ...
        <ellipse cx={centerX} cy="220" rx={view === 'left' || view === 'right' ? 60 : 100 * Math.max(s.shoulders, s.hips)} ry={200 * s.torso} fill="url(#bodyGlow)" />
        
        {/* Phantom limb indicators - only for front/back views */}
        {(view === 'front' || view === 'back') && !showPhantomLimbs.leftArm && (
          <text x="70" y="150" fill="rgba(255,100,100,0.5)" fontSize="10" textAnchor="middle">❌ Removed</text>
        )}
        {(view === 'front' || view === 'back') && !showPhantomLimbs.rightArm && (
          <text x="230" y="150" fill="rgba(255,100,100,0.5)" fontSize="10" textAnchor="middle">❌ Removed</text>
        )}
        {(view === 'front' || view === 'back') && !showPhantomLimbs.leftLeg && (
          <text x="120" y="350" fill="rgba(255,100,100,0.5)" fontSize="10" textAnchor="middle">❌</text>
        )}
        {(view === 'front' || view === 'back') && !showPhantomLimbs.rightLeg && (
          <text x="180" y="350" fill="rgba(255,100,100,0.5)" fontSize="10" textAnchor="middle">❌</text>
        )}
        ...
        {(hoveredRegion || selectedRegion) && (
          <text
            ...
            fontWeight="bold"
          >
            {(hoveredRegion || selectedRegion).replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase())}
          </text>
        )}
      </svg>
    );
    ...
    if (!selectedRegion) {
      return (
        <div className="text-center py-8 text-gray-500">
          ...
          <p className="mt-2">Click a body region to see related diagnostic codes</p>
        </div>
      );
    }

    const codes = DIAGNOSTIC_CODES[selectedRegion] || [];
    const regionName = selectedRegion.replace(/_/g, ' ').replace(/\b\w/g, l => l.toUpperCase());
            ...
            {codes.map(code => (
              ...
              >
                <div className="flex items-center justify-between mb-1">
                  <span className="font-mono text-blue-400 font-bold">DC {code.code}</span>
          ...
          <div key={index} className="p-3 bg-gray-800/50 rounded-lg mb-2">
            ...
            <div className="flex flex-wrap gap-1 mt-2">
              {nexus.suggestedCodes.map(code => (
                <span key={code} className="text-xs px-2 py-0.5 bg-purple-500/30 text-purple-300 rounded">
                  DC {code}
                </span>
              ))}
            </div>
  ...
  const handleExport = async () => {
    if (bodyMapRef.current) {
      await downloadScreenshot(bodyMapRef, `pain-map-${new Date().toISOString().slice(0, 10)}.png`);
    }
  };
  ...
  const handleSaveToPacket = async () => {
    ...
    const painPointsArray = Object.entries(painPoints).map(([region, data]) => ({
      region: region.replace(/_/g, ' '),
      bodyPart: region,
      type: PAIN_TYPES[data.type]?.name || data.type,
      severity: data.intensity > 0.7 ? 'severe' : data.intensity > 0.4 ? 'moderate' : 'mild',
      notes: ''
    }));
    ...
    if (detectedNexus.length > 0) {
      nexusLanguage = detectedNexus.map(n => `${n.name}: ${n.description}`).join('\n\n');
    }
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
                    ...
                    {Object.entries(bodyScale).map(([part, value]) => (
                      <div key={part} className="space-y-1">
                        ...
                        <input
                          ...
                          step="0.05"
                          value={value}
                          onChange={(e) => setBodyScale(prev => ({ ...prev, [part]: parseFloat(e.target.value) }))}
                ...
                <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700">
                  ...
                  <p className="text-sm text-gray-400 mb-4">
                    Toggle off limbs that have been amputated. You can still document phantom pain sensations in these areas.
                  </p>
                  <div className="grid grid-cols-2 gap-3">
                    {Object.entries(showPhantomLimbs).map(([limb, visible]) => (
                      <label key={limb} className="flex items-center justify-between p-3 bg-gray-900/50 rounded-lg cursor-pointer hover:bg-gray-900/70 transition-colors">
                        <span className="text-gray-300 capitalize">{limb.replace(/([A-Z])/g, ' $1').trim()}</span>
                        <button
                          onClick={() => setShowPhantomLimbs(prev => ({ ...prev, [limb]: !prev[limb] }))}
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-2">
                        ⌨️ Keyboard: <kbd className="px-1 bg-gray-700 rounded">F</kbd>ront, <kbd className="px-1 bg-gray-700 rounded">B</kbd>ack, <kbd className="px-1 bg-gray-700 rounded">L</kbd>eft, <kbd className="px-1 bg-gray-700 rounded">R</kbd>ight
                      </p>
                      <button
                        onClick={() => { setZoom(1); setView('front'); }}
                    ...
                    <>
                      ...
                      <div className="bg-gray-800/50 rounded-lg p-3 mb-4">
                        ...
                        <ul className="text-sm text-gray-300 space-y-1">
                          <li>• {Object.keys(painPoints).length} pain point{Object.keys(painPoints).length !== 1 ? 's' : ''}</li>
                          <li>• View: {view === 'front' ? 'Front' : 'Back'}</li>
                          {detectedNexus.length > 0 && (
                            <li>• {detectedNexus.length} nexus pattern{detectedNexus.length !== 1 ? 's' : ''} detected</li>
                          )}
                        </ul>
                      </div>
