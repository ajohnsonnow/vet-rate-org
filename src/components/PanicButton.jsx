          ...
          <div className="fixed inset-0 bg-white z-[10001] overflow-hidden">
            <div className="flex flex-col items-center justify-center min-h-screen">
              ...
              <div className="mb-8">
                <svg width="272" height="92" viewBox="0 0 272 92" fill="none">
                  <text x="10" y="70" fontFamily="Arial" fontSize="80" fontWeight="bold">
            ...
            {showHint && (
              <div className="fixed bottom-4 right-4 bg-gray-800 text-white text-xs px-3 py-2 rounded shadow-lg animate-fade-in">
                Press <kbd className="px-1 bg-gray-700 rounded">ESC</kbd> x3 to restore
              </div>
            )}
          </div>
        )}
          ...
          <div className="fixed inset-0 bg-white z-[10001] overflow-hidden">
            ...
            <div className="bg-gray-100 border-b border-gray-300 px-4 py-2 text-xs text-gray-600">
              <div className="flex items-center gap-2">
                <button className="px-2 py-1 hover:bg-gray-200 rounded">📄 New</button>
                <button className="px-2 py-1 hover:bg-gray-200 rounded">💾 Save</button>
                <button className="px-2 py-1 hover:bg-gray-200 rounded">↩️ Undo</button>
                <button className="px-2 py-1 hover:bg-gray-200 rounded">↪️ Redo</button>
              </div>
            </div>
            ...
            <div className="overflow-hidden">
              <table className="w-full border-collapse text-xs">
                ...
                <tbody>
                  {[...Array(20)].map((_, i) => (
                    <tr key={i}>
                      <td className="border border-gray-300 bg-gray-200 text-center py-1">{i + 1}</td>
          ...
          <div className="fixed inset-0 bg-white z-[10001] overflow-y-auto">
            ...
            <div className="border-b border-gray-300 px-4 py-3">
              <div className="flex items-center justify-between max-w-6xl mx-auto">
                <div className="text-2xl font-serif font-bold">The Daily News</div>
                <div className="text-sm text-gray-600">Saturday, January 18, 2026</div>
              </div>
            </div>
            ...
            <div className="max-w-6xl mx-auto px-4 py-8">
              <div className="grid grid-cols-3 gap-8">
                <div className="col-span-2">
                  <h1 className="text-4xl font-bold mb-4">Breaking News: Markets React to Latest Reports</h1>
                  ...
                  <div className="space-y-4">
                    {[1, 2, 3, 4, 5].map(i => (
                      <div key={i} className="border-b border-gray-200 pb-4">
                        ...
                        <h4 className="font-semibold text-sm">Article Headline {i}</h4>
