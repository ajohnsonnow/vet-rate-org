...
function AnalyticsDisclosureBox({ t }) {
  return (
...
function PrivacySectionsThreeToSix({ t }) {
  return (
    <>
      <section className="mb-6">
        <h3 className="text-xl font-bold text-gray-800 mb-3">
...
function PrivacyCriticalWarningBox() {
  return (
...
function PrivacyAIProcessingDetails({ t }) {
  return (
...
function PrivacyAIProcessingSection({ t }) {
  return (
    <section className="mb-6 bg-gradient-to-r from-amber-100 to-orange-100 border-4 border-amber-600 rounded-lg p-6 shadow-lg">
      ...
      <PrivacyAIProcessingDetails t={t} />
    </section>
  );
}

function PrivacySectionsEightToEleven({ t }) {
  return (
    <>
      <section className="mb-6">
        <h3 className="text-xl font-bold text-gray-800 mb-3">
  ...
  return (
    ...
    >
      <div>
        ...
        <PrivacySection1 t={t} />
        <PrivacySection2 t={t} />
        <PrivacySectionsThreeToSix t={t} />

        {/* Section 7: AI Processing - WITH PROMINENT WARNING */}
        <PrivacyAIProcessingSection t={t} />

        <PrivacySectionsEightToEleven t={t} />
      </div>
    </ResponsiveModal>
  );
};
