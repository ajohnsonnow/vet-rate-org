...
const PrivacyPolicy = ({ onClose, onReportBug }) => {
  ...
  return (
    ...
    >
      <div
        className={`${modalClasses.content} max-w-4xl my-8 max-h-[90vh] flex flex-col overflow-hidden`}
      >
        <div
          className={`flex-shrink-0 border-b px-6 py-4 flex justify-between items-center rounded-t-lg z-10 ${getColorClass(colors.base.modal)} ${getColorClass(colors.border.default)}`}
        >
          <h2
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6">
          <p className={`text-sm mb-6 ${getColorClass(colors.text.secondary)}`}>
            <strong>{t("privacyPolicy", "lastUpdated")}</strong> January 23,
            2026
          </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    <strong>
                      Using Google Gemini API with your own key (BYOK) sends
                      your data to Google's cloud data centers.
                    </strong>{" "}
