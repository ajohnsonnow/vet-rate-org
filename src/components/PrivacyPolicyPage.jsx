          ...
          <section className="mb-6 bg-gradient-to-r from-amber-100 to-orange-100 border-4 border-amber-600 rounded-lg p-6 shadow-lg">
            ...
            <div className="bg-red-600 text-white p-4 rounded-lg mb-4 border-2 border-red-800 shadow-md">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-bold text-lg mb-2">⚠️ CRITICAL PRIVACY NOTICE - READ CAREFULLY</p>
                  <p className="text-sm leading-relaxed">
                    <strong>Using Google Gemini API with your own key (BYOK) sends your data to Google's cloud data centers.</strong> Your 
                    text, documents, and prompts are transmitted over the internet to Google's servers for processing. While this is a direct 
                    connection between you and Google (Vet-Rate.org does not see your data), your information leaves your device and enters 
                    Google's infrastructure. <strong className="underline">For maximum privacy, use Local AI models that run entirely on your device.</strong>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-amber-50 border-2 border-amber-500 rounded-lg p-5 mb-4 shadow-sm">
              <p className="text-black mb-3 leading-relaxed">
                <strong className="text-lg text-black">{t('privacyPolicy', 'section7OptionalAI')}</strong>
                <br />
                <span className="text-black">{t('privacyPolicy', 'section7OptionalAIText')}</span>
              </p>
              ...
              <div className="bg-amber-100 border-l-4 border-amber-600 p-4 mb-3">
                ...
                <ul className="list-disc list-inside text-black space-y-2 ml-4">
                  <li className="leading-relaxed">{t('privacyPolicy', 'section7AIItem1')}</li>
                  <li className="leading-relaxed"><strong className="text-black">Cloud AI Warning:</strong> {t('privacyPolicy', 'section7AIItem2')}</li>
                  <li className="leading-relaxed">{t('privacyPolicy', 'section7AIItem3')}</li>
                  <li className="leading-relaxed">{t('privacyPolicy', 'section7AIItem4')}</li>
                </ul>
              </div>
              ...
              <div className="bg-blue-100 border-2 border-blue-500 rounded p-4">
                ...
                <div className="mt-3 text-sm">
                  <p className="text-black mb-2"><strong>Cloud AI Provider Links:</strong></p>
                  <ul className="list-disc list-inside text-black ml-4 space-y-1">
                    <li>
                      <a href="https://ai.google.dev/gemini-api/terms" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-medium">
