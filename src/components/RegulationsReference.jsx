...
import { X, ExternalLink, ChevronDown, ChevronUp, BookOpen, Scale, Shield, FileText, Calendar, AlertTriangle, Clock, Lightbulb, Search, Gavel, DollarSign } from 'lucide-react';
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-5xl w-full max-h-[90vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="bg-gradient-to-r from-blue-700 to-blue-800 text-white p-6 relative flex-shrink-0">
          <button
            onClick={onClose}
        ...
        <div className="flex-1 overflow-y-auto p-6">
            ...
            <>
              ...
              <div className="bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-amber-800 dark:text-amber-200">Why This Matters</h3>
                    <p className="text-sm text-amber-700 dark:text-amber-300">
                      38 CFR Part 3 contains the rules VA MUST follow when deciding your claim. Knowing these regulations
                      helps you file stronger claims, catch errors in denials, and effectively appeal unfavorable decisions.
                        ...
                        {category.regulations.map((reg, index) => (
                          ...
                          >
                            ...
                            {reg.keyPoints && reg.keyPoints.length > 0 && (
                              <div className="mb-3">
                                <h5 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1">Key Points:</h5>
                            ...
                            {reg.veteranTip && (
                              <div className="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-700 rounded-lg p-3">
                                <div className="flex items-start gap-2">
                                  ...
                                  <div>
                                    <span className="font-semibold text-green-800 dark:text-green-200 text-sm">Veteran Tip: </span>
                                    <span className="text-sm text-green-700 dark:text-green-300">{reg.veteranTip}</span>
                                  </div>
                                </div>
                              </div>
                            )}
            ...
            <>
              ...
              <div className="bg-purple-50 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-700 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-purple-800 dark:text-purple-200">Board of Veterans' Appeals (BVA)</h3>
                    <p className="text-sm text-purple-700 dark:text-purple-300">
                      {title38Regulations.bvaAppeals?.description || 'The Board reviews appeals from VA decisions.'}
                    </p>
                    <a 
                          ...
                          >
                            ...
                            {reg.docketDetails && (
                              <div className="mb-3 space-y-2">
                                <h5 className="text-sm font-semibold text-gray-700 dark:text-gray-300">Docket Options:</h5>
                ...
                <div className="mt-6">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    {title38Regulations.bvaAppeals.keyForms.map((form, index) => (
                      ...
                      >
                        <h4 className="font-bold text-gray-800 dark:text-gray-100">{form.form}</h4>
                        <p className="text-sm text-gray-700 dark:text-gray-300">{form.name}</p>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{form.use}</p>
                      </a>
                    ))}
                  </div>
                </div>
            ...
            <>
              ...
              <div className="bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-700 rounded-lg p-4 mb-6">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-bold text-amber-800 dark:text-amber-200">VA Pension vs. Disability Compensation</h3>
                    <p className="text-sm text-amber-700 dark:text-amber-300">
                      {title38Regulations.pension?.note || 'Pension is different from disability compensation.'}
                    </p>
                  </div>
                </div>
              </div>
                  ...
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className="bg-gray-100 dark:bg-gray-700">
                        {title38Regulations.pension.comparisonChart.columns.map((col, i) => (
                          <th key={i} className="p-2 text-left border border-gray-300 dark:border-gray-600 font-bold">
                            {col}
                          </th>
                        ))}
                      </tr>
                    ...
                    <tbody>
                      {title38Regulations.pension.comparisonChart.rows.map((row, i) => (
                        <tr key={i} className={i % 2 === 0 ? 'bg-white dark:bg-gray-800' : 'bg-gray-50 dark:bg-gray-750'}>
                          {row.map((cell, j) => (
                            <td key={j} className={`p-2 border border-gray-300 dark:border-gray-600 ${j === 0 ? 'font-semibold' : ''}`}>
                              {cell}
                            </td>
                          ))}
                        </tr>
          ...
          {activeTab === 'forms' && (
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Using the correct forms is critical for proper claim processing. Here are the key forms referenced in 38 CFR Part 3.
              </p>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-700 dark:text-gray-300">{form.name}</p>
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{form.use}</p>
          ...
          {activeTab === 'deadlines' && (
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Missing deadlines can cost you months or years of back-pay. These are the most important timelines in 38 CFR Part 3.
              </p>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 dark:text-gray-300 mt-1">
                          <strong className="text-green-700 dark:text-green-400">Why it matters: </strong>
                          {timeline.importance}
                        </p>
          ...
          {activeTab === 'mistakes' && (
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                These common mistakes cost veterans time, money, and benefits. Learn from others' experiences.
              </p>
        ...
        <div className="p-4 bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 flex-shrink-0">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
            <p className="text-xs text-gray-500 dark:text-gray-400">
              ...
              >
                38 CFR Title 38 - Pensions, Bonuses, and Veterans' Relief (eCFR.gov)
              </a>
            </p>
            <p className="text-xs text-gray-500 dark:text-gray-400">
