        ...
        <div className="flex-1 overflow-y-auto p-6">
            ...
            <>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-700 dark:text-amber-300">
                      38 CFR Part 3 contains the rules VA MUST follow when
                      deciding your claim. Knowing these regulations helps you
                      file stronger claims, catch errors in denials, and
                      effectively appeal unfavorable decisions. These are YOUR
                      rights - use them!
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                {_safeCfr3Categories.map((category) => {
                  if (!category.regulations.some(_regMatchesSearch))
                    return null;
              ...
              {title38Regulations.bvaAppeals?.keyForms && (
                <div className="mt-6">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    {title38Regulations.bvaAppeals.keyForms.map(
                      (form, index) => (
                        <a
                          key={index}
                          href={form.url}
          ...
          {activeTab === "deadlines" && (
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                Missing deadlines can cost you months or years of back-pay.
                These are the most important timelines in 38 CFR Part 3.
              </p>
          ...
          {activeTab === "mistakes" && (
            <div className="space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                These common mistakes cost veterans time, money, and benefits.
