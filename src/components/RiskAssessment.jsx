      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {warnings
          ...
          .map((warning, i) => (
            <div
              key={i}
              className="bg-red-50 dark:bg-red-900/30 border-2 border-red-500 rounded-xl p-6"
            >
              <div className="flex items-start gap-3">
        ...
        {warnings
          ...
          .map((warning, i) => (
            <div
              key={i}
              className="bg-orange-50 dark:bg-orange-900/30 border-2 border-orange-500 rounded-xl p-6"
            >
              <div className="flex items-start gap-3">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 rounded-xl p-6 border border-purple-200 dark:border-purple-800">
          ...
          {aiAnalysis && (
            <div className="space-y-4">
              ...
              {aiAnalysis.strengthenClaim &&
                aiAnalysis.strengthenClaim.length > 0 && (
                  <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
                    <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">
