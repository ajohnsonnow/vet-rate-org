        ...
        <div className="flex items-start justify-between">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-2">
              <span
                className={`px-3 py-1 rounded-full text-xs font-semibold border ${getProbabilityBadgeColor(suggestion.probability)}`}
              >
              ...
              <span
                className={`px-3 py-1 rounded-full text-xs font-semibold border ${getMechanismBadgeColor(suggestion.mechanism)}`}
              >
