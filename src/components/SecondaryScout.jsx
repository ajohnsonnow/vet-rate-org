    ...
    <div className="max-w-7xl mx-auto p-6">
      ...
      {selectedForPacket.size > 0 && (
        <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-40">
          <div className="bg-gradient-to-r from-emerald-700 to-teal-700 text-white px-6 py-4 rounded-xl shadow-2xl flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              {getUnsavedSelectedCount() < selectedForPacket.size && (
                <span className="text-blue-200 text-sm">
                  ({selectedForPacket.size - getUnsavedSelectedCount()} already saved)
                </span>
              )}
            </div>
            <div className="flex items-center gap-2">
              <button
                ...
                className="bg-white text-blue-600 px-4 py-2 rounded-lg font-semibold hover:bg-blue-50 transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
