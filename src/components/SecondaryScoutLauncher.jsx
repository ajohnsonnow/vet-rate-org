  ...
  const exampleProfiles = [
    {
      ...
      description:
        "50% PTSD, 20% spine, 20% left radiculopathy, bilateral hip issues, tinnitus",
      conditions: [
    ...
    },
    {
      ...
      description:
        "Military Sexual Trauma with related mental health and physical conditions",
      conditions: [
        "PTSD (Post-Traumatic Stress Disorder)",
    ...
    },
    {
      name: "LGBTQ+ Veteran",
      description:
        "Common conditions in LGBTQ+ veterans - higher rates due to stigma, stress, and discrimination per VA research",
      conditions: [
        "PTSD (Post-Traumatic Stress Disorder)",
        "Major Depressive Disorder",
        "Generalized Anxiety Disorder",
    ...
    },
    {
      ...
      description:
        "Mental health conditions more prevalent in LGBTQ+ veterans due to minority stress and discrimination",
      conditions: [
        "PTSD (Post-Traumatic Stress Disorder)",
        "Major Depressive Disorder",
        "Generalized Anxiety Disorder",
    ...
    },
    {
      ...
      description:
        "Military Sexual Trauma affects all genders - mental health and physical impacts",
      conditions: [
        "PTSD (Post-Traumatic Stress Disorder)",
        "Major Depressive Disorder",
        "Generalized Anxiety Disorder",
    ...
    },
    {
      ...
      description:
        "Post-9/11 toxic exposure conditions (Iraq, Afghanistan, etc.)",
      conditions: [
        "Asthma",
    ...
    },
    {
      ...
      description:
        "Conditions common in transgender veterans, including gender dysphoria and related health impacts",
      conditions: [
        "PTSD (Post-Traumatic Stress Disorder)",
        "Major Depressive Disorder",
        "Generalized Anxiety Disorder",
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-purple-700 dark:text-purple-300 mt-1">
                        Drop in a PDF of your VA Rating Decision, Decision
                        Letter, or Benefits Summary to automatically extract
                      ...
                      <span className="font-medium text-purple-800 dark:text-purple-200">
                        {pdfOcrProgress.state === OCR_STATES.LOADING
                          ...
                          : pdfOcrProgress.state === OCR_STATES.EXTRACTING
                            ? "Extracting text..."
                            : pdfOcrProgress.state === OCR_STATES.OCR_PROCESSING
            ...
            {inputMethod === "checkbox" && (
              <div>
                <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
                  Select all conditions you currently have service connection
                  for (organized by body system per 38 CFR Part 4, Subpart B):
                </p>
                ...
                <div className="space-y-2 max-h-[280px] overflow-y-auto border border-gray-200 dark:border-gray-700 rounded-lg p-3">
                  {savedRatings.length === 0 ? (
                    <div className="text-center py-8 text-gray-500 dark:text-gray-400">
                      ...
                      <p className="text-sm mt-1">
                        Use the <strong>Tactical Calculator</strong> to save
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700 dark:text-yellow-100">
                    <strong>Important:</strong> This tool is educational and
                    based on 38 CFR § 3.310 (Secondary Service Connection).
                    Suggestions should be reviewed with a VA-accredited
                    representative and require a medical nexus opinion.
                  </p>
                </div>
              </div>
            </div>
