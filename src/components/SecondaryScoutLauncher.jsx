...
function ManualInputPanel({ manualInput, setManualInput, handleManualSubmit }) {
  return (
    <div>
...
function CheckboxSelectionPanel({
  searchFilter,
  setSearchFilter,
  selectedConditions,
  ...
  return (
    <div>
      <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
        Select all conditions you currently have service connection for
...
function ExampleProfilesPanel({ loadExampleProfile }) {
  return (
    <div>
