...
const FAQTab = () => (
  <div className="space-y-6">
    ...
    <FAQItem
      ...
      answer={
        <div className="space-y-2 text-sm">
          <p><strong>Not here.</strong> That business model requires collecting your data to sell or monetize. We can't sell what we don't have.</p>
          ...
          <p className="font-semibold mt-2">The "product" is helping veterans get what they deserve without predatory claim sharks taking 20-30% of your backpay.</p>
        </div>
      }
    />
    ...
    <FAQItem
      ...
      answer={
        <div className="space-y-2 text-sm">
          <p><strong>I don't.</strong> This is a passion project, not a business.</p>
          <p>There's a donation link for those who want to support hosting/development, but it's 100% optional. No features are paywalled. No subscriptions. No upsells.</p>
          <p className="font-semibold">Veterans shouldn't have to pay to understand their benefits. Full stop.</p>
        </div>
      }
    />
    ...
    <FAQItem
      ...
      answer={
        <div className="space-y-2 text-sm">
          <p><strong>We don't train any models.</strong> When you use AI features:</p>
          <ul className="list-disc ml-5 space-y-1">
          ...
          <p className="font-semibold mt-2">Google's privacy policy applies to their API, not ours (because we don't have servers).</p>
        </div>
      }
    />
    ...
    <FAQItem
      ...
      answer={
        <div className="space-y-2 text-sm">
          <p><strong>Good catch!</strong> Yes, disability ratings and regulations change. Here's how we handle it:</p>
          <ul className="list-disc ml-5 space-y-1">
            ...
            <li>You download the updated files when you visit (like any website update)</li>
            <li>No continuous sync required - the data is the site itself</li>
          </ul>
          <p className="font-semibold mt-2">Think of it like downloading a phone app update - new data replaces old, but your personal info stays local.</p>
        </div>
      }
    />
    ...
    <FAQItem
      ...
      answer={
        <div className="space-y-2 text-sm">
          <p><strong>GOOD.</strong> You shouldn't blindly trust anyone. That's why:</p>
          <ul className="list-disc ml-5 space-y-1">
          ...
          <p className="font-semibold mt-2">Don't trust my words - verify with your own eyes. See the "Verify Yourself" tab above.</p>
        </div>
      }
    />
    ...
    <FAQItem
      ...
      answer={
        <div className="space-y-2 text-sm">
          <p><strong>Can't breach what doesn't exist.</strong></p>
          <p>Traditional breaches happen when companies store your data on servers and those servers get hacked. We have:</p>
          <ul className="list-disc ml-5 space-y-1">
          ...
          <p className="font-semibold mt-2">The ONLY way your data could leak is if YOUR device is compromised - which is true for any website you use.</p>
        </div>
      }
    />
    ...
    <FAQItem
      ...
      answer={
        <div className="space-y-2 text-sm">
          ...
          <p className="font-semibold mt-2">But don't take this table as truth - verify each claim yourself.</p>
        </div>
      }
    />
  </div>
