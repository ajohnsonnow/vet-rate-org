...
• 'Pay $3,000 upfront to start'"
            ...
            <div className="flex items-center justify-between mt-4">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  disabled={
                    isAnalyzing || !isAnyAIAvailable() || !textInput.trim()
                  }
          ...
          {results && results.success && (
            <div className="space-y-6">
              {/* Risk Level Card */}
              <div
                className={`rounded-2xl shadow-xl p-6 border-2 ${getRiskLevelColors(results.data.risk_level).border} ${getRiskLevelColors(results.data.risk_level).bgLight}`}
              >
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  ...
                  <div className="flex-shrink-0">
                    <RiskMeter
                      ...
                      riskLevel={results.data.risk_level}
                    />
                  </div>
                  ...
                  <div className="flex-1">
                    <div
                      className={`inline-flex items-center gap-2 px-4 py-2 rounded-full font-bold text-lg mb-3 ${
                        results.data.risk_level === "PREDATORY"
                          ? "bg-red-600 text-white"
                          : results.data.risk_level === "CAUTION"
                    ...
                    {results.data.recommendation && (
                      <p
                        className={`mt-2 font-semibold ${
                          results.data.recommendation === "RUN" ||
                          results.data.recommendation === "DO_NOT_SIGN"
                            ? "text-red-600 dark:text-red-400"
                            : "text-yellow-600 dark:text-yellow-400"
                        }`}
                      >
                        Recommendation:{" "}
                        {results.data.recommendation.replace(/_/g, " ")}
                      </p>
                    )}
                  </div>
                </div>
              ...
              {/* Positive Signs */}
              {results.data.positive_signs &&
                results.data.positive_signs.length > 0 && (
              ...
              {results.data.risk_level === "PREDATORY" && (
                <div className="bg-red-900 text-white rounded-2xl p-6">
                  ...
                  <p className="mb-4">
                    This contract contains serious red flags. Do NOT sign or
                    share personal information with this company.
                  </p>
          ...
          <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 rounded-xl p-6 border border-blue-200 dark:border-blue-700">
            ...
            <ul className="space-y-2 text-sm text-blue-700 dark:text-blue-300">
              <li className="flex items-start gap-2">
                ...
                <span>
                  <strong>Free Help Exists:</strong> VA-accredited VSOs (like
                  DAV, VFW, American Legion) help veterans for FREE.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">•</span>
                <span>
                  ...
                  attorneys/agents can charge fees, and only AFTER an initial
                  claim decision.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">•</span>
                <span>
                  <strong>Never Share Passwords:</strong> Legitimate
                  representatives never need your VA.gov or ID.me login
                  credentials.
                </span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">•</span>
                <span>
                  <strong>No Guarantees:</strong> No one can guarantee a
                  specific rating. Anyone who does is being deceptive.
                </span>
              </li>
            </ul>
          </div>
