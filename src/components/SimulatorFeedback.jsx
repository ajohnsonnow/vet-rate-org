    ...
    <div ref={feedbackContentRef} className="space-y-6">
        ...
        <div className="bg-white rounded-lg shadow-md border-2 border-green-200 p-6">
          <div className="flex items-start gap-3 mb-4">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-600 mb-4">
                These are specific steps you should take to prepare for your
                exam and maximize your rating.
              </p>
            </div>
          </div>
      ...
      <div className="bg-gray-100 border-l-4 border-gray-400 p-4 rounded">
        <p className="text-sm text-gray-600 italic">
          ...
          personalized advice. The information provided is based on 38 CFR Part
          4 as of January 2026.
        </p>
      </div>
    </div>
  );
