      ...
      <div>
        ...
        <div className="bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-xl p-6 mb-6 border border-purple-200 dark:border-purple-700">
          ...
          <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
            Have questions about state benefits, eligibility, or how to apply?
                  ...
                  {results.verified ? (
                    <>
                      <p className="text-xs text-green-700 dark:text-green-300 leading-relaxed">
                        <strong>Manually Verified:</strong> This data has been
                        scraped and verified from official state sources.
                        Includes legal citations, dollar amounts, and
                    ...
                    <>
                      <p className="text-xs text-amber-700 dark:text-amber-300 leading-relaxed">
                        ...
                        verification. Benefits shown are typical for this state
