...
function PyramidingWarningsSection({ t, pyramiding }) {
  if (!pyramiding.hasPotentialPyramiding) return null;
  return (
...
function TdiuAdvisorySection({ tdiu }) {
  if (!tdiu.eligible) return null;
  return (
...
function QuickPayPreview({ t, results, setActiveTab }) {
  return (
...
function CalculationStepDetail({ step }) {
  return (
...
function CalculatorResultsSection({
  ...
  return (
    <div className="space-y-6">
      ...
      <TdiuAdvisorySection tdiu={tdiu} />

      {/* Gap Analysis */}
      <GapAnalysisSection
        t={t}
        results={results}
        ratingNeededFor90={ratingNeededFor90}
        ratingNeededFor100={ratingNeededFor100}
      />

      {/* Quick Pay Preview */}
      <QuickPayPreview t={t} results={results} setActiveTab={setActiveTab} />
