      ...
      <div className={`${modalClasses.content} max-w-4xl max-h-[90vh] flex flex-col overflow-hidden`}>
        ...
        <div className="flex-shrink-0 bg-red-700 text-white px-6 py-4 border-b-4 border-red-900">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold">Terms of Service & Liability Waiver</h2>
          </div>
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 space-y-6 text-gray-800">
          ...
          <section className="border-l-4 border-blue-500 pl-4">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              ...
              <p className="mt-3 bg-gray-100 p-3 rounded">
                <strong>Recommendation:</strong> For complex cases, consider working with an accredited VSO 
                or VA-accredited attorney. Visit{' '}
                <a href="https://www.va.gov/ogc/accreditation.asp" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
          ...
          <section className="border-l-4 border-green-500 pl-4">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              <p>
                The "Nexus Letter Builder," "Symptom Database," "Secondary Conditions Scout," and all 
                other medical-related features are <strong>organizational tools only</strong>-they are 
                <span className="font-semibold underline"> NOT medical diagnostic instruments</span>.
              </p>
              <p className="mt-2">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>Generated content does not substitute for a licensed physician's evaluation</li>
                <li>Only qualified healthcare professionals can provide medical opinions for VA claims</li>
                <li>You must obtain proper medical evidence from licensed providers</li>
              </ul>
              <p className="mt-3 bg-gray-100 p-3 rounded">
                <strong>What We Do:</strong> We help you articulate symptoms in medically-recognized 
                terminology and identify potential connections based on VA medical literature. 
                <strong> What We Don't Do:</strong> Provide medical opinions, diagnoses, or treatment advice.
              </p>
            </div>
          </section>
          ...
          <section className="border-l-4 border-purple-500 pl-4">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              <p>
                Portions of this application use <strong>Artificial Intelligence (AI)</strong> to generate 
                content, suggest language, and organize information.
              </p>
              <p className="mt-2">
                <strong>AI Can Make Mistakes:</strong>
              </p>
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>Case law citations may be outdated, incomplete, or incorrectly referenced</li>
                <li>Medical terminology may be imprecise or contextually inappropriate</li>
                <li>Regulatory interpretations may not reflect the most current VA guidance</li>
              ...
              <p className="mt-3 bg-yellow-50 border border-yellow-300 p-3 rounded">
                <strong className="text-red-700">YOUR RESPONSIBILITY:</strong> You must independently 
                verify all AI-generated content, cross-reference legal citations, and confirm medical 
                information with qualified professionals. <span className="underline">Do not submit 
                AI-generated content to the VA without thorough human review.</span>
              </p>
            </div>
          </section>
          ...
          <section className="border-l-4 border-orange-500 pl-4">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                <li>All data is stored locally in your web browser's <code className="bg-gray-200 px-1 rounded">localStorage</code></li>
              ...
              <p className="mt-3 text-xs text-gray-600">
                <strong>Best Practice:</strong> After each significant work session, use the "Export" 
                feature to save a backup copy to your computer or cloud storage.
              </p>
            </div>
          </section>
          ...
          <section className="border-l-4 border-red-500 pl-4">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>That your rating will increase upon appeal or supplemental claim</li>
                <li>Any particular outcome from the Department of Veterans Affairs</li>
              </ul>
              <p className="mt-3">
                <strong>Factors Beyond Our Control:</strong> VA claim outcomes depend on the strength of 
                your medical evidence, service records, C&P exam results, VA regional office practices, 
                and current case law-none of which this tool can influence or predict.
              </p>
              <p className="mt-3 bg-gray-100 p-3 rounded">
                <strong>What We Can Help With:</strong> Organizing your argument, identifying relevant 
                medical research, articulating your case clearly, and understanding VA rating criteria. 
                <strong> What We Cannot Control:</strong> How the VA adjudicates your specific claim.
              </p>
            </div>
          </section>
          ...
          <section className="bg-gray-50 p-4 rounded-lg border border-gray-300">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              <p>
                <strong>No Warranty:</strong> This software is provided "AS IS" without warranty of any 
              ...
              <p>
                <strong>Updates to Terms:</strong> These terms may be updated periodically. Continued use 
