...
const TosModalFooter = ({ canAccept, countdown, onAccept }) => (
...
const TosClauseNonAccreditation = () => (
...
const TosClauseNotMedicalAdvice = () => (
...
const TosContent = () => (
  <div className="space-y-6 text-gray-800">
    <TosPreamble />
    <TosClauseNonAccreditation />
    <TosClauseNotMedicalAdvice />
    <TosClauseAiLimitations />
    <TosClauseDataVolatility />
    <TosClauseNoGuarantees />
    <TosAdditionalTerms />
    <TosFinalStatement />
  </div>
);
