...
const TermsOfServiceModal = () => {
  ...
  return (
    <div data-tos-modal="true" className={`${modalClasses.backdrop} z-[99]`}>
      <div
        className={`${modalClasses.content} max-w-4xl max-h-[90vh] flex flex-col overflow-hidden`}
      >
        {/* Header - Fixed at top */}
          ...
          <section className="border-l-4 border-blue-500 pl-4">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              ...
              <p className="mt-3">
                ...
                thoughts, understand VA rating criteria, and prepare
          ...
          <section className="border-l-4 border-green-500 pl-4">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>
                  You must obtain proper medical evidence from licensed
                  providers
                </li>
              </ul>
              <p className="mt-3 bg-gray-100 p-3 rounded">
          ...
          <section className="border-l-4 border-purple-500 pl-4">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              <p>
                ...
                <strong>Artificial Intelligence (AI)</strong> to generate
              ...
              <p className="mt-3 bg-yellow-50 border border-yellow-300 p-3 rounded">
                <strong className="text-red-700">YOUR RESPONSIBILITY:</strong>{" "}
          ...
          <section className="border-l-4 border-red-500 pl-4">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-1 ml-4">
                ...
                <li>
                  That your rating will increase upon appeal or supplemental
                  claim
                </li>
                <li>
              ...
              <p className="mt-3">
                ...
                depend on the strength of your medical evidence, service
                records, C&P exam results, VA regional office practices, and
                current case law-none of which this tool can influence or
                predict.
              </p>
              <p className="mt-3 bg-gray-100 p-3 rounded">
                <strong>What We Can Help With:</strong> Organizing your
                argument, identifying relevant medical research, articulating
                your case clearly, and understanding VA rating criteria.
          ...
          <section className="bg-gray-50 p-4 rounded-lg border border-gray-300">
            ...
            <div className="space-y-2 text-sm leading-relaxed">
              ...
              <p>
                ...
                punitive damages arising from your use of this tool.
              </p>
              <p>
                <strong>Severability:</strong> If any provision of these terms
                is found unenforceable, the remaining provisions shall remain in
                full effect.
              </p>
              <p>
                <strong>Updates to Terms:</strong> These terms may be updated
                periodically. Continued use constitutes acceptance of any
                changes.
              </p>
            </div>
          </section>
