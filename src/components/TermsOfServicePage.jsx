        ...
        <div className="px-8 py-8 space-y-8 text-gray-800 dark:text-gray-200">
          ...
          <section>
            ...
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-400 dark:border-yellow-600 p-6 space-y-3">
              <p className="leading-relaxed text-gray-800 dark:text-gray-200">
                <strong>Vet-Rate.org</strong> is a free, privacy-first
                educational platform designed to help United States veterans
                understand VA disability rating criteria, organize their claim
                documentation, and navigate the complex veterans benefits
                system.
              </p>
              <p className="leading-relaxed text-gray-800 dark:text-gray-200">
                ...
                service by clearly defining what Vet-Rate.org is, what it is
                not, and the inherent limitations of self-help legal technology.
              </p>
            ...
            <div className="space-y-4 leading-relaxed">
              <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1 mt-2 ml-4 text-gray-800 dark:text-gray-200">
                  ...
                  <li>
                    A representative authorized to practice before the
                    Department of Veterans Affairs
                  </li>
                  <li>
                    Affiliated with, endorsed by, or operating under the
                    authority of the U.S. Department of Veterans Affairs
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-4 mt-2">
                  <li>
                    Access to publicly available VA rating criteria and
                    schedules
                  </li>
                  <li>
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-300 p-4 rounded-lg">
                ...
                <p className="text-gray-800">
                  ...
                  or cases involving legal nuances, it is strongly recommended
                  to work with an accredited representative. Find one at:{" "}
                  <a
            ...
            <div className="space-y-4 leading-relaxed">
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <p className="text-sm">
                  ...
                  relationship. Always consult with your own healthcare
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-white dark:bg-gray-800 border-2 border-purple-400 dark:border-purple-600 p-3 rounded shadow-sm">
                    ...
                    <p className="text-sm text-gray-800 dark:text-gray-200">
                      AI may use medical terms imprecisely, suggest
                      inappropriate diagnostic criteria, or misunderstand
                      symptom relationships. Medical content requires healthcare
                  ...
                  <div className="bg-white dark:bg-gray-800 border-2 border-purple-400 dark:border-purple-600 p-3 rounded shadow-sm">
                    ...
                    <p className="text-sm text-gray-800">
                      ...
                      correct but practically inapplicable to your specific
                      case.
                    </p>
                  </div>
            ...
            <div className="space-y-4 leading-relaxed">
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 ml-4">
                  ...
                  <li>
                    Export functionality allows you to save data to your own
                    files
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-green-50 dark:bg-green-900/20 border-2 border-green-500 dark:border-green-600 p-5 rounded-lg">
                ...
                <div className="space-y-2 text-gray-800">
                  <p>
                    <strong>1. Export Regularly:</strong> Use the built-in
                    export features after each work session
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>3. Before Browser Maintenance:</strong> Always
                    export your data before clearing cache or updating browsers
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>5. Test Imports:</strong> Periodically test that
                    your exported files can be successfully re-imported
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <p className="text-sm">
                  ...
                  Vet-Rate.org, you acknowledge and accept full responsibility
                  for backing up your data. We are not liable for any data loss,
                  regardless of cause, including but not limited to browser
                  issues, technical failures, user error, or circumstances
                  beyond our control.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 leading-relaxed">
              ...
              <div>
                ...
                <div className="grid md:grid-cols-2 gap-3">
                  ...
                  <div className="bg-white dark:bg-gray-800 border border-gray-300 p-3 rounded">
                    ...
                    <p className="text-xs text-gray-600">
                      Evolving legal precedents from Court of Appeals for
                      Veterans Claims
                    </p>
                  </div>
                  <div className="bg-white dark:bg-gray-800 border border-gray-300 p-3 rounded">
              ...
              <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-300 p-4 rounded-lg">
                ...
                <ul className="list-disc list-inside space-y-1 ml-4 text-gray-800">
                  ...
                  <li>
                    Identifying potential secondary conditions to research
                  </li>
              ...
              <div className="bg-gray-100 p-4 rounded-lg">
                <p className="text-sm">
                  ...
                  with VA adjudicators applying legal and medical criteria to
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed bg-gray-50 dark:bg-gray-800 p-4 rounded">
                  ...
                  PARTICULAR PURPOSE, TITLE, AND NON-INFRINGEMENT. THE WEBAPP
                  DOES NOT WARRANT THAT THE SOFTWARE WILL BE UNINTERRUPTED,
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed bg-gray-50 dark:bg-gray-800 p-4 rounded">
                  ...
                  and its operators from any claims, damages, liabilities,
              ...
              <div>
                ...
                <p className="text-sm leading-relaxed bg-gray-50 dark:bg-gray-800 p-4 rounded">
                  The webapp reserves the right to modify these terms at any
                  time. Material changes will be indicated by updating the "Last
          ...
          <section className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-600 p-6 rounded-lg">
            ...
            <p className="text-sm text-blue-800">
              <strong>Remember:</strong> I cannot provide legal advice about
              your specific claim. For legal guidance, consult with an
              accredited VSO or VA-accredited attorney.
            </p>
          </section>
