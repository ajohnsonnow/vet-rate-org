        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            {countdown.isExpired ? (
              ...
              <>
                <p className="text-3xl font-bold">{countdown.daysRemaining} Days</p>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) => setEstimatedRating(parseInt(e.target.value))}
                    className="w-full px-4 py-3 border-2 border-gray-300 dark:border-gray-600 rounded-lg focus:border-blue-500 dark:bg-gray-700 dark:text-white text-lg"
                  >
                ...
                {countdown.isExpired ? (
                  ...
                  <>
                    ...
                    <p className="text-lg text-gray-600 dark:text-gray-300">
                      Expires: {countdown.expirationDate.toLocaleDateString('en-US', {
                        weekday: 'long',
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric'
              ...
              {countdown.isCritical && !countdown.isExpired && (
                <div className="bg-red-100 dark:bg-red-900/30 border-l-4 border-red-600 p-4 rounded animate-pulse">
                  ...
                  <p className="text-red-700 dark:text-red-300">
                    You need to file your claim IMMEDIATELY. Every day counts. If you're not ready, 
                    consider filing a "protective claim" with what you have now.
                  </p>
                </div>
              )}
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className={`font-semibold ${
                      countdown.isCritical ? 'text-red-600' : countdown.isUrgent ? 'text-yellow-600' : 'text-green-600'
                    }`}>
                ...
                <div className="mt-4">
                  ...
                  <p className="text-xs text-center text-gray-500 dark:text-gray-400 mt-1">
                    {Math.round((countdown.daysRemaining / 365) * 100)}% of ITF period remaining
                  </p>
                </div>
              </div>
          ...
          {!countdown && !isEditing && (
            <div className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-400 p-4 rounded">
              ...
              <p className="text-blue-700 dark:text-blue-300 text-sm mb-2">
                An Intent to File (ITF) establishes your effective date for VA benefits. You have 
                365 days from the ITF date to submit your complete claim.
              </p>
              <p className="text-blue-700 dark:text-blue-300 text-sm font-semibold">
                Your backpay is calculated from your ITF date, not when you submit your claim!
              </p>
            </div>
          )}
        </div>
