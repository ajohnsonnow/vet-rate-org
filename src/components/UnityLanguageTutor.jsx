...
const UnityLanguageTutor = ({
  ...
  const translations = {
    es: {
      ...
      flag: "🇲🇽",
      phrases: {
        here_for_you: { text: "Estoy aquí para ti", phonetic: "Es-TOY ah-KEE PAH-rah tee" },
        not_alone: { text: "No estás solo", phonetic: "No es-TAS SO-lo" },
        fought_together: { text: "Luchamos juntos", phonetic: "Loo-CHA-mos HOON-tos" },
        understand: { text: "Entiendo", phonetic: "En-tee-EN-do" },
        stay_strong: { text: "Mantente fuerte", phonetic: "Man-TEN-tay FWER-tay" },
        where_serve: { text: "¿Dónde serviste?", phonetic: "DON-day ser-VEES-tay" },
        your_job: { text: "¿Cuál era tu trabajo?", phonetic: "KWAHL EH-ra too tra-BA-ho" },
        welcome_home: { text: "Bienvenido a casa", phonetic: "Bee-en-veh-NEE-do ah KA-sa" },
        thank_service: { text: "Gracias por tu servicio", phonetic: "GRA-see-as por too ser-VEE-see-oh" },
        how_long: { text: "¿Cuánto tiempo serviste?", phonetic: "KWAN-to tee-EM-po ser-VEES-tay" },
        are_ok: { text: "¿Estás bien?", phonetic: "Es-TAS bee-EN" },
        take_break: { text: "Tomemos un descanso", phonetic: "To-MAY-mos oon des-KAN-so" },
        deep_breath: { text: "Respira profundo", phonetic: "Res-PEE-ra pro-FOON-do" },
        how_feeling: { text: "¿Cómo te sientes?", phonetic: "KO-mo tay see-EN-tays" },
        listening: { text: "Te escucho", phonetic: "Tay es-KOO-cho" },
        semper_fi: { text: "Semper Fi, compañero", phonetic: "SEM-per FEE, kom-pan-YAIR-oh" },
        hooah: { text: "Hooah, guerrero", phonetic: "HOO-ah, gair-RAIR-oh" },
        hooyah: { text: "Hooyah, marinero", phonetic: "HOO-yah, ma-ree-NAIR-oh" },
        aim_high: { text: "Alto vuelo, aviador", phonetic: "AL-to VWAY-lo, ah-vee-a-DOR" }
      }
    },
    tl: {
      name: "Tagalog",
      ...
      flag: "🇵🇭",
      phrases: {
        here_for_you: { text: "Nandito ako para sa iyo", phonetic: "Nan-DEE-to ah-KO PAH-ra sa ee-YO" },
        not_alone: { text: "Hindi ka nag-iisa", phonetic: "Hin-DEE kah nahg-ee-EE-sa" },
        fought_together: { text: "Magkasama tayong lumaban", phonetic: "Mahg-ka-SA-ma TA-yong loo-MA-ban" },
        understand: { text: "Naiintindihan kita", phonetic: "Nah-een-tin-dee-HAN kee-TA" },
        stay_strong: { text: "Maging malakas", phonetic: "Ma-GING ma-LA-kas" },
        where_serve: { text: "Saan ka nagsilbi?", phonetic: "Sa-AN ka nahg-SEEL-bee" },
        your_job: { text: "Ano ang trabaho mo?", phonetic: "Ah-NO ang tra-BA-ho mo" },
        welcome_home: { text: "Maligayang pagbabalik", phonetic: "Ma-lee-GA-yang pahg-ba-BA-lik" },
        thank_service: { text: "Salamat sa iyong serbisyo", phonetic: "Sa-LA-mat sa ee-YONG ser-BEES-yo" },
        how_long: { text: "Gaano katagal ka nagsilbi?", phonetic: "Ga-AH-no ka-ta-GAL ka nahg-SEEL-bee" },
        are_ok: { text: "Ayos ka lang ba?", phonetic: "AH-yos ka lang ba" },
        take_break: { text: "Magpahinga tayo", phonetic: "Mahg-pa-HEENG-a TA-yo" },
        deep_breath: { text: "Huminga ng malalim", phonetic: "Hoo-MEENG-a nahng ma-la-LEEM" },
        how_feeling: { text: "Kumusta ang pakiramdam mo?", phonetic: "Koo-MOOS-ta ang pa-kee-ram-DAM mo" },
        listening: { text: "Nakikinig ako", phonetic: "Na-kee-kee-NEEG ah-KO" },
        semper_fi: { text: "Semper Fi, kapatid", phonetic: "SEM-per FEE, ka-PA-tid" },
        hooah: { text: "Hooah, kawal", phonetic: "HOO-ah, ka-WAL" },
        hooyah: { text: "Hooyah, marino", phonetic: "HOO-yah, ma-REE-no" },
        aim_high: { text: "Mataas ang layunin", phonetic: "Ma-TA-as ang la-YOO-nin" }
      }
    },
    vi: {
      name: "Vietnamese",
      ...
      flag: "🇻🇳",
      phrases: {
        here_for_you: { text: "Tôi ở đây vì bạn", phonetic: "Toy uh day vee bahn" },
        not_alone: { text: "Bạn không đơn độc", phonetic: "Bahn kohng duhn dohk" },
        fought_together: { text: "Chúng ta chiến đấu cùng nhau", phonetic: "Chung ta chee-en dow koong nyow" },
        understand: { text: "Tôi hiểu", phonetic: "Toy hee-oo" },
        stay_strong: { text: "Hãy mạnh mẽ", phonetic: "Hi mahng may" },
        where_serve: { text: "Bạn phục vụ ở đâu?", phonetic: "Bahn fook voo uh dow" },
        your_job: { text: "Công việc của bạn là gì?", phonetic: "Kohng vee-ek koo-a bahn la zee" },
        welcome_home: { text: "Chào mừng về nhà", phonetic: "Chow muhng vay nyah" },
        thank_service: { text: "Cảm ơn bạn đã phục vụ", phonetic: "Kahm uhn bahn dah fook voo" },
        how_long: { text: "Bạn phục vụ bao lâu?", phonetic: "Bahn fook voo bow low" },
        ...
        how_feeling: { text: "Bạn cảm thấy thế nào?", phonetic: "Bahn kahm thay thay now" },
        listening: { text: "Tôi đang nghe", phonetic: "Toy dahng ngay" },
        semper_fi: { text: "Semper Fi, đồng đội", phonetic: "SEM-per FEE, dohng doy" },
        hooah: { text: "Hooah, chiến sĩ", phonetic: "HOO-ah, chee-en see" },
        hooyah: { text: "Hooyah, thủy thủ", phonetic: "HOO-yah, twee too" },
        aim_high: { text: "Hướng cao, phi công", phonetic: "Huhng cow, fee kohng" }
      }
    },
    ko: {
      name: "Korean",
      ...
      flag: "🇰🇷",
      phrases: {
        here_for_you: { text: "나는 당신을 위해 여기 있어요", phonetic: "Na-neun dang-shin-eul wi-hae yeo-gi iss-eo-yo" },
        not_alone: { text: "당신은 혼자가 아닙니다", phonetic: "Dang-shin-eun hon-ja-ga a-nip-ni-da" },
        fought_together: { text: "우리는 함께 싸웠습니다", phonetic: "U-ri-neun ham-kke ssa-woss-seup-ni-da" },
        understand: { text: "이해합니다", phonetic: "I-hae-hap-ni-da" },
        stay_strong: { text: "강해지세요", phonetic: "Gang-hae-ji-se-yo" },
        where_serve: { text: "어디서 복무하셨나요?", phonetic: "Eo-di-seo bok-mu-ha-syeoss-na-yo" },
        your_job: { text: "무슨 일을 하셨나요?", phonetic: "Mu-seun il-eul ha-syeoss-na-yo" },
        welcome_home: { text: "집에 온 것을 환영합니다", phonetic: "Jip-e on geos-eul hwan-yeong-hap-ni-da" },
        thank_service: { text: "복무해주셔서 감사합니다", phonetic: "Bok-mu-hae-ju-syeo-seo gam-sa-hap-ni-da" },
        how_long: { text: "얼마나 오래 복무하셨나요?", phonetic: "Eol-ma-na o-rae bok-mu-ha-syeoss-na-yo" },
        are_ok: { text: "괜찮으세요?", phonetic: "Gwaen-chan-eu-se-yo" },
        take_break: { text: "잠깐 쉬어요", phonetic: "Jam-kkan swi-eo-yo" },
        deep_breath: { text: "깊게 숨쉬세요", phonetic: "Gip-ge sum-swi-se-yo" },
        how_feeling: { text: "기분이 어떠세요?", phonetic: "Gi-bun-i eo-tteo-se-yo" },
        listening: { text: "듣고 있습니다", phonetic: "Deut-go iss-seup-ni-da" },
        ...
        aim_high: { text: "높이 겨냥, 공군", phonetic: "Nop-i gyeo-nyang, gong-gun" }
      }
    }
  };
  ...
  return (
    <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 p-4">
      <div className={`bg-slate-900 border-2 border-indigo-500/50 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-hidden flex flex-col ${className}`}>
        {/* Header */}
        <div className="p-6 border-b border-slate-800">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="text-xl font-bold text-white">Unity Language Tutor</h2>
                <p className="text-slate-400 text-sm">Learn the languages of your fellow veterans</p>
              </div>
            </div>
            <button
              onClick={onClose}
        ...
        <div className="p-4 bg-slate-800/50 border-b border-slate-800">
          <div className="grid grid-cols-2 gap-4">
            {/* Target Language */}
            <div>
              <label className="block text-xs text-slate-400 mb-2">Learn This Language</label>
              <select
                value={targetLang}
                onChange={(e) => {
            ...
            {/* Phrase Category */}
            <div>
              <label className="block text-xs text-slate-400 mb-2">Phrase Category</label>
              <select
          ...
          {!currentPhrase ? (
            ...
            <div className="space-y-2">
              <h3 className="text-sm text-slate-400 mb-3">
                {learningModules[phraseCategory].icon} {learningModules[phraseCategory].title}
              </h3>
                  ...
                  >
                    <div className="flex justify-between items-start">
                      <div className="flex-1">
                        ...
                        {translation && (
                          <p className="text-indigo-400 text-sm mt-1">{translation.text}</p>
                        )}
                      </div>
            ...
            <div className="bg-slate-800/50 rounded-xl border border-indigo-500/30 p-6">
              ...
              <div className="mb-6 text-center">
                ...
                <p className="text-2xl text-white font-bold">{currentPhrase.english}</p>
              </div>
              ...
              <div className="mb-6 text-center bg-indigo-500/10 rounded-xl p-6 border border-indigo-500/20">
                <p className="text-indigo-400 text-sm mb-2">
                  {translations[targetLang].flag} {translations[targetLang].nativeName}
                </p>
                <p className="text-3xl text-white font-bold mb-3">{currentPhrase.target}</p>
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-800/30">
          <p className="text-xs text-slate-500 text-center">
            🤝 Building unity through language • 100% Private • No data leaves your device
          </p>
        </div>
      </div>
    </div>
