...
const HIGH_IMPACT_AI_SYSTEMS = [
  {
    name: "STORM (Opioid Overdose Risk)",
    category: "Healthcare",
    description:
      "AI system that identifies Veterans at risk of opioid overdose and provides clinical decision support.",
    impact: "22% decrease in mortality for Veterans prescribed opioids",
    status: "Active",
    riskLevel: "High-Impact",
    veteranBenefit:
      "Helps your care team identify and mitigate overdose risks proactively",
  },
  {
    name: "AI-Assisted Colonoscopy",
    category: "Healthcare",
    description:
      "Computer vision AI that helps doctors detect polyps and tumors during colonoscopy procedures.",
  ...
  },
  {
    ...
    category: "Benefits",
    description:
      "AI model that identifies potentially fraudulent direct deposit changes to protect veteran benefits.",
    impact: "Detects 1-2 fraudulent changes per 1,000 transactions",
    status: "Active",
    riskLevel: "High-Impact",
    veteranBenefit:
      "Protects your benefit payments from identity theft and fraud",
  },
  {
    name: "Ambient AI Clinical Scribe",
    category: "Healthcare",
    description:
      "AI that transcribes doctor-patient conversations and auto-generates clinical notes in real-time.",
    impact:
  ...
  },
  {
    ...
    category: "Benefits",
    description:
      "AI that automatically organizes and routes documents in disability claims for faster processing.",
    impact:
      'Accelerates document processing, supports "minutes not months" goal',
    status: "Active",
...
const GOVERNANCE_PROTECTIONS = [
  {
    title: "OMB M-25-21 Compliance",
    description:
      "VA follows federal AI requirements including risk assessments, testing, and monitoring for all high-impact AI systems.",
    icon: Shield,
  },
  {
    title: "Human Oversight Required",
    description:
      "All high-impact AI decisions require human review. AI assists VA staff but doesn't make final decisions alone.",
    icon: Users,
  },
  {
    title: "Trustworthy AI Framework",
    description:
      "VA's AI systems must be fair, accountable, transparent, and respect privacy - adopted July 2023.",
    icon: CheckCircle,
  },
  {
    title: "Public Inventory",
    description:
      "VA publishes all 227 AI use cases publicly, updated annually for full transparency.",
    icon: Eye,
  },
  {
    title: "No Unapproved Data Sharing",
    description:
      "Your PII and health data can only be used with VA-approved AI tools that have passed security reviews.",
    icon: Lock,
  },
  {
    title: "AI Ethics Toolkit",
    description:
      "VA uses an AI Ethics Assessment Tool to anticipate and mitigate risks to veteran rights and safety.",
    icon: Scale,
  },
];

const AI_WORKFLOWS_BY_ADMINISTRATION = {
  vha: [
...
function OverviewKeyStatistics() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg border border-amber-300 dark:border-amber-700">
        ...
        <div className="text-sm text-amber-800 dark:text-amber-200">
          High-Impact AI Systems Monitored
        </div>
      </div>
    </div>
  );
    ...
    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-gray-200 dark:border-gray-700">
      ...
      <div className="space-y-3 text-gray-700 dark:text-gray-300">
        ...
        <p className="leading-relaxed">
          ...
          Real-time transcription of doctor visits, auto-generated clinical
          notes, suggested billing codes, and evidence-based treatment
          recommendations - letting doctors focus on patient care instead of
          paperwork.
        </p>
        <p className="leading-relaxed">
          ...
          Automated document intake, classification, and preliminary
          adjudication to deliver benefits faster with fewer errors.
        </p>
      </div>
    </div>
  );
...
function OverviewImportantNotice() {
  return (
...
function OverviewTab() {
  return (
    <div className="space-y-6">
      <OverviewHero />
      <OverviewKeyStatistics />
      <OverviewAIVision />
      <OverviewImportantNotice />
    </div>
  );
}
...
function AISystemCard({ system, accentClass, impactBoxClass, impactLabelClass, impactTextClass, benefitBoxClass, benefitIconClass, benefitTextClass }) {
  return (
    ...
    >
      ...
      <div className={`${impactBoxClass} p-3 rounded-lg mb-3`}>
        <div className={`text-sm font-semibold ${impactLabelClass} mb-1`}>
          Impact:
        </div>
    ...
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-teal-300 dark:border-teal-700">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          VA uses AI to improve diagnosis, reduce medical errors, identify
          health risks early, and reduce the time doctors spend on paperwork.
          Here are the major healthcare AI systems:
        </p>
        ...
        <div className="mt-6 p-5 bg-gradient-to-br from-blue-50 to-teal-50 dark:from-blue-900/20 dark:to-teal-900/20 rounded-lg border border-teal-300 dark:border-teal-700">
          <h5 className="font-bold text-gray-900 dark:text-gray-100 mb-3">
            Other Healthcare AI Initiatives:
          </h5>
          <WorkflowList
            workflows={AI_WORKFLOWS_BY_ADMINISTRATION.vha}
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-blue-300 dark:border-blue-700">
        ...
        <p className="text-gray-700 dark:text-gray-300 mb-6 leading-relaxed">
          VA uses AI to speed up disability claims processing, detect fraud,
          automate document organization, and assist with eligibility
          determinations - all while maintaining human oversight.
        </p>
        ...
        <div className="mt-6 space-y-4">
          <div className="p-5 bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg border border-blue-300 dark:border-blue-700">
            <h5 className="font-bold text-gray-900 dark:text-gray-100 mb-3">
              VBA (Benefits) AI Initiatives:
            </h5>
            <WorkflowList
              workflows={AI_WORKFLOWS_BY_ADMINISTRATION.vba}
          ...
          <div className="p-5 bg-gradient-to-br from-purple-50 to-blue-50 dark:from-purple-900/20 dark:to-blue-900/20 rounded-lg border border-purple-300 dark:border-purple-700">
            <h5 className="font-bold text-gray-900 dark:text-gray-100 mb-3">
              VEO (Veteran Experience) AI Initiatives:
            </h5>
            <WorkflowList
              workflows={AI_WORKFLOWS_BY_ADMINISTRATION.veo}
...
function HighImpactAISafetyRequirements() {
  return (
    <div className="mt-6 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 p-5 rounded-lg border-2 border-purple-300 dark:border-purple-700">
      <h5 className="font-bold text-gray-900 dark:text-gray-100 mb-3">
        High-Impact AI Safety Requirements:
      </h5>
      <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
        ...
        <div className="flex items-start gap-2">
          <CheckCircle className="h-4 w-4 text-purple-600 dark:text-purple-400 flex-shrink-0 mt-0.5" />
          <span>
            <strong>Continuous Monitoring:</strong> Performance tracked to
            detect bias, errors, or safety issues
          </span>
        </div>
        <div className="flex items-start gap-2">
          <CheckCircle className="h-4 w-4 text-purple-600 dark:text-purple-400 flex-shrink-0 mt-0.5" />
          <span>
            <strong>Testing & Validation:</strong> AI systems tested against
            diverse data to ensure accuracy
          </span>
        </div>
        <div className="flex items-start gap-2">
          <CheckCircle className="h-4 w-4 text-purple-600 dark:text-purple-400 flex-shrink-0 mt-0.5" />
...
function GenerativeAIPolicyNotice() {
  return (
    <div className="mt-6 bg-yellow-50 dark:bg-yellow-900/20 border-l-4 border-yellow-500 p-4 rounded-r-lg">
      ...
      <div className="space-y-2 text-sm text-yellow-900 dark:text-yellow-100">
        ...
        <p>
          ...
          Claude, Gemini) are NOT approved for veteran PII/PHI
        </p>
        <p>
          🔒 <strong>Your Data Protection:</strong> Your personal and health
          information can only be used with VA-approved, security-cleared AI
          tools
        </p>
        <p>
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-red-300 dark:border-red-700">
        ...
        <HighImpactAISafetyRequirements />
        <GenerativeAIPolicyNotice />
      </div>
    </div>
  );
}

function InventorySummaryHero() {
  return (
...
function InventoryExcelDownload() {
  return (
    <div className="bg-white dark:bg-gray-900 p-5 rounded-lg border-2 border-gray-200 dark:border-gray-700 mb-6">
      ...
      <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
        Download the full inventory as an Excel file for offline review and
        analysis (96KB, updated December 2024):
      </p>
      <a
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="p-4 bg-teal-50 dark:bg-teal-900/20 rounded-lg border border-teal-300 dark:border-teal-700">
          <div className="font-bold text-teal-900 dark:text-teal-100 mb-2">
            Healthcare Innovation
          </div>
          <div className="text-sm text-teal-800 dark:text-teal-200">
            21% increase in colonoscopy detection, STORM opioid risk model,
            ambient AI scribes, clinical documentation, health surveillance
          </div>
        </div>
        ...
        <div className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-300 dark:border-purple-700">
          ...
          <div className="text-sm text-purple-800 dark:text-purple-200">
            Document classification, eligibility determination, automated
...
function InventoryAdditionalResources() {
  return (
    <div className="mt-6 space-y-3">
      <h5 className="font-bold text-gray-900 dark:text-gray-100">
        More VA AI Resources:
      </h5>
      <a
      ...
      >
        ...
        <div className="flex-1">
          <div className="font-semibold text-purple-900 dark:text-purple-100">
            OMB M-25-21 Compliance Plan
          </div>
          <div className="text-sm text-purple-700 dark:text-purple-300">
            How VA meets federal AI requirements
          </div>
        </div>
      ...
      >
        ...
        <div className="flex-1">
          <div className="font-semibold text-orange-900 dark:text-orange-100">
            AI Workforce Blueprint (PDF)
          </div>
          <div className="text-sm text-orange-700 dark:text-orange-300">
            How VA is training staff for AI
          </div>
        </div>
...
function InventoryFeedbackLink() {
  return (
  ...
  return (
    <div className="space-y-6">
      <div className="bg-white dark:bg-gray-800 p-6 rounded-lg border-2 border-indigo-300 dark:border-indigo-700">
        ...
        <InventorySummaryHero />
        <InventoryExcelDownload />
        <InventoryCategories />
        <InventoryAdditionalResources />
        <InventoryFeedbackLink />
      </div>
    </div>
  );
}

function VAAITransparencyFooter({ onClose }) {
  return (
...
function VAAITransparencyTabs({ activeTab, onChangeTab }) {
  return (
...
function VAAITransparencyHeader({ activeTab, onChangeTab, onClose }) {
  return (
    <>
...
const VAAITransparency = ({ onClose }) => {
  ...
  return (
    <ResponsiveModal
      ...
      footer={<VAAITransparencyFooter onClose={onClose} />}
      header={
        <VAAITransparencyHeader
          activeTab={activeTab}
    ...
    >
      ...
      {activeTab === "healthcare" && <HealthcareAITab />}
      {activeTab === "benefits" && <BenefitsAITab />}
