...
const ParseFooter = ({ pasteText, setPasteText, isParsing, handleParse }) => (
...
const ParsedRatingsResults = ({ parsedResult }) => (
  <>
    {/* Combined Rating */}
    ...
    <ServiceConnectedRatingList ratings={parsedResult.serviceConnected} />

    {/* Non-Service-Connected Warning */}
    {parsedResult.notServiceConnected.length > 0 && (
      <NotServiceConnectedWarning
        notServiceConnected={parsedResult.notServiceConnected}
      />
    )}
  </>
);

const runParse = (pasteText, setParsedResult, setIsParsing) => {
  try {
...
export default function VAGovRatingPaster({
  ...
  const handleParse = () => {
    ...
    setTimeout(() => {
      runParse(pasteText, setParsedResult, setIsParsing);
    }, 100);
  };
  ...
  return (
    <ResponsiveModal
      ...
      header={<RatingPasterHeader onClose={onClose} />}
    >
      <div className="space-y-6">
        ...
        {!parsedResult ? (
          ...
          <ParsedRatingsResults parsedResult={parsedResult} />
        )}
      </div>
    </ResponsiveModal>
  );
