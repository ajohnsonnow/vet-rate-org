                    ...
                    <ul className="text-xs text-yellow-300 mt-2 space-y-1 font-mono">
                      {!getVaConfigStatus().hasOAuth && (
                        <>
                          ...
                          <li>
                            • VITE_VA_REDIRECT_URL (must match what you
                            submitted on the VA sandbox form)
                          </li>
                          <li>
                            • VITE_VA_OAUTH_API_PATH (e.g.,
                            veteran-verification/v1)
                          </li>
                        </>
                      )}
          ...
          <div className="p-6 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <button
                    ...
                    disabled={
                      loading.facilities || !isFacilitiesApiKeyConfigured
                    }
                ...
                >
                  ...
                  <button
                    ...
                    disabled={
                      loading.disabilities || !isBenefitsApiKeyConfigured
                    }
            ...
            <div className="bg-gray-50 dark:bg-gray-700/30 rounded-xl p-4">
              ...
              <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-600">
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  <strong>Scopes Requested:</strong> openid profile
                  offline_access claim.read service_history.read
