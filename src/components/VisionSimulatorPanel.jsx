    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 space-y-4">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 rounded-lg p-3">
        <div className="flex items-start gap-2">
          ...
          <div className="text-sm text-blue-800 dark:text-blue-200">
            <strong>How it works:</strong> This uses OCR (Tesseract.js) to extract text from your document, 
            then combines it with AI analysis. While not as powerful as a true vision model, 
            it works great for text-heavy documents like DD214s, medical records, and VA forms.
          </div>
        </div>
      </div>
          ...
          {analysisResult.isQuickCheck ? (
            ...
            <div className={`p-3 rounded-lg ${
              ...
              <p className="font-medium">
                {analysisResult.quickCheck.isLikely ? '✅ This appears to be a DD214!' : '⚠️ May not be a DD214'}
              </p>
            ...
            <>
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded p-3">
                ...
                <p className="text-gray-900 dark:text-white">{analysisResult.structureInfo?.estimatedType}</p>
                <p className="text-xs text-gray-500 mt-1">
                  {analysisResult.structureInfo?.width} × {analysisResult.structureInfo?.height} px | 
                  Text Density: {analysisResult.structureInfo?.textDensityScore}
                </p>
              </div>
              
              {/* OCR Stats */}
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded p-3">
                <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Text Extraction</p>
                <p className="text-gray-900 dark:text-white">
                  {analysisResult.ocrResult?.words} words, {analysisResult.ocrResult?.lines} lines
                </p>
                <p className="text-xs text-gray-500 mt-1">
              ...
              {analysisResult.dd214Elements?.isLikelyDD214 && (
                <div className="bg-green-50 dark:bg-green-900/30 rounded p-3 border border-green-200 dark:border-green-800">
                  <p className="text-sm font-medium text-green-800 dark:text-green-200">🎖️ DD214 Detected!</p>
                  {analysisResult.dd214Elements.characterOfService && (
                    <p className="text-sm">Character: <strong>{analysisResult.dd214Elements.characterOfService}</strong></p>
                  )}
                  {analysisResult.dd214Elements.serviceInfo?.branch && (
                    <p className="text-sm">Branch: <strong>{analysisResult.dd214Elements.serviceInfo.branch}</strong></p>
                  )}
                </div>
              )}
              ...
              <div className="bg-gray-50 dark:bg-gray-700/50 rounded p-3">
                <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Extracted Text Preview</p>
      ...
      <details className="text-sm">
        ...
        <div className="mt-2 grid grid-cols-2 gap-2 text-xs">
          <div>
            <p className="font-medium text-gray-700 dark:text-gray-300">✅ Capabilities</p>
          ...
          <div>
            <p className="font-medium text-gray-700 dark:text-gray-300">⚠️ Limitations</p>
            <ul className="text-gray-600 dark:text-gray-400 space-y-1 mt-1">
