    ...
    secondaries: [
      {
        ...
        strength: 0.9,
        nexus:
          "Both conditions stem from noise-induced damage to cochlear hair cells. The same acoustic trauma that causes tinnitus typically damages hearing.",
      },
      {
        condition: "Migraines",
        strength: 0.7,
        nexus:
          "Chronic tinnitus creates persistent auditory cortex stimulation, leading to neurological changes that trigger migraines.",
      },
      {
        condition: "Anxiety",
        strength: 0.8,
        nexus:
          "Constant ringing creates hypervigilance and stress responses, triggering the anxiety feedback loop.",
      },
      {
        condition: "Depression",
        strength: 0.75,
        nexus:
          "Sleep disruption and inability to find silence leads to depressive symptoms over time.",
      },
      {
        condition: "Sleep Apnea",
        strength: 0.6,
        nexus:
          "Tinnitus disrupts sleep architecture, contributing to or worsening sleep apnea symptoms.",
      },
      {
        condition: "Insomnia",
        strength: 0.85,
        nexus:
          "The phantom noise makes it difficult to fall asleep and stay asleep, causing chronic insomnia.",
      },
    ],
  },
  PTSD: {
    ...
    secondaries: [
      {
        ...
        strength: 0.9,
        nexus:
          "PTSD and depression share overlapping neurobiological pathways. Trauma alters serotonin and norepinephrine systems.",
      },
      {
        condition: "Anxiety",
        strength: 0.95,
        nexus:
          "Hyperarousal symptoms of PTSD directly cause generalized anxiety through constant fight-or-flight activation.",
      },
      {
        condition: "Migraines",
        strength: 0.65,
        nexus:
          "Stress hormones from PTSD cause chronic tension and vascular changes leading to migraines.",
      },
      {
        condition: "Sleep Apnea",
        strength: 0.7,
        nexus:
          "PTSD nightmares and hyperarousal disrupt normal sleep patterns, contributing to sleep apnea.",
      },
      {
        condition: "Insomnia",
        strength: 0.85,
        nexus:
          "Hypervigilance and nightmares prevent normal sleep initiation and maintenance.",
      },
      {
        condition: "IBS",
        strength: 0.7,
        nexus:
          "The gut-brain axis is disrupted by chronic stress, causing gastrointestinal dysfunction.",
      },
      {
        condition: "GERD",
        strength: 0.6,
        nexus:
          "Stress increases stomach acid production and weakens the lower esophageal sphincter.",
      },
      {
        condition: "Hypertension",
        strength: 0.65,
        nexus:
          "Chronic stress activation raises blood pressure over time through sustained cortisol elevation.",
      },
      {
        condition: "Erectile Dysfunction",
        strength: 0.7,
        nexus:
          "PTSD medications (SSRIs) and psychological factors both contribute to sexual dysfunction.",
      },
      {
        condition: "Substance Abuse",
        strength: 0.75,
        nexus:
          "Self-medication attempts to manage PTSD symptoms often lead to dependency.",
      },
    ],
  },
  "Lumbar Strain / DDD": {
    ...
    secondaries: [
      {
        ...
        strength: 0.85,
        nexus:
          "Degenerative disc changes compress nerve roots, causing radiating pain and numbness.",
      },
      {
        condition: "Sciatica",
        strength: 0.8,
        nexus:
          "Disc herniation or spinal stenosis irritates the sciatic nerve, causing leg symptoms.",
      },
      {
        condition: "Hip Pain",
        strength: 0.7,
        nexus:
          "Altered gait and posture from back pain creates secondary stress on hip joints.",
      },
      {
        condition: "Knee Pain",
        strength: 0.65,
        nexus: "Compensatory movements to protect the back strain knee joints.",
      },
      {
        condition: "Depression",
        strength: 0.7,
        nexus:
          "Chronic pain leads to depressive symptoms through shared inflammatory pathways.",
      },
      {
        condition: "Obesity",
        strength: 0.6,
        nexus:
          "Reduced mobility from pain leads to weight gain, which further stresses the spine.",
      },
      {
        condition: "Sleep Disorders",
        strength: 0.65,
        nexus:
          "Pain prevents comfortable sleeping positions, disrupting sleep quality.",
      },
      {
        condition: "Erectile Dysfunction",
        strength: 0.55,
        nexus: "Spinal nerve involvement can affect pelvic nerve function.",
      },
    ],
  },
    ...
    secondaries: [
      {
        ...
        strength: 0.9,
        nexus:
          "Chronic hyperglycemia damages small blood vessels supplying peripheral nerves.",
      },
      {
        condition: "Retinopathy",
        strength: 0.85,
        nexus:
          "High blood sugar damages retinal blood vessels, causing vision problems.",
      },
      {
        condition: "Nephropathy",
        strength: 0.8,
        nexus:
          "Diabetes damages kidney filtration units (glomeruli), leading to kidney disease.",
      },
      {
        condition: "Hypertension",
        strength: 0.85,
        nexus:
          "Insulin resistance and vascular changes from diabetes raise blood pressure.",
      },
      {
        condition: "Coronary Artery Disease",
        strength: 0.8,
        nexus:
          "Diabetes accelerates atherosclerosis through inflammation and lipid changes.",
      },
      {
        condition: "Erectile Dysfunction",
        strength: 0.75,
        nexus:
          "Vascular and nerve damage from diabetes impairs erectile function.",
      },
      {
        condition: "Peripheral Vascular Disease",
        strength: 0.75,
        nexus:
          "Poor circulation from diabetes affects extremities, especially feet.",
      },
      {
        condition: "Depression",
        strength: 0.6,
        nexus:
          "Managing chronic disease and complications contributes to depression.",
      },
    ],
  },
  "Sleep Apnea": {
    ...
    secondaries: [
      {
        ...
        strength: 0.85,
        nexus:
          "Repeated oxygen desaturation triggers sympathetic nervous system, raising BP.",
      },
      {
        condition: "Coronary Artery Disease",
        strength: 0.75,
        nexus:
          "Chronic hypoxia and inflammation from apnea accelerate heart disease.",
      },
      {
        condition: "Atrial Fibrillation",
        strength: 0.7,
        nexus:
          "Oxygen fluctuations and cardiac strain trigger irregular heart rhythms.",
      },
      {
        condition: "Stroke",
        strength: 0.7,
        nexus: "Blood pressure surges and reduced oxygen increase stroke risk.",
      },
      {
        condition: "Depression",
        strength: 0.7,
        nexus:
          "Poor sleep quality and chronic fatigue lead to depressive symptoms.",
      },
      {
        condition: "Diabetes Type II",
        strength: 0.65,
        nexus:
          "Sleep deprivation impairs glucose metabolism and insulin sensitivity.",
      },
      {
        condition: "GERD",
        strength: 0.6,
        nexus:
          "Negative intrathoracic pressure from apnea episodes can worsen reflux.",
      },
      {
        condition: "Cognitive Decline",
        strength: 0.65,
        nexus: "Chronic hypoxia and sleep fragmentation affect brain function.",
      },
    ],
  },
  Migraines: {
    ...
    secondaries: [
      {
        ...
        strength: 0.75,
        nexus:
          "Chronic pain and disability from migraines leads to depressive symptoms.",
      },
      {
        condition: "Anxiety",
        strength: 0.7,
        nexus: "Fear of triggering migraines creates anticipatory anxiety.",
      },
      {
        condition: "Insomnia",
        strength: 0.65,
        nexus: "Pain and neurological symptoms disrupt normal sleep patterns.",
      },
      {
        condition: "GERD",
        strength: 0.5,
        nexus: "Migraine medications and stress can worsen acid reflux.",
      },
      {
        condition: "Cervical Strain",
        strength: 0.6,
        nexus:
          "Tension-type migraines often involve neck muscle tension and strain.",
      },
    ],
  },
    ...
    secondaries: [
      {
        ...
        strength: 0.85,
        nexus: "Previous knee injury accelerates cartilage degeneration.",
      },
      {
        condition: "Hip Pain",
        strength: 0.7,
        nexus: "Favoring the injured knee changes gait, stressing the hip.",
      },
      {
        condition: "Lumbar Strain",
        strength: 0.65,
        nexus: "Altered biomechanics from knee injury affect spinal alignment.",
      },
      {
        condition: "Ankle Instability",
        strength: 0.55,
        nexus: "Compensation patterns affect ankle mechanics.",
      },
      {
        condition: "Obesity",
        strength: 0.5,
        nexus: "Reduced mobility leads to weight gain.",
      },
      {
        condition: "Depression",
        strength: 0.6,
        nexus: "Chronic pain and activity limitations cause depression.",
      },
    ],
  },
    ...
    secondaries: [
      {
        ...
        strength: 0.8,
        nexus:
          "TBI and PTSD often co-occur; brain injury affects stress response systems.",
      },
      {
        condition: "Migraines",
        strength: 0.85,
        nexus: "Post-traumatic headaches are common after TBI.",
      },
      {
        condition: "Depression",
        strength: 0.8,
        nexus: "Brain injury affects mood-regulating neurotransmitters.",
      },
      {
        condition: "Cognitive Impairment",
        strength: 0.85,
        nexus:
          "Direct damage to brain tissue affects memory and executive function.",
      },
      {
        condition: "Tinnitus",
        strength: 0.7,
        nexus: "Blast TBI often includes auditory system damage.",
      },
      {
        condition: "Sleep Disorders",
        strength: 0.75,
        nexus: "TBI disrupts normal sleep architecture and circadian rhythms.",
      },
      {
        condition: "Vertigo",
        strength: 0.65,
        nexus:
          "Vestibular system damage from head injury causes balance problems.",
      },
      {
        condition: "Seizures",
        strength: 0.6,
        nexus: "Brain scarring from TBI can create seizure foci.",
      },
    ],
  },
  Hypertension: {
    ...
    secondaries: [
      ...
      },
      {
        ...
        strength: 0.8,
        nexus:
          "Sustained high BP increases risk of both ischemic and hemorrhagic stroke.",
      },
      {
        condition: "Heart Failure",
        strength: 0.75,
        nexus:
          "The heart works harder against high pressure, eventually weakening.",
      },
      {
        condition: "Chronic Kidney Disease",
        strength: 0.75,
        nexus: "High BP damages kidney blood vessels, reducing filtration.",
      },
      {
        condition: "Retinopathy",
        strength: 0.65,
        nexus: "Elevated pressure damages delicate retinal blood vessels.",
      },
      {
        condition: "Erectile Dysfunction",
        strength: 0.6,
        nexus:
          "Vascular damage affects penile blood flow; medications worsen it.",
      },
    ],
  },
  GERD: {
    ...
    secondaries: [
      {
        ...
        strength: 0.85,
        nexus: "Chronic acid exposure inflames and damages esophageal lining.",
      },
      {
        condition: "Barrett's Esophagus",
        strength: 0.7,
        nexus: "Long-term acid exposure causes precancerous cell changes.",
      },
      {
        condition: "Asthma",
        strength: 0.55,
        nexus: "Acid reflux can trigger bronchospasm and worsen asthma.",
      },
      {
        condition: "Chronic Cough",
        strength: 0.65,
        nexus:
          "Acid irritates the throat and airways, causing persistent cough.",
      },
      {
        condition: "Sleep Disorders",
        strength: 0.6,
        nexus: "Nighttime reflux disrupts sleep quality.",
      },
      {
        condition: "Dental Problems",
        strength: 0.5,
        nexus: "Acid erodes tooth enamel over time.",
      },
    ],
  },
  Asthma: {
    ...
    secondaries: [
      {
        condition: "GERD",
        strength: 0.6,
        nexus: "Asthma medications can worsen reflux; reflux triggers asthma.",
      },
      {
        condition: "Sleep Apnea",
        strength: 0.55,
        nexus: "Airway inflammation and nighttime symptoms affect sleep.",
      },
      {
        condition: "Anxiety",
        strength: 0.65,
        nexus: "Fear of attacks and breathing difficulties cause anxiety.",
      },
      {
        condition: "Sinusitis",
        strength: 0.6,
        nexus: "Chronic inflammation affects upper and lower airways together.",
      },
      {
        condition: "Depression",
        strength: 0.5,
        nexus: "Chronic illness management leads to depression.",
      },
    ],
  },
};
...
export default function WebOfConditions({
  ...
  const handleNodeClick = useCallback((node) => {
    setSelectedNode((prevSelected) =>
      node.id === prevSelected ? null : node.id,
    );
  ...
  const handleLinkClick = useCallback((link) => {
    setSelectedLink((prevSelected) =>
      prevSelected?.source === link.source &&
      prevSelected?.target === link.target
        ? null
        : link,
    );
