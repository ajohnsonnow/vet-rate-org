...
const getTypeLabel = (type, isNew, t) => {
...
const ModalHeader = ({ t, version, onClose }) => (
...
const NewFeaturesSection = ({ newFeatures, t }) => {
...
const ExistingFeaturesSection = ({ existingFeatures, hasNewFeatures, t }) => {
  if (existingFeatures.length === 0) return null;
  return (
    <div>
      {hasNewFeatures && (
        <div className="flex items-center gap-2 mb-4">
          ...
          >
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                >
                  {getTypeLabel(item.type, false, t)}
                </span>
              </div>
...
const BugFixesSection = ({ bugFixes, totalBugsSquashed, t }) => {
...
const WhatsNewModal = ({
  ...
  return (
    <ResponsiveModal
      ...
      header={<ModalHeader t={t} version={version} onClose={handleClose} />}
    >
      <div data-whats-new-modal="true">
        <NewFeaturesSection newFeatures={newFeatures} t={t} />

        <ExistingFeaturesSection
        ...
        <BugFixesSection
          bugFixes={bugFixes}
          totalBugsSquashed={totalBugsSquashed}
          t={t}
        />
