...
import { 
  ...
  RefreshCw, Stethoscope, Shield, Target, Award,
  Clock, ArrowRight, Bookmark, Star, AlertTriangle
} from 'lucide-react';
...
const WORKFLOWS = {
  getting_started: {
    ...
    description: 'Start your VA claims journey by uploading your DD214. This auto-fills your service information across all tools and unlocks MOS-specific hazards.',
    ...
    steps: [
      {
        ...
        description: 'Find your DD Form 214 (Certificate of Release or Discharge from Active Duty). Check your files, VA.gov, or ebenefits.',
        tool: null,
        toolName: null,
        critical: true,
      ...
      },
      {
        ...
        description: 'Drop your DD214 PDF into the DD214 Analyzer. It will extract your service dates, MOS, awards, and deployment info.',
        tool: 'dd214-analyzer',
      ...
      },
      {
        ...
        description: 'Check the extracted information for accuracy. The AI reads your DD214 and fills in your veteran profile automatically.',
        tool: 'dd214-analyzer',
        toolName: 'DD214 Analyzer',
      ...
      },
      {
        ...
        description: 'Save the uploaded DD214 to My Packet for easy access. This will be required for most VA claims.',
        tool: 'my-packet',
        toolName: 'My Packet',
      ...
      },
      {
        ...
        description: 'Check the MOS Hazard Matcher to see conditions commonly linked to your military job.',
        tool: 'mos-hazard',
      ...
      },
      {
        ...
        description: 'Create a visual timeline of your deployments, injuries, and key events from your DD214 data.',
  ...
  original_claim: {
    ...
    description: 'Complete workflow for veterans filing their first disability claim for a condition.',
    ...
    steps: [
      {
        ...
        description: 'Lock in your effective date for potential backpay. This is CRITICAL - do it first!',
        tool: 'forms-helper',
      ...
      },
      {
        ...
        description: 'Search the VA rating database to find your diagnoses and understand rating criteria.',
      ...
      },
      {
        ...
        description: 'Use the VA math calculator to estimate your combined rating percentage.',
      ...
      },
      {
        ...
        description: 'Find conditions caused by your primary disability for additional compensation.',
      ...
      },
      {
        ...
        description: 'Gather the "Big 3": Diagnosis, Nexus Letter, and In-Service Event proof.',
        tool: 'my-packet',
        toolName: 'My Packet',
      ...
      },
      {
        ...
        description: 'Create a medical opinion linking your condition to military service.',
        tool: 'nexus-builder',
      ...
      },
      {
        ...
        description: 'Document how your condition affects your daily life in your own words.',
      ...
      },
      {
        ...
        description: 'Collect statements from family, friends, or fellow service members.',
        tool: 'witness-bench',
  ...
  claim_increase: {
    ...
    description: 'When a service-connected condition worsens, you can file for an increased rating.',
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Understand what rating level you currently have and what the next level requires.',
        tool: 'conditions-search',
        toolName: 'Conditions Search',
      ...
      },
      {
        ...
        description: 'Log how your symptoms have increased in frequency or severity.',
        tool: 'symptom-logger',
      ...
      },
      {
        ...
        description: 'See how an increase would affect your overall combined rating.',
        tool: 'tactical-calculator',
        toolName: 'Tactical Calculator',
      ...
      },
      {
        ...
        description: 'Explain how your condition has worsened since last rating.',
        tool: 'statement-analyzer',
        toolName: 'Statement Analyzer',
  ...
  secondary_claim: {
    ...
    description: 'Claim conditions that were caused or aggravated by your service-connected disabilities.',
    ...
    steps: [
      ...
      },
      {
        id: 'discover',
        title: 'Discover Secondary Conditions',
        description: 'Find medically-recognized connections between your rated conditions and new ones.',
        tool: 'secondary-scout',
        toolName: 'Secondary Scout',
      ...
      },
      {
        ...
        description: 'See how adding secondary conditions affects your total rating.',
        tool: 'tactical-calculator',
        toolName: 'Tactical Calculator',
      ...
      },
      {
        ...
        description: 'Gather diagnosis and proof of the connection to your primary condition.',
        tool: 'my-packet',
        toolName: 'My Packet',
      ...
      },
      {
        ...
        description: 'Create a medical opinion showing the secondary relationship.',
        tool: 'nexus-builder',
        toolName: 'Nexus Builder',
        critical: true,
      ...
      },
      {
        ...
        description: 'Explain in your own words how your conditions are related.',
        tool: 'statement-analyzer',
        toolName: 'Statement Analyzer',
  ...
  fighting_denial: {
    ...
    description: 'Complete workflow for challenging a VA denial and winning on appeal.',
    ...
    steps: [
      {
        ...
        description: 'You have exactly 1 YEAR from decision date to appeal. Verify your deadline NOW.',
      ...
      },
      {
        ...
        description: 'Understand exactly WHY you were denied - the specific reasons matter.',
        tool: 'denial-decoder',
      ...
      },
      {
        ...
        description: 'You need NEW and RELEVANT evidence for a Supplemental Claim.',
        tool: 'my-packet',
        toolName: 'My Packet',
        critical: true,
      ...
      },
      {
        ...
        description: 'A stronger medical opinion can overcome the previous denial.',
        tool: 'nexus-builder',
        toolName: 'Nexus Builder',
      ...
      },
      {
        ...
        description: 'Third-party evidence can fill gaps in your original claim.',
        tool: 'witness-bench',
        toolName: 'Witness Bench',
      ...
      },
      {
        id: 'submit',
        title: 'Submit Appeal',
        description: 'File the appropriate appeal form based on your chosen lane.',
        tool: 'forms-helper',
        toolName: 'Forms Helper',
  ...
  cp_exam_prep: {
    ...
    description: 'The C&P exam often determines your rating. Prepare thoroughly to get an accurate assessment.',
    ...
    steps: [
      {
        ...
        description: 'Learn what happens during a C&P exam and what the examiner is looking for.',
        tool: 'cp-simulator',
      ...
      },
      {
        ...
        description: 'Know the exact symptoms and limitations that qualify for each rating level.',
        tool: 'conditions-search',
        toolName: 'Conditions Search',
        critical: true,
      ...
      },
      {
        ...
        description: 'Create a detailed log of your symptoms to reference during the exam.',
        tool: 'symptom-logger',
        toolName: 'Symptom Logger',
      ...
      },
      {
        ...
        description: 'Have a written statement ready in case you forget something.',
        tool: 'statement-analyzer',
        toolName: 'Statement Analyzer',
  ...
  tdiu_claim: {
    ...
    description: 'If your service-connected disabilities prevent you from maintaining gainful employment, you may qualify for TDIU (100% pay without 100% rating).',
    estimatedTime: '2-4 weeks preparation',
    difficulty: 'Advanced',
    steps: [
      {
        ...
        description: 'Verify you meet the rating thresholds: 60% single or 70% combined (with one 40%+).',
        tool: 'tactical-calculator',
        toolName: 'Tactical Calculator',
      ...
      },
      {
        ...
        description: 'Show how disabilities prevent sedentary AND physical work.',
        tool: 'tdiu-builder',
        toolName: 'TDIU Builder',
        critical: true,
      ...
      },
      {
        ...
        description: 'Explain in detail why you cannot work due to your disabilities.',
        tool: 'statement-analyzer',
        toolName: 'Statement Analyzer',
      ...
      },
      {
        ...
        description: 'Medical opinion stating your disabilities prevent employment.',
        tool: 'nexus-builder',
        toolName: 'Nexus Builder',
      ...
      },
      {
        ...
        description: 'Request statements from former employers about why you left.',
        tool: 'witness-bench',
        toolName: 'Witness Bench',
  ...
  pact_act: {
    ...
    description: 'The PACT Act (2022) expanded benefits for toxic exposure. If you served near burn pits, Agent Orange areas, or contaminated bases, you may have presumptive conditions.',
    ...
    steps: [
      {
        ...
        description: 'Verify your service locations and dates qualify under PACT Act.',
        tool: 'pact-navigator',
      ...
      },
      {
        id: 'itf',
        title: 'File Intent to File',
        description: 'Lock in your effective date - especially important for presumptive claims.',
        tool: 'forms-helper',
        toolName: 'Forms Helper',
        form: 'VA Form 21-0966',
        critical: true,
      ...
      },
      {
        ...
        description: 'Find which of your conditions are presumptive under PACT Act.',
        tool: 'conditions-search',
        toolName: 'Conditions Search',
      ...
      },
      {
        ...
        description: 'Gather evidence of your toxic exposure locations and dates.',
  ...
  retro_pay: {
    ...
    description: 'Veterans often have backdated effective dates they don\'t know about. Find out if the VA owes you retroactive pay.',
    ...
    steps: [
      ...
      },
      {
        ...
        description: 'Look for CUE errors in past decisions that can be challenged.',
        tool: 'denial-decoder',
        toolName: 'Denial Decoder',
      ...
      },
      {
        ...
        description: 'Collect documents showing earlier effective date should apply.',
        tool: 'my-packet',
        toolName: 'My Packet',
...
export default function WorkflowGuide({ onClose, onToolSelect }) {
  ...
  const getWorkflowCompletion = (workflowId) => {
    ...
    const completed = workflow.steps.filter(step => workflowProgress[step.id]).length;
  ...
  const WorkflowDetail = ({ workflowId }) => {
    ...
    return (
      <div className="space-y-6">
        {/* Header */}
        <div className={`p-6 rounded-xl bg-gradient-to-br ${workflow.bgGradient} border-2 ${workflow.borderColor}`}>
          <button 
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-white mb-1">{workflow.title}</h2>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2 mb-1">
                      <h4 className={`font-bold ${isComplete ? 'text-green-700 dark:text-green-300 line-through' : 'text-gray-900 dark:text-white'}`}>
                        {step.critical && !isComplete && <span className="text-red-500 mr-1">⚠️</span>}
                        {step.title}
                      </h4>
                      {step.form && (
            ...
            <>
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  Select a workflow to see step-by-step guidance through the VA claims process.
                  Each step links directly to the right tool.
                </p>
              </div>
              <WorkflowGrid />
            </>
