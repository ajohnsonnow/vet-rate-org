...
const BRANDS = {
  vetrate: {
    ...
    description: 'Helping veterans navigate the VA claims process - 100% free, forever.',
  ...
  supplylocker: {
    ...
    description: 'Your personal supply locker for VA claims - powered by the same tech as VetRate.',
