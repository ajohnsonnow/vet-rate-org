/**
 * SupplyLocker.org - Language Context
...
const LANGUAGE_STORAGE_KEY = 'supplylocker_language';
...
export const APP_TRANSLATIONS = {
  ...
  splash: {
    ...
    enterVetRate: { en: 'Enter SupplyLocker.org', es: 'Entrar a SupplyLocker.org', tl: 'Pumasok sa SupplyLocker.org', vi: 'Vào SupplyLocker.org', ko: 'SupplyLocker.org 입장' },
  ...
  // Header & Navigation
  header: {
    title: { en: 'SupplyLocker.org', es: 'SupplyLocker.org', tl: 'SupplyLocker.org', vi: 'SupplyLocker.org', ko: 'SupplyLocker.org' },
    subtitle: { 
    ...
    supportTooltip: { en: 'Support SupplyLocker.org - Help keep this free for veterans', es: 'Apoya SupplyLocker.org - Ayuda a mantener esto gratis para veteranos', tl: 'Suportahan ang SupplyLocker.org - Tulungang panatilihing libre ito para sa mga beterano', vi: 'Hỗ trợ SupplyLocker.org - Giúp giữ miễn phí cho cựu chiến binh', ko: 'SupplyLocker.org 지원 - 재향군인에게 무료로 유지하도록 도와주세요' },
...
I'm your AI guide for SupplyLocker.org and the VA claims process. I can help you:
...
Soy tu guía de IA para SupplyLocker.org y el proceso de reclamos del VA. Puedo ayudarte a:
...
Ako ang iyong AI guide para sa SupplyLocker.org at sa proseso ng VA claims. Makakatulong ako sa:
...
Tôi là hướng dẫn AI của bạn cho SupplyLocker.org và quy trình yêu cầu VA. Tôi có thể giúp bạn:
...
저는 SupplyLocker.org와 VA 청구 절차를 위한 AI 가이드입니다. 다음을 도와드릴 수 있습니다:
...
**무엇이든 물어보세요!** VA 규정(38 CFR)을 사용하여 정확한 답변을 드립니다.`
    ...
    // Placeholders
    placeholder: { en: 'Ask me anything about VA claims, regulations, or how to use SupplyLocker tools...', es: 'Pregúntame cualquier cosa sobre reclamos VA, regulaciones o cómo usar las herramientas de SupplyLocker...', tl: 'Itanong mo sa akin ang kahit ano tungkol sa VA claims, regulations, o paano gamitin ang mga SupplyLocker tools...', vi: 'Hỏi tôi bất cứ điều gì về yêu cầu VA, quy định, hoặc cách sử dụng công cụ SupplyLocker...', ko: 'VA 청구, 규정 또는 SupplyLocker 도구 사용 방법에 대해 무엇이든 물어보세요...' },
  ...
  // About Us
  about: {
    aboutVetRate: { en: 'About SupplyLocker.org', es: 'Acerca de SupplyLocker.org', tl: 'Tungkol sa SupplyLocker.org', vi: 'Về SupplyLocker.org', ko: 'SupplyLocker.org 소개' },
    ...
    theVetRatePromise: { en: 'The SupplyLocker Promise', es: 'La Promesa de SupplyLocker', tl: 'Ang Pangako ng SupplyLocker', vi: 'Lời Hứa SupplyLocker', ko: 'SupplyLocker 약속' },
    promiseIntro: { en: 'I am Anthony Johnson, an instructor and developer based in Portland, OR. I built SupplyLocker because I believe you shouldn\'t need a law degree - or pay thousands to a "claim shark" - to get the benefits you earned.', es: 'Soy Anthony Johnson, instructor y desarrollador en Portland, OR. Construí SupplyLocker porque creo que no deberías necesitar un título de abogado, ni pagar miles a un "tiburón de reclamaciones" para obtener los beneficios que ganaste.', tl: 'Ako si Anthony Johnson, isang instructor at developer sa Portland, OR. Ginawa ko ang SupplyLocker dahil naniniwala ako na hindi mo kailangan ng law degree - o magbayad ng libo-libo sa "claim shark" - para makuha ang mga benepisyo na kinita mo.', vi: 'Tôi là Anthony Johnson, giảng viên và nhà phát triển tại Portland, OR. Tôi xây dựng SupplyLocker vì tôi tin rằng bạn không cần bằng luật - hay trả hàng nghìn đô cho "cá mập yêu cầu" - để nhận được quyền lợi bạn đã kiếm được.', ko: '저는 포틀랜드, OR에 있는 강사이자 개발자 Anthony Johnson입니다. 당신이 얻은 혜택을 받기 위해 법학 학위가 필요하거나 "청구 상어"에게 수천 달러를 지불할 필요가 없다고 믿기 때문에 SupplyLocker를 만들었습니다.' },
    ...
    whoIAmDesc1: { en: 'SupplyLocker.org is an independent educational resource created by a fellow service-disabled veteran passionate about helping other veterans navigate the VA disability system. This is not an official VA website, law firm, or medical service. I am simply providing a tool that makes publicly available information easier to access and understand.', es: 'SupplyLocker.org es un recurso educativo independiente creado por un compañero veterano discapacitado apasionado por ayudar a otros veteranos a navegar el sistema de discapacidad del VA. Este no es un sitio web oficial del VA, bufete de abogados o servicio médico.', tl: 'Ang SupplyLocker.org ay isang independiyenteng educational resource na ginawa ng isang kapwa service-disabled veteran na masigasig sa pagtulong sa ibang mga beterano na i-navigate ang VA disability system. Hindi ito opisyal na VA website, law firm, o medical service.', vi: 'SupplyLocker.org là nguồn tài liệu giáo dục độc lập được tạo bởi một cựu chiến binh khuyết tật đam mê giúp đỡ các cựu chiến binh khác điều hướng hệ thống khuyết tật VA. Đây không phải là trang web VA chính thức, công ty luật hoặc dịch vụ y tế.', ko: 'SupplyLocker.org는 다른 재향군인들이 VA 장애 시스템을 탐색하도록 돕는 것에 열정적인 동료 서비스 장애 재향군인이 만든 독립적인 교육 자원입니다. 이것은 공식 VA 웹사이트, 법률 회사 또는 의료 서비스가 아닙니다.' },
    ...
    midnightDescription: { en: 'The tireless machine that brought SupplyLocker.org to life. Running countless builds, tests, and deployments without complaint (mostly).', es: 'La máquina incansable que dio vida a SupplyLocker.org. Ejecutando innumerables compilaciones, pruebas y despliegues sin quejas (mayormente).', tl: 'Ang walang pagod na machine na nagbigay buhay sa SupplyLocker.org. Nagpapatakbo ng walang bilang na builds, tests, at deployments nang walang reklamo (halos).', vi: 'Cỗ máy không mệt mỏi đã mang SupplyLocker.org đến cuộc sống. Chạy vô số bản dựng, kiểm tra và triển khai mà không phàn nàn (hầu hết).', ko: 'SupplyLocker.org를 생명으로 가져온 지칠 줄 모르는 기계. 불평 없이 (대부분) 수많은 빌드, 테스트 및 배포를 실행합니다.' },
    ...
    codebaseDescription: { en: 'A labor of love, countless hours, and a whole lot of caffeine. Here\'s what powers SupplyLocker.org under the hood.', es: 'Un trabajo de amor, incontables horas, y mucha cafeína. Esto es lo que impulsa SupplyLocker.org bajo el capó.', tl: 'Isang labor of love, walang bilang na oras, at maraming caffeine. Ito ang nagpapatakbo sa SupplyLocker.org sa ilalim ng hood.', vi: 'Một công việc của tình yêu, vô số giờ, và rất nhiều caffeine. Đây là những gì cung cấp năng lượng cho SupplyLocker.org bên trong.', ko: '사랑의 노동, 셀 수 없는 시간, 그리고 많은 카페인. SupplyLocker.org를 내부에서 구동하는 것입니다.' },
    ...
    howBuiltIntro: { en: 'SupplyLocker.org was developed using modern tools and AI-assisted development:', es: 'SupplyLocker.org fue desarrollado usando herramientas modernas y desarrollo asistido por IA:', tl: 'Ang SupplyLocker.org ay ginawa gamit ang mga modernong tools at AI-assisted development:', vi: 'SupplyLocker.org được phát triển bằng các công cụ hiện đại và phát triển hỗ trợ AI:', ko: 'SupplyLocker.org는 현대적인 도구와 AI 지원 개발을 사용하여 개발되었습니다:' },
    ...
    notAffiliatedWithVADesc: { en: 'SupplyLocker.org is an independent resource and is not endorsed by, affiliated with, or approved by the U.S. Department of Veterans Affairs.', es: 'SupplyLocker.org es un recurso independiente y no está respaldado, afiliado ni aprobado por el Departamento de Asuntos de Veteranos de EE.UU.', tl: 'Ang SupplyLocker.org ay isang independiyenteng resource at hindi endorsed, affiliated, o approved ng U.S. Department of Veterans Affairs.', vi: 'SupplyLocker.org là nguồn tài liệu độc lập và không được xác nhận, liên kết hoặc phê duyệt bởi Bộ Cựu Chiến Binh Hoa Kỳ.', ko: 'SupplyLocker.org는 독립적인 자원이며 미국 재향군인부에서 승인, 제휴 또는 보증하지 않습니다.' },
    ...
    allContributionsGo: { en: '100% of contributions go toward hosting, development, and keeping SupplyLocker.org running for the veteran community.', es: 'El 100% de las contribuciones van hacia hosting, desarrollo y mantener SupplyLocker.org funcionando para la comunidad de veteranos.', tl: '100% ng mga kontribusyon ay napupunta sa hosting, development, at pagpapanatili ng SupplyLocker.org na tumatakbo para sa veteran community.', vi: '100% đóng góp dành cho lưu trữ, phát triển và duy trì SupplyLocker.org hoạt động cho cộng đồng cựu chiến binh.', ko: '기부금의 100%는 호스팅, 개발 및 재향군인 커뮤니티를 위해 SupplyLocker.org를 운영하는 데 사용됩니다.' },
    ...
    zonkThanks: { en: 'Just kidding, thanks for using SupplyLocker!', es: '¡Es broma, gracias por usar SupplyLocker!', tl: 'Joke lang, salamat sa paggamit ng SupplyLocker!', vi: 'Chỉ đùa thôi, cảm ơn bạn đã sử dụng SupplyLocker!', ko: '농담이에요, SupplyLocker를 사용해 주셔서 감사합니다!' },
  },
  ...
  bootCampTour: {
    ...
    // Welcome step
    welcomeTitle: { en: '🎖️ Welcome to SupplyLocker.org', es: '🎖️ Bienvenido a SupplyLocker.org', tl: '🎖️ Maligayang Pagdating sa SupplyLocker.org', vi: '🎖️ Chào Mừng Đến Với SupplyLocker.org', ko: '🎖️ SupplyLocker.org에 오신 것을 환영합니다' },
  ...
  // What's New Modal
  whatsNew: {
    title: { en: "What's New in SupplyLocker.org", es: 'Novedades en SupplyLocker.org', tl: "Ano'ng Bago sa SupplyLocker.org", vi: 'Có Gì Mới Tại SupplyLocker.org', ko: 'SupplyLocker.org의 새로운 기능' },
    version: { en: 'Version', es: 'Versión', tl: 'Bersyon', vi: 'Phiên Bản', ko: '버전' },
  ...
  featureRequest: {
    ...
    subtitle: { en: 'Share your ideas to make SupplyLocker.org better', es: 'Comparte tus ideas para mejorar SupplyLocker.org', tl: 'Ibahagi ang iyong mga ideya para mapabuti ang SupplyLocker.org', vi: 'Chia sẻ ý tưởng của bạn để cải thiện SupplyLocker.org', ko: 'SupplyLocker.org를 더 좋게 만들 아이디어를 공유하세요' },
    ...
    ideasMatterText: { en: 'Every feature on SupplyLocker.org came from veteran feedback. Share your idea and help me build tools that make a difference.', es: 'Cada función en SupplyLocker.org provino de comentarios de veteranos. Comparte tu idea y ayúdame a construir herramientas que marquen la diferencia.', tl: 'Ang bawat feature sa SupplyLocker.org ay galing sa feedback ng mga beterano. Ibahagi ang iyong ideya at tulungan akong gumawa ng mga tool na may pagkakaiba.', vi: 'Mọi tính năng trên SupplyLocker.org đều đến từ phản hồi của cựu chiến binh. Chia sẻ ý tưởng của bạn và giúp tôi xây dựng công cụ tạo nên sự khác biệt.', ko: 'SupplyLocker.org의 모든 기능은 재향군인 피드백에서 비롯되었습니다. 아이디어를 공유하고 차이를 만드는 도구를 만드는 데 도움을 주세요.' },
    ...
    thankYouMessage: { en: 'Thank you for helping make SupplyLocker.org better for all veterans!', es: '¡Gracias por ayudar a mejorar SupplyLocker.org para todos los veteranos!', tl: 'Salamat sa pagtulong na mapabuti ang SupplyLocker.org para sa lahat ng beterano!', vi: 'Cảm ơn bạn đã giúp SupplyLocker.org tốt hơn cho tất cả cựu chiến binh!', ko: 'SupplyLocker.org를 모든 재향군인을 위해 더 좋게 만드는 데 도움을 주셔서 감사합니다!' },
  },
  ...
  contactUs: {
    ...
    faq1Answer: { en: 'No, SupplyLocker.org is an independent educational tool created by a service-connected disabled veteran. This site is not affiliated with the U.S. Department of Veterans Affairs.', es: 'No, SupplyLocker.org es una herramienta educativa independiente creada por un veterano discapacitado conectado al servicio. Este sitio no está afiliado con el Departamento de Asuntos de Veteranos de EE.UU.', tl: 'Hindi, ang SupplyLocker.org ay isang independyenteng educational tool na nilikha ng isang service-connected disabled veteran. Ang site na ito ay hindi kaanib ng U.S. Department of Veterans Affairs.', vi: 'Không, SupplyLocker.org là một công cụ giáo dục độc lập được tạo bởi một cựu chiến binh khuyết tật liên quan đến dịch vụ. Trang web này không liên kết với Bộ Cựu chiến binh Hoa Kỳ.', ko: '아니요, SupplyLocker.org는 복무 관련 장애 재향군인이 만든 독립적인 교육 도구입니다. 이 사이트는 미국 재향군인부와 관련이 없습니다.' },
  ...
  privacyPolicy: {
    ...
    section1Text: { 
      en: "Welcome to SupplyLocker.org. I'm a service-connected disabled veteran who built this site to help fellow veterans navigate the VA disability rating process. This Privacy Policy explains how information is handled when you visit this website. By using this site, you agree to the practices described in this policy.",
      es: 'Bienvenido a SupplyLocker.org. Soy un veterano discapacitado conectado al servicio que construyó este sitio para ayudar a otros veteranos a navegar el proceso de calificación de discapacidad del VA. Esta Política de Privacidad explica cómo se maneja la información cuando visitas este sitio web. Al usar este sitio, aceptas las prácticas descritas en esta política.',
      tl: 'Maligayang pagdating sa SupplyLocker.org. Ako ay isang service-connected disabled veteran na gumawa ng site na ito para tulungan ang mga kapwa beterano na mag-navigate sa VA disability rating process. Ang Privacy Policy na ito ay nagpapaliwanag kung paano hinahandle ang impormasyon kapag binisita mo ang website na ito. Sa paggamit ng site na ito, sumasang-ayon ka sa mga kasanayan na inilarawan sa patakaran na ito.',
      vi: 'Chào mừng đến với SupplyLocker.org. Tôi là một cựu chiến binh khuyết tật liên quan đến dịch vụ đã xây dựng trang web này để giúp đồng đội cựu chiến binh điều hướng quy trình đánh giá khuyết tật VA. Chính sách Quyền riêng tư này giải thích cách thông tin được xử lý khi bạn truy cập trang web này. Bằng cách sử dụng trang web này, bạn đồng ý với các thực hành được mô tả trong chính sách này.',
      ko: 'SupplyLocker.org에 오신 것을 환영합니다. 저는 동료 재향군인들이 VA 장애 등급 절차를 탐색할 수 있도록 이 사이트를 구축한 복무 관련 장애 재향군인입니다. 이 개인정보 처리방침은 이 웹사이트를 방문할 때 정보가 어떻게 처리되는지 설명합니다. 이 사이트를 사용함으로써 이 정책에 설명된 관행에 동의하는 것입니다.'
    },
    ...
    section7AIItem2: { en: 'SupplyLocker.org does not store this data on our servers', es: 'SupplyLocker.org no almacena estos datos en nuestros servidores', tl: 'Ang SupplyLocker.org ay hindi nag-store ng data na ito sa servers namin', vi: 'SupplyLocker.org không lưu trữ dữ liệu này trên máy chủ của chúng tôi', ko: 'SupplyLocker.org는 이 데이터를 서버에 저장하지 않습니다' },
    ...
    privacyFirstText: { en: 'SupplyLocker.org is built with veteran privacy as a top priority. This site does not collect, store, or transmit your personal information. We use only GoatCounter for minimal, cookie-free analytics. No advertising networks or invasive trackers are used. Your searches and disability research remain completely private.', es: 'SupplyLocker.org está construido con la privacidad del veterano como máxima prioridad. Este sitio no recopila, almacena ni transmite tu información personal. Solo usamos GoatCounter para análisis mínimos sin cookies. No se usan redes publicitarias ni rastreadores invasivos. Tus búsquedas e investigación sobre discapacidad permanecen completamente privadas.', tl: 'Ang SupplyLocker.org ay binuo na ang veteran privacy ang top priority. Ang site na ito ay hindi nangongolekta, nag-store, o nag-transmit ng personal information mo. Gumagamit lang kami ng GoatCounter para sa minimal, cookie-free analytics. Walang advertising networks o invasive trackers na ginagamit. Ang searches mo at disability research ay nananatiling completely private.', vi: 'SupplyLocker.org được xây dựng với quyền riêng tư của cựu chiến binh là ưu tiên hàng đầu. Trang web này không thu thập, lưu trữ hoặc truyền thông tin cá nhân của bạn. Chúng tôi chỉ sử dụng GoatCounter cho phân tích tối thiểu, không có cookie. Không sử dụng mạng quảng cáo hoặc trình theo dõi xâm phạm. Các tìm kiếm và nghiên cứu về khuyết tật của bạn vẫn hoàn toàn riêng tư.', ko: 'SupplyLocker.org는 재향군인의 개인정보 보호를 최우선으로 하여 구축되었습니다. 이 사이트는 개인 정보를 수집, 저장 또는 전송하지 않습니다. 최소한의 쿠키 없는 분석을 위해 GoatCounter만 사용합니다. 광고 네트워크나 침해적인 추적기는 사용되지 않습니다. 귀하의 검색 및 장애 연구는 완전히 비공개로 유지됩니다.' },
  },
};
