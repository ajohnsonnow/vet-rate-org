...
export const ARMY_BADGES = [
  ...
  // Worn above ribbons, max 3 badges
  {
    ...
    branch: ["Army"],
    description:
      "Awarded to Infantry soldiers who have engaged in active ground combat",
  ...
  },
  {
    ...
    branch: ["Army"],
    description:
      "Awarded to soldiers who personally engaged or are engaged by the enemy",
    combatIndicator: true,
  ...
  },
  {
    ...
    branch: ["Army"],
    description:
      "Awarded to medical personnel who provide medical care under fire",
    combatIndicator: true,
  ...
  },
  {
    ...
    branch: ["Army"],
    description:
      "Awarded to Infantry soldiers who demonstrate expert proficiency",
  ...
  },
  {
    ...
    branch: ["Army"],
    description:
      "Awarded to medical personnel who demonstrate expert proficiency",
  ...
  },
  {
    ...
    branch: ["Army"],
    description:
      "Awarded to soldiers who demonstrate expert proficiency in warrior tasks",
  ...
  // === DIVING AND SPECIAL OPERATIONS ===
  {
    ...
    branch: ["Army"],
    description:
      "Awarded upon completion of Special Forces Qualification Course",
