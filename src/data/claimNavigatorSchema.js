...
export const EVIDENCE_ITEMS = {
  ...
  personalStatement: {
    ...
    recommended: true,
    description:
      "Your detailed account of symptoms and how they affect daily life",
  ...
  buddyLetters: {
    ...
    examples: [
      "VA Form 21-10210",
      "Spouse statement",
      "Fellow service member statement",
    ],
    weight: "medium",
...
export const TRIAGE_QUESTIONS = [
  {
    ...
    options: [
      ...
      {
        value: "yes_rated",
        label: "Yes, I have a current rating for it",
        next: "condition_worse",
      },
      {
        value: "yes_denied",
        label: "Yes, but it was denied",
        next: "denial_timing",
      },
    ],
  },
  {
    ...
    options: [
      {
        value: "yes",
        label: "Yes, my symptoms have worsened",
        next: "INCREASE",
      },
      {
        value: "no",
        label: "No, but I have a new related condition",
        next: "caused_by_rated",
      },
    ],
  },
  {
    id: "caused_by_rated",
    question:
      "Is this new condition caused or aggravated by a condition you're already rated for?",
    options: [
      {
        value: "yes",
        label: "Yes, it's related to my rated condition",
        next: "SECONDARY",
      },
      {
        value: "no",
        label: "No, it's a separate issue from service",
        next: "ORIGINAL",
      },
    ],
  },
  ...
  },
  {
    ...
    options: [
      {
        value: "yes",
        label: "Yes, I have new evidence (new doctor notes, nexus, etc.)",
        next: "SUPPLEMENTAL",
      },
      {
        value: "no_error",
        label: "No, but the VA made an error reviewing my case",
        next: "HLR",
      },
      {
        value: "want_judge",
        label: "I want a judge to review my case",
        next: "BOARD_APPEAL",
      },
    ],
  },
