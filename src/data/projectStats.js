...
export const PROJECT_STATS = {
  ...
  totalFiles:
    dynamicStats.live?.totalFiles ||
    parseNumeric(dynamicStats.total_files) ||
    1127,
  linesOfCode:
    dynamicStats.live?.linesOfCode ||
    parseNumeric(dynamicStats.loc_count) ||
    138219,
  appSizeMB: dynamicStats.live?.appSizeMB || 104.05,
  components:
    dynamicStats.live?.componentCount ||
    parseNumeric(dynamicStats.component_count) ||
    115,
  majorTools:
  ...
  utilities:
    ...
    parseNumeric(dynamicStats.utility_count) ||
    49,
  disabilitiesValidated:
    dynamicStats.live?.disabilityCount ||
    parseNumeric(dynamicStats.validation_count) ||
    748,

  // Content Counts (from live calculation)
  vaForms:
    dynamicStats.live?.vaFormsCount ||
    parseNumeric(dynamicStats.forms_supported) ||
    16,
  secondaryConditions:
    dynamicStats.live?.secondaryCount ||
    parseNumeric(dynamicStats.secondary_conditions) ||
    500,
  ...
  localAIModels:
    dynamicStats.live?.localAIModels ||
    parseNumeric(dynamicStats.local_ai_models) ||
    3,
  ...
  breakdown: dynamicStats.breakdown
    ...
    : {
        ...
        testing: Math.round(
          (parseNumeric(dynamicStats.coding_hours) || 13147) * 0.15,
        ),
        uiux: 400,
        documentation: 200,
  ...
  componentHoursTotal:
    parseNumeric(dynamicStats.component_hours_total) || 11380,
