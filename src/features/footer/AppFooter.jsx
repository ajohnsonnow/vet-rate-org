        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">
              ...
              {getTotalToolCount()} professional-grade tools covering research,
              calculators, AI analysis, C&P prep, evidence builders, and
              strategic planning. What claim sharks charge thousands for,
              absolutely free.
            </p>
            <button
              onClick={() =>
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mb-3">
              ...
              legal or medical advice. Consult with VA officials or qualified
