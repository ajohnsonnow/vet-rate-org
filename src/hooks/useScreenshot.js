 ...
 * @param {string} options.watermarkText - Text for watermark (default: "Generated by SupplyLocker.org")
...
export const useScreenshot = (options = {}) => {
  const {
    watermarkText = 'Generated by SupplyLocker.org • Privacy Protected',
   ...
   */
  const downloadScreenshot = useCallback(async (target, filename = 'supplylocker-screenshot.png') => {
    try {
