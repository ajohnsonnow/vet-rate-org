...
export const BDD_MILESTONES = [
  {
    ...
    description:
      "Request your complete medical records from MHS Genesis / military treatment facilities. You need ALL records - dental, mental health, everything.",
    icon: "📋",
  ...
  },
  {
    ...
    description:
      "Use Vet-Rate tools to identify every condition you should claim. Many veterans only claim their obvious injuries and miss secondary conditions worth thousands.",
    icon: "🔍",
    category: "preparation",
    details: [
  ...
  },
  {
    ...
    description:
      "Protect your effective date immediately. This gives you one year to submit the full claim while locking in your backpay date.",
    icon: "📅",
    category: "filing",
    details: [
  ...
  },
  {
    ...
    description:
      "You can now submit your full BDD claim (VA Form 21-526EZ). File as early as possible to give VA time to schedule C&P exams before discharge.",
    icon: "🚀",
    category: "filing",
    details: [
  ...
  },
  {
    ...
    description:
      "Submit buddy statements, personal statements, and any private medical records that support your claims.",
    icon: "📎",
    category: "evidence",
    details: [
  ...
  },
  {
    ...
    description:
      "VA will schedule your Compensation & Pension exams while you're still on active duty. This is the major advantage of BDD - exams happen before discharge.",
    icon: "🏥",
    category: "exams",
    details: [
  ...
  },
  {
    ...
    description:
      "Attend ALL scheduled exams. Missing an exam can result in automatic denial. Be honest about your worst symptoms - your career is ending, not beginning.",
    icon: "✅",
    category: "exams",
    details: [
  ...
  },
  {
    ...
    description:
      "Last day to file under BDD. After this, claims go through the standard process which takes much longer (4-6+ months vs. same-day rating).",
    icon: "⚠️",
    category: "filing",
    critical: true,
    details: [
  ...
  },
  {
    ...
    description:
      "Attend your Transition Assistance Program class. While mandatory, supplement with Vet-Rate tools for much more comprehensive claims preparation.",
    icon: "🎓",
    category: "transition",
    details: [
  ...
  },
  {
    ...
    description:
      "Report EVERYTHING at your separation physical. Any condition not documented here becomes harder to claim later.",
    icon: "🩺",
    category: "transition",
    details: [
  ...
  },
  {
    ...
    description:
      "You did it. Your BDD claim should be decided on or very close to your separation date. Benefits begin the day after discharge.",
    icon: "🎖️",
    category: "transition",
    details: [
  ...
  },
  {
    ...
    description:
      "Review your rating decision. If any condition was underrated or denied, you have options to appeal.",
    icon: "📊",
    category: "post",
    details: [
...
export const BDD_CHECKLIST = [
  ...
  },
  {
    ...
    required: true,
    helpText:
      "Includes Active Duty, ADOS, or National Guard/Reserve on federal orders (Title 10)",
  },
  {
    id: "within-window",
  ...
  },
  {
    ...
    required: true,
    helpText:
      "You must provide your service treatment records with your BDD claim",
  },
  {
  ...
  },
  {
    ...
    required: true,
    helpText:
      "Use Secondary Scout and MOS Hazard Matcher to find all conditions",
  },
  {
    id: "itf-filed",
    ...
    required: false,
    helpText:
      "Protects your effective date - highly recommended before BDD claim",
  },
  {
  ...
  },
  {
    ...
    required: true,
    helpText:
      "This is your last chance to document conditions in military records",
  },
];
...
export const BDD_COMMON_MISTAKES = [
  {
    ...
    description:
      "Many service members don't know about BDD until it's too late. If you're past 90 days, you can still file a standard claim, but rating decisions come after separation.",
    impact: "HIGH",
  ...
  },
  {
    ...
    description:
      'Veterans often only claim their "big" injuries and miss secondary conditions, mental health, and seemingly minor issues worth significant ratings.',
    impact: "HIGH",
  ...
  },
  {
    ...
    description:
      "Active duty military culture teaches you to be tough. At a C&P exam, report your WORST days - this isn't a fitness report.",
    impact: "HIGH",
  ...
  },
  {
    ...
    description:
      "If you miss a C&P exam without rescheduling, that condition will likely be denied. No exam = no rating.",
    impact: "CRITICAL",
  ...
  },
  {
    ...
    description:
      "The 21-526EZ form doesn't tell the rater your story. Personal statements explain how your conditions affect your daily life.",
    impact: "MEDIUM",
  ...
  },
  {
    ...
    description:
      "Fellow service members can corroborate your conditions, injuries, and how they've worsened. This is powerful evidence.",
    impact: "MEDIUM",
  ...
  },
  {
    ...
    description:
      "Your separation physical is the last military medical document. Any condition not listed here becomes harder to prove was service-connected.",
    impact: "HIGH",
  ...
  },
  {
    ...
    description:
      'The longer you wait, the harder service connection becomes. A gap between service and filing creates a "continuity" problem.',
    impact: "HIGH",
...
export function calculateBDDEligibility(separationDate) {
  if (!separationDate)
    return { eligible: false, reason: "No separation date provided" };
  ...
  if (
    daysUntilSep >= BDD_RULES.windowEnd &&
    daysUntilSep <= BDD_RULES.windowStart
  ) {
    return {
      eligible: true,
      daysUntilSep,
  ...
  return {
    ...
    daysUntilSep,
    reason:
      "BDD window has closed. File a standard claim (pre-discharge) immediately.",
