...
export const BUTTON_COLORS = {
  primary: {
    ...
    highContrast: 'bg-emerald-700 hover:bg-emerald-800 text-white border-2 border-emerald-900',
  },
  secondary: {
    light: 'bg-gray-200 hover:bg-gray-300 text-gray-800',
    dark: 'bg-gray-700 hover:bg-gray-600 text-gray-200',
    protanopia: 'bg-gray-200 hover:bg-gray-300 text-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200',
    deuteranopia: 'bg-gray-200 hover:bg-gray-300 text-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200',
    tritanopia: 'bg-gray-200 hover:bg-gray-300 text-gray-800 dark:bg-gray-700 dark:hover:bg-gray-600 dark:text-gray-200',
    highContrast: 'bg-gray-300 hover:bg-gray-400 text-black dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-white border-2 border-gray-900 dark:border-white',
  },
  danger: {
    ...
    highContrast: 'bg-red-700 hover:bg-red-800 text-white border-2 border-red-900',
  },
};
 ...
 */
export function getColorClass(colorObj, theme = 'dark', colorBlindMode = 'none') {
 ...
 */
export function getHeaderGradient(gradientType, theme = 'dark', colorBlindMode = 'none') {
