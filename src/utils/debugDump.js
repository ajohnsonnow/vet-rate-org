  ...
  try {
    const debugData = {
      ...
      versionInfo: {
        ...
        storedSchemaVersion: localStorage.getItem('vet_rate_data_schema_version'),
 ...
 */
export const createClickCounter = (requiredClicks, onActivate, timeWindow = 2000) => {
  let clicks = [];
...
export const createDebugDumpHandler = () => {
  return createClickCounter(7, () => {
    console.log('🐛 DEBUG MODE ACTIVATED - Downloading full diagnostic dump...');
  ...
  }, 2000); // 2 second window for 7 clicks
};
