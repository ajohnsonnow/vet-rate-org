...
export const MASTER_AWARDS = ribbonManifest?.awards?.length > 0 
  ...
  },
  {
    ...
    precedence: { Army: 2 },
    category: 'valor',
    ribbonColor: 'bg-gradient-to-r from-blue-600 via-white via-red-600 to-blue-600',
  },
  {
    id: 'navy_cross',
    name: 'Navy Cross',
  ...
  },
  {
    ...
    category: 'valor',
    ribbonColor: 'bg-gradient-to-r from-blue-600 via-red-600 via-white via-red-600 to-blue-600',
  },
  {
    id: 'legion_of_merit',
  ...
  },
  {
    ...
    category: 'valor',
    ribbonColor: 'bg-gradient-to-r from-blue-500 via-white via-red-500 to-blue-500',
  },
  {
    id: 'bronze_star',
    ...
    category: 'valor',
    ribbonColor: 'bg-gradient-to-r from-red-600 via-white via-blue-600 via-white to-red-600',
  },
  {
    id: 'purple_heart',
    name: 'Purple Heart',
    ...
    category: 'valor',
    ribbonColor: 'bg-gradient-to-r from-purple-700 via-white to-purple-700',
  },
  {
  ...
  },
  {
    ...
    category: 'valor',
    ribbonColor: 'bg-gradient-to-r from-blue-500 via-orange-400 to-blue-500',
  },
  {
  ...
  },
  {
    ...
    category: 'service',
    ribbonColor: 'bg-gradient-to-r from-blue-500 via-yellow-400 to-blue-500',
  },
  {
  ...
  },
  {
    ...
    category: 'service',
    ribbonColor: 'bg-gradient-to-r from-green-500 via-orange-400 to-green-500',
  },
  {
    ...
    category: 'service',
    ribbonColor: 'bg-gradient-to-r from-blue-400 via-yellow-300 to-blue-400',
  },
  {
    ...
    category: 'service',
    ribbonColor: 'bg-gradient-to-r from-blue-600 via-yellow-400 via-red-500 to-blue-600',
  },
  {
    ...
    precedence: { Army: 31 },
    category: 'service',
    ribbonColor: 'bg-gradient-to-r from-red-600 via-white via-blue-600 to-red-600',
  },
  {
  ...
  },
  {
    ...
    category: 'service',
    ribbonColor: 'bg-gradient-to-r from-red-600 via-yellow-400 to-red-600',
  },
  {
    ...
    category: 'campaign',
    ribbonColor: 'bg-gradient-to-r from-green-700 via-yellow-500 to-red-600',
  },
  {
    ...
    category: 'campaign',
    ribbonColor: 'bg-gradient-to-r from-red-600 via-yellow-400 to-green-600',
  },
  {
    ...
    category: 'campaign',
    ribbonColor: 'bg-gradient-to-r from-red-600 via-yellow-400 via-blue-600 to-red-600',
  },
  {
    ...
    category: 'campaign',
    ribbonColor: 'bg-gradient-to-r from-red-500 via-white via-blue-500 to-red-500',
  },
  {
  ...
  },
  {
    ...
    category: 'service',
    ribbonColor: 'bg-gradient-to-r from-blue-600 via-yellow-300 to-blue-600',
  },
  {
    ...
    category: 'service',
    ribbonColor: 'bg-gradient-to-r from-purple-600 via-white to-purple-600',
  },
  {
    ...
    category: 'service',
    ribbonColor: 'bg-gradient-to-r from-yellow-400 via-blue-600 to-yellow-400',
  },
  {
    ...
    precedence: { Army: 57 },
    category: 'service',
    ribbonColor: 'bg-gradient-to-r from-green-600 via-yellow-400 to-green-600',
  },
  {
...
export const DEVICES = {
  bronze_star: { name: 'Bronze Service Star', color: '#CD7F32', symbol: '★', size: 'sm' },
  silver_star: { name: 'Silver Service Star', color: '#C0C0C0', symbol: '★', size: 'sm' },
  gold_star: { name: 'Gold Service Star', color: '#FFD700', symbol: '★', size: 'sm' },
  bronze_olc: { name: 'Bronze Oak Leaf Cluster', color: '#CD7F32', symbol: '🌿', size: 'sm' },
  silver_olc: { name: 'Silver Oak Leaf Cluster', color: '#C0C0C0', symbol: '🌿', size: 'sm' },
  v_device: { name: 'V Device (Valor)', color: '#CD7F32', symbol: 'V', size: 'sm' },
  c_device: { name: 'C Device (Combat)', color: '#CD7F32', symbol: 'C', size: 'sm' },
  r_device: { name: 'R Device (Remote)', color: '#CD7F32', symbol: 'R', size: 'sm' },
  ...
  if (branch === 'Navy' || branch === 'Marines' || branch === 'Coast Guard') {
    ...
    if (starMatch) {
      ...
      for (let i = 0; i < bronzeStars; i++) {
        devices.push({ type: 'bronze_star', position: goldStars + silverStars + i });
      }
    }
  }
...
export function getAwardsForBranch(branch) {
  return MASTER_AWARDS
    .filter(a => a.branch.includes(branch))
    .sort((a, b) => (a.precedence[branch] || 999) - (b.precedence[branch] || 999));
}
