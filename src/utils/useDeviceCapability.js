...
const getDeviceAdvice = (tier, capabilities) => {
  const { isMobile, isDataSaver, androidVersion, iosVersion, webGPUSupported } = capabilities;
  ...
  switch (tier) {
    case DEVICE_TIERS.HIGH_END:
      ...
      advice.localAI.description = 'Runs entirely on your device. No data leaves your phone.';
      advice.cloudAI.description = 'Fast but sends data to Google. Use Local AI for privacy.';
      break;
    ...
    case DEVICE_TIERS.CAPABLE:
      ...
      advice.localAI.description = 'Private processing on your device. May use significant resources.';
    ...
    case DEVICE_TIERS.LEGACY:
      ...
      if (androidVersion !== null) {
        ...
        advice.localAI.description = 'Your device may struggle with Local AI. We recommend Cloud AI.';
      }
      advice.localAI.warning = '⚠️ Local AI may freeze or crash on older devices.';
      advice.cloudAI.recommended = true;
      advice.cloudAI.badge = '✨ Recommended for your device';
      advice.cloudAI.description = 'Fast and reliable on your device. Requires internet connection.';
      break;
    ...
    case DEVICE_TIERS.UNSUPPORTED:
      ...
      advice.localAI.description = 'Local AI requires WebGPU, which is not available on your device.';
      advice.localAI.warning = 'Your browser does not support WebGPU. Please use Chrome 113+, Edge 113+, or a compatible browser.';
      advice.cloudAI.recommended = true;
      advice.cloudAI.badge = '✨ Use this option';
      advice.cloudAI.description = 'Cloud AI works on all devices. Requires internet connection.';
      break;
  }
  
  // Add data saver warning if applicable
  if (isDataSaver && advice.localAI.available) {
    advice.localAI.warning = (advice.localAI.warning || '') + 
...
export function useDeviceCapability() {
  ...
  return {
    ...
    shouldRecommendCloud: capabilities.tier === DEVICE_TIERS.LEGACY || 
