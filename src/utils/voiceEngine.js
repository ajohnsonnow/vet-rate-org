...
export const getAvailableVoices = () => {
  ...
  const categorized = {
    "North American English": voices.filter(
      (v) => v.lang.startsWith("en-US") || v.lang.startsWith("en-CA"),
    ),
    "Spanish / Latino": voices.filter((v) => v.lang.startsWith("es")),
    "Pacific / Asian": voices.filter(
      (v) =>
    ...
    "British / Commonwealth": voices.filter(
      (v) =>
        v.lang.includes("GB") ||
        v.lang.includes("AU") ||
        v.lang.includes("ZA") ||
